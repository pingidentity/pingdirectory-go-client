...
const (
	DISCONNECT EnumclientConnectionPolicyConnectionOperationRateExceededBehaviorProp = "disconnect"
	REJECT_ADMIN_LIMIT_EXCEEDED EnumclientConnectionPolicyConnectionOperationRateExceededBehaviorProp = "reject-admin-limit-exceeded"
	REJECT_CONSTRAINT_VIOLATION EnumclientConnectionPolicyConnectionOperationRateExceededBehaviorProp = "reject-constraint-violation"
	REJECT_BUSY EnumclientConnectionPolicyConnectionOperationRateExceededBehaviorProp = "reject-busy"
	REJECT_UNAVAILABLE EnumclientConnectionPolicyConnectionOperationRateExceededBehaviorProp = "reject-unavailable"
	REJECT_UNWILLING_TO_PERFORM EnumclientConnectionPolicyConnectionOperationRateExceededBehaviorProp = "reject-unwilling-to-perform"
	REJECT_OTHER EnumclientConnectionPolicyConnectionOperationRateExceededBehaviorProp = "reject-other"
)
