...
// LeaveLockdownModeRecurringTaskShared struct for LeaveLockdownModeRecurringTaskShared
type LeaveLockdownModeRecurringTaskShared struct {
...
func NewLeaveLockdownModeRecurringTaskShared(schemas []EnumleaveLockdownModeRecurringTaskSchemaUrn) *LeaveLockdownModeRecurringTaskShared {
	this := LeaveLockdownModeRecurringTaskShared{}
...
func (o LeaveLockdownModeRecurringTaskShared) MarshalJSON() ([]byte, error) {
...
type NullableLeaveLockdownModeRecurringTaskShared struct {
	value *LeaveLockdownModeRecurringTaskShared
	isSet bool
}

func (v NullableLeaveLockdownModeRecurringTaskShared) Get() *LeaveLockdownModeRecurringTaskShared {
	return v.value
}

func (v *NullableLeaveLockdownModeRecurringTaskShared) Set(val *LeaveLockdownModeRecurringTaskShared) {
	v.value = val
	v.isSet = true
}

func (v NullableLeaveLockdownModeRecurringTaskShared) IsSet() bool {
	return v.isSet
}

func (v *NullableLeaveLockdownModeRecurringTaskShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLeaveLockdownModeRecurringTaskShared(val *LeaveLockdownModeRecurringTaskShared) *NullableLeaveLockdownModeRecurringTaskShared {
	return &NullableLeaveLockdownModeRecurringTaskShared{value: val, isSet: true}
}

func (v NullableLeaveLockdownModeRecurringTaskShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLeaveLockdownModeRecurringTaskShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
