...
// OpenidConnectIdTokenValidatorShared struct for OpenidConnectIdTokenValidatorShared
type OpenidConnectIdTokenValidatorShared struct {
...
func NewOpenidConnectIdTokenValidatorShared(schemas []EnumopenidConnectIdTokenValidatorSchemaUrn, allowedSigningAlgorithm []EnumidTokenValidatorAllowedSigningAlgorithmProp, enabled bool, identityMapper string, issuerURL string, evaluationOrderIndex int32) *OpenidConnectIdTokenValidatorShared {
	this := OpenidConnectIdTokenValidatorShared{}
...
func (o OpenidConnectIdTokenValidatorShared) MarshalJSON() ([]byte, error) {
...
type NullableOpenidConnectIdTokenValidatorShared struct {
	value *OpenidConnectIdTokenValidatorShared
	isSet bool
}

func (v NullableOpenidConnectIdTokenValidatorShared) Get() *OpenidConnectIdTokenValidatorShared {
	return v.value
}

func (v *NullableOpenidConnectIdTokenValidatorShared) Set(val *OpenidConnectIdTokenValidatorShared) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenidConnectIdTokenValidatorShared) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenidConnectIdTokenValidatorShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenidConnectIdTokenValidatorShared(val *OpenidConnectIdTokenValidatorShared) *NullableOpenidConnectIdTokenValidatorShared {
	return &NullableOpenidConnectIdTokenValidatorShared{value: val, isSet: true}
}

func (v NullableOpenidConnectIdTokenValidatorShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenidConnectIdTokenValidatorShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
