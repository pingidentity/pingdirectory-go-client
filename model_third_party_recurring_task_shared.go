...
// ThirdPartyRecurringTaskShared struct for ThirdPartyRecurringTaskShared
type ThirdPartyRecurringTaskShared struct {
...
func NewThirdPartyRecurringTaskShared(schemas []EnumthirdPartyRecurringTaskSchemaUrn, extensionClass string) *ThirdPartyRecurringTaskShared {
	this := ThirdPartyRecurringTaskShared{}
...
func (o ThirdPartyRecurringTaskShared) MarshalJSON() ([]byte, error) {
...
type NullableThirdPartyRecurringTaskShared struct {
	value *ThirdPartyRecurringTaskShared
	isSet bool
}

func (v NullableThirdPartyRecurringTaskShared) Get() *ThirdPartyRecurringTaskShared {
	return v.value
}

func (v *NullableThirdPartyRecurringTaskShared) Set(val *ThirdPartyRecurringTaskShared) {
	v.value = val
	v.isSet = true
}

func (v NullableThirdPartyRecurringTaskShared) IsSet() bool {
	return v.isSet
}

func (v *NullableThirdPartyRecurringTaskShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThirdPartyRecurringTaskShared(val *ThirdPartyRecurringTaskShared) *NullableThirdPartyRecurringTaskShared {
	return &NullableThirdPartyRecurringTaskShared{value: val, isSet: true}
}

func (v NullableThirdPartyRecurringTaskShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThirdPartyRecurringTaskShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
