...
GetReplicationDomain Returns a single Replication Domain
	...
	@param replicationDomainName Name of the Replication Domain to be read
	@return ApiGetReplicationDomainRequest
*/
func (a *ReplicationDomainApiService) GetReplicationDomain(ctx context.Context, replicationDomainName string) ApiGetReplicationDomainRequest {
	return ApiGetReplicationDomainRequest{
		ApiService:            a,
		ctx:                   ctx,
...
func (a *ReplicationDomainApiService) GetReplicationDomainExecute(r ApiGetReplicationDomainRequest) (*ReplicationDomainResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/replication-domains/{replication-domain-name}"
...
UpdateReplicationDomain Update an existing Replication Domain by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param replicationDomainName Name of the Replication Domain to be updated
	@return ApiUpdateReplicationDomainRequest
*/
func (a *ReplicationDomainApiService) UpdateReplicationDomain(ctx context.Context, replicationDomainName string) ApiUpdateReplicationDomainRequest {
	return ApiUpdateReplicationDomainRequest{
		ApiService:            a,
		ctx:                   ctx,
		replicationDomainName: replicationDomainName,
