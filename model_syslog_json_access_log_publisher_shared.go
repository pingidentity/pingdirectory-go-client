...
// SyslogJsonAccessLogPublisherShared struct for SyslogJsonAccessLogPublisherShared
type SyslogJsonAccessLogPublisherShared struct {
...
func NewSyslogJsonAccessLogPublisherShared(schemas []EnumsyslogJsonAccessLogPublisherSchemaUrn, syslogExternalServer []string, syslogFacility EnumlogPublisherSyslogFacilityProp, syslogSeverity EnumlogPublisherSyslogSeverityProp, enabled bool) *SyslogJsonAccessLogPublisherShared {
	this := SyslogJsonAccessLogPublisherShared{}
...
func (o SyslogJsonAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableSyslogJsonAccessLogPublisherShared struct {
	value *SyslogJsonAccessLogPublisherShared
	isSet bool
}

func (v NullableSyslogJsonAccessLogPublisherShared) Get() *SyslogJsonAccessLogPublisherShared {
	return v.value
}

func (v *NullableSyslogJsonAccessLogPublisherShared) Set(val *SyslogJsonAccessLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableSyslogJsonAccessLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableSyslogJsonAccessLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyslogJsonAccessLogPublisherShared(val *SyslogJsonAccessLogPublisherShared) *NullableSyslogJsonAccessLogPublisherShared {
	return &NullableSyslogJsonAccessLogPublisherShared{value: val, isSet: true}
}

func (v NullableSyslogJsonAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyslogJsonAccessLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
