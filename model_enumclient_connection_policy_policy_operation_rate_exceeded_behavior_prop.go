...
const (
	DISCONNECT EnumclientConnectionPolicyPolicyOperationRateExceededBehaviorProp = "disconnect"
	REJECT_ADMIN_LIMIT_EXCEEDED EnumclientConnectionPolicyPolicyOperationRateExceededBehaviorProp = "reject-admin-limit-exceeded"
	REJECT_CONSTRAINT_VIOLATION EnumclientConnectionPolicyPolicyOperationRateExceededBehaviorProp = "reject-constraint-violation"
	REJECT_BUSY EnumclientConnectionPolicyPolicyOperationRateExceededBehaviorProp = "reject-busy"
	REJECT_UNAVAILABLE EnumclientConnectionPolicyPolicyOperationRateExceededBehaviorProp = "reject-unavailable"
	REJECT_UNWILLING_TO_PERFORM EnumclientConnectionPolicyPolicyOperationRateExceededBehaviorProp = "reject-unwilling-to-perform"
	REJECT_OTHER EnumclientConnectionPolicyPolicyOperationRateExceededBehaviorProp = "reject-other"
)
