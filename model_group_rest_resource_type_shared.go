...
// GroupRestResourceTypeShared struct for GroupRestResourceTypeShared
type GroupRestResourceTypeShared struct {
...
func NewGroupRestResourceTypeShared(schemas []EnumgroupRestResourceTypeSchemaUrn, enabled bool, resourceEndpoint string, structuralLDAPObjectclass string, searchBaseDN string) *GroupRestResourceTypeShared {
	this := GroupRestResourceTypeShared{}
...
func (o GroupRestResourceTypeShared) MarshalJSON() ([]byte, error) {
...
type NullableGroupRestResourceTypeShared struct {
	value *GroupRestResourceTypeShared
	isSet bool
}

func (v NullableGroupRestResourceTypeShared) Get() *GroupRestResourceTypeShared {
	return v.value
}

func (v *NullableGroupRestResourceTypeShared) Set(val *GroupRestResourceTypeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupRestResourceTypeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupRestResourceTypeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupRestResourceTypeShared(val *GroupRestResourceTypeShared) *NullableGroupRestResourceTypeShared {
	return &NullableGroupRestResourceTypeShared{value: val, isSet: true}
}

func (v NullableGroupRestResourceTypeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupRestResourceTypeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
