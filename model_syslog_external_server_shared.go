...
// SyslogExternalServerShared struct for SyslogExternalServerShared
type SyslogExternalServerShared struct {
...
func NewSyslogExternalServerShared(schemas []EnumsyslogExternalServerSchemaUrn, serverHostName string, transportMechanism EnumexternalServerTransportMechanismProp, connectTimeout string, maxConnectionAge string, trustManagerProvider string) *SyslogExternalServerShared {
	this := SyslogExternalServerShared{}
...
func (o SyslogExternalServerShared) MarshalJSON() ([]byte, error) {
...
type NullableSyslogExternalServerShared struct {
	value *SyslogExternalServerShared
	isSet bool
}

func (v NullableSyslogExternalServerShared) Get() *SyslogExternalServerShared {
	return v.value
}

func (v *NullableSyslogExternalServerShared) Set(val *SyslogExternalServerShared) {
	v.value = val
	v.isSet = true
}

func (v NullableSyslogExternalServerShared) IsSet() bool {
	return v.isSet
}

func (v *NullableSyslogExternalServerShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyslogExternalServerShared(val *SyslogExternalServerShared) *NullableSyslogExternalServerShared {
	return &NullableSyslogExternalServerShared{value: val, isSet: true}
}

func (v NullableSyslogExternalServerShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyslogExternalServerShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
