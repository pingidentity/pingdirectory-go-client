...
// SmtpAccountStatusNotificationHandlerShared struct for SmtpAccountStatusNotificationHandlerShared
type SmtpAccountStatusNotificationHandlerShared struct {
...
func NewSmtpAccountStatusNotificationHandlerShared(schemas []EnumsmtpAccountStatusNotificationHandlerSchemaUrn, sendMessageWithoutEndUserAddress bool, senderAddress string, messageSubject []string, messageTemplateFile []string, enabled bool) *SmtpAccountStatusNotificationHandlerShared {
	this := SmtpAccountStatusNotificationHandlerShared{}
...
func (o SmtpAccountStatusNotificationHandlerShared) MarshalJSON() ([]byte, error) {
...
type NullableSmtpAccountStatusNotificationHandlerShared struct {
	value *SmtpAccountStatusNotificationHandlerShared
	isSet bool
}

func (v NullableSmtpAccountStatusNotificationHandlerShared) Get() *SmtpAccountStatusNotificationHandlerShared {
	return v.value
}

func (v *NullableSmtpAccountStatusNotificationHandlerShared) Set(val *SmtpAccountStatusNotificationHandlerShared) {
	v.value = val
	v.isSet = true
}

func (v NullableSmtpAccountStatusNotificationHandlerShared) IsSet() bool {
	return v.isSet
}

func (v *NullableSmtpAccountStatusNotificationHandlerShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmtpAccountStatusNotificationHandlerShared(val *SmtpAccountStatusNotificationHandlerShared) *NullableSmtpAccountStatusNotificationHandlerShared {
	return &NullableSmtpAccountStatusNotificationHandlerShared{value: val, isSet: true}
}

func (v NullableSmtpAccountStatusNotificationHandlerShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmtpAccountStatusNotificationHandlerShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
