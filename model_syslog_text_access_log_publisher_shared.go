...
// SyslogTextAccessLogPublisherShared struct for SyslogTextAccessLogPublisherShared
type SyslogTextAccessLogPublisherShared struct {
...
func NewSyslogTextAccessLogPublisherShared(schemas []EnumsyslogTextAccessLogPublisherSchemaUrn, syslogExternalServer []string, syslogFacility EnumlogPublisherSyslogFacilityProp, syslogSeverity EnumlogPublisherSyslogSeverityProp, asynchronous bool, enabled bool) *SyslogTextAccessLogPublisherShared {
	this := SyslogTextAccessLogPublisherShared{}
...
func (o SyslogTextAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableSyslogTextAccessLogPublisherShared struct {
	value *SyslogTextAccessLogPublisherShared
	isSet bool
}

func (v NullableSyslogTextAccessLogPublisherShared) Get() *SyslogTextAccessLogPublisherShared {
	return v.value
}

func (v *NullableSyslogTextAccessLogPublisherShared) Set(val *SyslogTextAccessLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableSyslogTextAccessLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableSyslogTextAccessLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyslogTextAccessLogPublisherShared(val *SyslogTextAccessLogPublisherShared) *NullableSyslogTextAccessLogPublisherShared {
	return &NullableSyslogTextAccessLogPublisherShared{value: val, isSet: true}
}

func (v NullableSyslogTextAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyslogTextAccessLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
