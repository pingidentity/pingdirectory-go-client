...
// checks if the LeaveLockdownModeRecurringTaskResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LeaveLockdownModeRecurringTaskResponse{}
