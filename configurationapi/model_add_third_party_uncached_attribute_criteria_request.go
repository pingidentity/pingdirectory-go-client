...
// checks if the AddThirdPartyUncachedAttributeCriteriaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddThirdPartyUncachedAttributeCriteriaRequest{}
...
func (o AddThirdPartyUncachedAttributeCriteriaRequest) ToMap() (map[string]interface{}, error) {
