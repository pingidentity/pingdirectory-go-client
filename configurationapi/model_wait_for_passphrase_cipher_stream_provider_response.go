...
// checks if the WaitForPassphraseCipherStreamProviderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WaitForPassphraseCipherStreamProviderResponse{}
...
func (o WaitForPassphraseCipherStreamProviderResponse) ToMap() (map[string]interface{}, error) {
