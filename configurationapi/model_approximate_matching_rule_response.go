...
// checks if the ApproximateMatchingRuleResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApproximateMatchingRuleResponse{}
