...
func (r ApiGetKeyManagerProviderRequest) Execute() (*GetKeyManagerProvider200Response, *http.Response, error) {
...
// SCIM filter
func (r ApiListKeyManagerProvidersRequest) Filter(filter string) ApiListKeyManagerProvidersRequest {
	r.filter = &filter
	return r
}

func (r ApiListKeyManagerProvidersRequest) Execute() (*KeyManagerProviderListResponse, *http.Response, error) {
	return r.ApiService.ListKeyManagerProvidersExecute(r)
}

/*
ListKeyManagerProviders Returns a list of all Key Manager Provider objects
...
func (r ApiUpdateKeyManagerProviderRequest) Execute() (*GetKeyManagerProvider200Response, *http.Response, error) {
