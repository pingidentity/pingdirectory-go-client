...
// checks if the DefaultUncachedEntryCriteriaResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefaultUncachedEntryCriteriaResponse{}
