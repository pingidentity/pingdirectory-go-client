...
// checks if the PasswordModifyExtendedOperationHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PasswordModifyExtendedOperationHandlerResponse{}
...
func (o PasswordModifyExtendedOperationHandlerResponse) ToMap() (map[string]interface{}, error) {
