...
// checks if the PlainSaslMechanismHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlainSaslMechanismHandlerResponse{}
...
func (o PlainSaslMechanismHandlerResponse) ToMap() (map[string]interface{}, error) {
