...
// checks if the OrderingMatchingRuleResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderingMatchingRuleResponse{}
...
func (o OrderingMatchingRuleResponse) ToMap() (map[string]interface{}, error) {
