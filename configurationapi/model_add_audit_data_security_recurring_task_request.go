...
// checks if the AddAuditDataSecurityRecurringTaskRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddAuditDataSecurityRecurringTaskRequest{}
...
// GetBaseOutputDirectory returns the BaseOutputDirectory field value if set, zero value otherwise.
func (o *AddAuditDataSecurityRecurringTaskRequest) GetBaseOutputDirectory() string {
	if o == nil || IsNil(o.BaseOutputDirectory) {
		var ret string
		return ret
	}
...
// GetBaseOutputDirectoryOk returns a tuple with the BaseOutputDirectory field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetBaseOutputDirectory gets a reference to the given string and assigns it to the BaseOutputDirectory field.
...
type NullableAddAuditDataSecurityRecurringTaskRequest struct {
	value *AddAuditDataSecurityRecurringTaskRequest
	isSet bool
}

func (v NullableAddAuditDataSecurityRecurringTaskRequest) Get() *AddAuditDataSecurityRecurringTaskRequest {
	return v.value
}

func (v *NullableAddAuditDataSecurityRecurringTaskRequest) Set(val *AddAuditDataSecurityRecurringTaskRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddAuditDataSecurityRecurringTaskRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddAuditDataSecurityRecurringTaskRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddAuditDataSecurityRecurringTaskRequest(val *AddAuditDataSecurityRecurringTaskRequest) *NullableAddAuditDataSecurityRecurringTaskRequest {
	return &NullableAddAuditDataSecurityRecurringTaskRequest{value: val, isSet: true}
}

func (v NullableAddAuditDataSecurityRecurringTaskRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddAuditDataSecurityRecurringTaskRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
