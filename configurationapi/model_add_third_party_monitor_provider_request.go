...
// checks if the AddThirdPartyMonitorProviderRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddThirdPartyMonitorProviderRequest{}
...
func (o AddThirdPartyMonitorProviderRequest) ToMap() (map[string]interface{}, error) {
