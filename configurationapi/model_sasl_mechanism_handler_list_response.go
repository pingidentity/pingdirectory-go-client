...
// checks if the SaslMechanismHandlerListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaslMechanismHandlerListResponse{}
...
func NewSaslMechanismHandlerListResponse() *SaslMechanismHandlerListResponse {
	this := SaslMechanismHandlerListResponse{}
	return &this
}
...
func (o SaslMechanismHandlerListResponse) MarshalJSON() ([]byte, error) {
...
func (o SaslMechanismHandlerListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSaslMechanismHandlerListResponse struct {
	value *SaslMechanismHandlerListResponse
	isSet bool
}

func (v NullableSaslMechanismHandlerListResponse) Get() *SaslMechanismHandlerListResponse {
	return v.value
}

func (v *NullableSaslMechanismHandlerListResponse) Set(val *SaslMechanismHandlerListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSaslMechanismHandlerListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSaslMechanismHandlerListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaslMechanismHandlerListResponse(val *SaslMechanismHandlerListResponse) *NullableSaslMechanismHandlerListResponse {
	return &NullableSaslMechanismHandlerListResponse{value: val, isSet: true}
}

func (v NullableSaslMechanismHandlerListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaslMechanismHandlerListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
