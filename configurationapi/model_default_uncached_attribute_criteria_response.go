...
// checks if the DefaultUncachedAttributeCriteriaResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefaultUncachedAttributeCriteriaResponse{}
