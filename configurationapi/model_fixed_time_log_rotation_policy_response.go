...
// checks if the FixedTimeLogRotationPolicyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FixedTimeLogRotationPolicyResponse{}
...
func (o FixedTimeLogRotationPolicyResponse) ToMap() (map[string]interface{}, error) {
