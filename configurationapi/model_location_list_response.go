...
// checks if the LocationListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocationListResponse{}

// LocationListResponse struct for LocationListResponse
type LocationListResponse struct {
	Schemas      []string           `json:"schemas,omitempty"`
	TotalResults *float64           `json:"totalResults,omitempty"`
	Resources    []LocationResponse `json:"Resources,omitempty"`
}
...
// SetResources gets a reference to the given []LocationResponse and assigns it to the Resources field.
func (o *LocationListResponse) SetResources(v []LocationResponse) {
	o.Resources = v
}

func (o LocationListResponse) MarshalJSON() ([]byte, error) {
...
func (o LocationListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLocationListResponse struct {
	value *LocationListResponse
	isSet bool
}

func (v NullableLocationListResponse) Get() *LocationListResponse {
	return v.value
}

func (v *NullableLocationListResponse) Set(val *LocationListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLocationListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLocationListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocationListResponse(val *LocationListResponse) *NullableLocationListResponse {
	return &NullableLocationListResponse{value: val, isSet: true}
}

func (v NullableLocationListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocationListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
