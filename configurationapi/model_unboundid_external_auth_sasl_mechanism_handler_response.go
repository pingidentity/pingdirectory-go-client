...
// checks if the UnboundidExternalAuthSaslMechanismHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnboundidExternalAuthSaslMechanismHandlerResponse{}
...
func (o UnboundidExternalAuthSaslMechanismHandlerResponse) ToMap() (map[string]interface{}, error) {
