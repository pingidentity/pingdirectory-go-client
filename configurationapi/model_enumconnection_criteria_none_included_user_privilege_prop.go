...
const (
	...
	ENUMCONNECTIONCRITERIANONEINCLUDEDUSERPRIVILEGEPROP_PERMIT_VERIFY_PASSWORD_REQUEST             EnumconnectionCriteriaNoneIncludedUserPrivilegeProp = "permit-verify-password-request"
)
