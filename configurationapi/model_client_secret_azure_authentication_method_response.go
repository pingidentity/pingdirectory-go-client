...
// checks if the ClientSecretAzureAuthenticationMethodResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientSecretAzureAuthenticationMethodResponse{}
...
func (o ClientSecretAzureAuthenticationMethodResponse) ToMap() (map[string]interface{}, error) {
