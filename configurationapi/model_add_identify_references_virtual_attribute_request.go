...
// checks if the AddIdentifyReferencesVirtualAttributeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddIdentifyReferencesVirtualAttributeRequest{}
