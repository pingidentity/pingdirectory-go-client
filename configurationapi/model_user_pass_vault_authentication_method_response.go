...
// checks if the UserPassVaultAuthenticationMethodResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserPassVaultAuthenticationMethodResponse{}
...
func (o UserPassVaultAuthenticationMethodResponse) ToMap() (map[string]interface{}, error) {
