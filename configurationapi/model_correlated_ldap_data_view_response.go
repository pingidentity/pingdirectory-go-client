...
// checks if the CorrelatedLdapDataViewResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CorrelatedLdapDataViewResponse{}
...
func (o CorrelatedLdapDataViewResponse) ToMap() (map[string]interface{}, error) {
