...
// checks if the DeliverPasswordResetTokenExtendedOperationHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeliverPasswordResetTokenExtendedOperationHandlerResponse{}
...
func (o DeliverPasswordResetTokenExtendedOperationHandlerResponse) ToMap() (map[string]interface{}, error) {
