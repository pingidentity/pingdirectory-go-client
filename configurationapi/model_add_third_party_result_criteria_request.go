...
// checks if the AddThirdPartyResultCriteriaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddThirdPartyResultCriteriaRequest{}
...
func (o AddThirdPartyResultCriteriaRequest) ToMap() (map[string]interface{}, error) {
