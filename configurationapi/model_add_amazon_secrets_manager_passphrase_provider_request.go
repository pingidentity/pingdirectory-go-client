...
// checks if the AddAmazonSecretsManagerPassphraseProviderRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddAmazonSecretsManagerPassphraseProviderRequest{}
