...
func (a *MonitorProviderApiService) DeleteMonitorProviderExecute(r ApiDeleteMonitorProviderRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"monitor-provider-name"+"}", url.PathEscape(parameterValueToString(r.monitorProviderName, "monitorProviderName")), -1)
...
// SCIM filter
func (r ApiListMonitorProvidersRequest) Filter(filter string) ApiListMonitorProvidersRequest {
	r.filter = &filter
	return r
}

func (r ApiListMonitorProvidersRequest) Execute() (*MonitorProviderListResponse, *http.Response, error) {
	return r.ApiService.ListMonitorProvidersExecute(r)
}

/*
ListMonitorProviders Returns a list of all Monitor Provider objects
