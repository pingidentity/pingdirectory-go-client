...
// checks if the ThirdPartyPasswordGeneratorResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThirdPartyPasswordGeneratorResponse{}
...
func (o ThirdPartyPasswordGeneratorResponse) ToMap() (map[string]interface{}, error) {
