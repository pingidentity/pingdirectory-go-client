...
// checks if the PassThroughScimResourceTypeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PassThroughScimResourceTypeResponse{}

// PassThroughScimResourceTypeResponse struct for PassThroughScimResourceTypeResponse
type PassThroughScimResourceTypeResponse struct {
	Schemas []EnumpassThroughScimResourceTypeSchemaUrn `json:"schemas"`
...
func (o *PassThroughScimResourceTypeResponse) GetSchemas() []EnumpassThroughScimResourceTypeSchemaUrn {
	if o == nil {
		var ret []EnumpassThroughScimResourceTypeSchemaUrn
		return ret
	}
...
func (o PassThroughScimResourceTypeResponse) MarshalJSON() ([]byte, error) {
...
func (o PassThroughScimResourceTypeResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePassThroughScimResourceTypeResponse struct {
	value *PassThroughScimResourceTypeResponse
	isSet bool
}

func (v NullablePassThroughScimResourceTypeResponse) Get() *PassThroughScimResourceTypeResponse {
	return v.value
}

func (v *NullablePassThroughScimResourceTypeResponse) Set(val *PassThroughScimResourceTypeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePassThroughScimResourceTypeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePassThroughScimResourceTypeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePassThroughScimResourceTypeResponse(val *PassThroughScimResourceTypeResponse) *NullablePassThroughScimResourceTypeResponse {
	return &NullablePassThroughScimResourceTypeResponse{value: val, isSet: true}
}

func (v NullablePassThroughScimResourceTypeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePassThroughScimResourceTypeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
