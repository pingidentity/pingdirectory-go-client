...
// checks if the StaticGroupImplementationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StaticGroupImplementationResponse{}
...
func (o StaticGroupImplementationResponse) ToMap() (map[string]interface{}, error) {
