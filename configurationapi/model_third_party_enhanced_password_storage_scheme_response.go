...
// checks if the ThirdPartyEnhancedPasswordStorageSchemeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThirdPartyEnhancedPasswordStorageSchemeResponse{}
...
func (o ThirdPartyEnhancedPasswordStorageSchemeResponse) ToMap() (map[string]interface{}, error) {
