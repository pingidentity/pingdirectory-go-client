...
// checks if the ConsoleJsonAccessLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsoleJsonAccessLogPublisherResponse{}
...
func (o *ConsoleJsonAccessLogPublisherResponse) GetSchemas() []EnumconsoleJsonAccessLogPublisherSchemaUrn {
	if o == nil {
		var ret []EnumconsoleJsonAccessLogPublisherSchemaUrn
		return ret
	}
...
func (o *ConsoleJsonAccessLogPublisherResponse) GetIncludeConnectionDetailsInRequestMessages() bool {
...
// and a boolean to check if the value has been set.
func (o *ConsoleJsonAccessLogPublisherResponse) GetIncludeConnectionDetailsInRequestMessagesOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeConnectionDetailsInRequestMessages) {
		return nil, false
	}
...
func (o *ConsoleJsonAccessLogPublisherResponse) HasIncludeConnectionDetailsInRequestMessages() bool {
	if o != nil && !IsNil(o.IncludeConnectionDetailsInRequestMessages) {
		return true
	}
...
func (o *ConsoleJsonAccessLogPublisherResponse) SetIncludeConnectionDetailsInRequestMessages(v bool) {
...
func (o ConsoleJsonAccessLogPublisherResponse) MarshalJSON() ([]byte, error) {
...
func (o ConsoleJsonAccessLogPublisherResponse) ToMap() (map[string]interface{}, error) {
...
type NullableConsoleJsonAccessLogPublisherResponse struct {
	value *ConsoleJsonAccessLogPublisherResponse
	isSet bool
}

func (v NullableConsoleJsonAccessLogPublisherResponse) Get() *ConsoleJsonAccessLogPublisherResponse {
	return v.value
}

func (v *NullableConsoleJsonAccessLogPublisherResponse) Set(val *ConsoleJsonAccessLogPublisherResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableConsoleJsonAccessLogPublisherResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableConsoleJsonAccessLogPublisherResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConsoleJsonAccessLogPublisherResponse(val *ConsoleJsonAccessLogPublisherResponse) *NullableConsoleJsonAccessLogPublisherResponse {
	return &NullableConsoleJsonAccessLogPublisherResponse{value: val, isSet: true}
}

func (v NullableConsoleJsonAccessLogPublisherResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConsoleJsonAccessLogPublisherResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
