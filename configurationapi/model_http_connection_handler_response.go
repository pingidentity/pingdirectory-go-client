...
// checks if the HttpConnectionHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpConnectionHandlerResponse{}
