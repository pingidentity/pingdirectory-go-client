...
// checks if the SizeLimitLogRetentionPolicyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SizeLimitLogRetentionPolicyResponse{}
...
func (o SizeLimitLogRetentionPolicyResponse) ToMap() (map[string]interface{}, error) {
