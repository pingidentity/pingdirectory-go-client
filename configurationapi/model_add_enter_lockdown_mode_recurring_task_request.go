...
// checks if the AddEnterLockdownModeRecurringTaskRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddEnterLockdownModeRecurringTaskRequest{}
