...
type AddPeriodicStatsLoggerPluginRequest struct {
	...
	// Specifies whether to log moving averages (1, 5, and 15-minute intervals) for HTTP socket, connection, queue, request, and response durations.
	IncludeHTTPMetrics *bool                        `json:"includeHTTPMetrics,omitempty"`
...
// GetIncludeHTTPMetrics returns the IncludeHTTPMetrics field value if set, zero value otherwise.
func (o *AddPeriodicStatsLoggerPluginRequest) GetIncludeHTTPMetrics() bool {
	if o == nil || IsNil(o.IncludeHTTPMetrics) {
		var ret bool
		return ret
	}
	return *o.IncludeHTTPMetrics
}

// GetIncludeHTTPMetricsOk returns a tuple with the IncludeHTTPMetrics field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AddPeriodicStatsLoggerPluginRequest) GetIncludeHTTPMetricsOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeHTTPMetrics) {
		return nil, false
	}
	return o.IncludeHTTPMetrics, true
}

// HasIncludeHTTPMetrics returns a boolean if a field has been set.
func (o *AddPeriodicStatsLoggerPluginRequest) HasIncludeHTTPMetrics() bool {
	if o != nil && !IsNil(o.IncludeHTTPMetrics) {
		return true
	}
...
// SetIncludeHTTPMetrics gets a reference to the given bool and assigns it to the IncludeHTTPMetrics field.
func (o *AddPeriodicStatsLoggerPluginRequest) SetIncludeHTTPMetrics(v bool) {
	o.IncludeHTTPMetrics = &v
}
...
func (o AddPeriodicStatsLoggerPluginRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IncludeHTTPMetrics) {
		toSerialize["includeHTTPMetrics"] = o.IncludeHTTPMetrics
	}
