...
func NewAddOperationTimingAccessLogPublisherRequest(schemas []EnumoperationTimingAccessLogPublisherSchemaUrn, logFile string, enabled bool, publisherName string) *AddOperationTimingAccessLogPublisherRequest {
