...
// checks if the EntryCacheListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntryCacheListResponse{}
...
func (o EntryCacheListResponse) MarshalJSON() ([]byte, error) {
...
func (o EntryCacheListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableEntryCacheListResponse struct {
	value *EntryCacheListResponse
	isSet bool
}

func (v NullableEntryCacheListResponse) Get() *EntryCacheListResponse {
	return v.value
}

func (v *NullableEntryCacheListResponse) Set(val *EntryCacheListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEntryCacheListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEntryCacheListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntryCacheListResponse(val *EntryCacheListResponse) *NullableEntryCacheListResponse {
	return &NullableEntryCacheListResponse{value: val, isSet: true}
}

func (v NullableEntryCacheListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntryCacheListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
