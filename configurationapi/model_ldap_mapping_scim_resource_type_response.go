...
// checks if the LdapMappingScimResourceTypeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LdapMappingScimResourceTypeResponse{}

// LdapMappingScimResourceTypeResponse struct for LdapMappingScimResourceTypeResponse
type LdapMappingScimResourceTypeResponse struct {
...
func (o *LdapMappingScimResourceTypeResponse) GetSchemas() []EnumldapMappingScimResourceTypeSchemaUrn {
	if o == nil {
		var ret []EnumldapMappingScimResourceTypeSchemaUrn
		return ret
	}
...
func (o LdapMappingScimResourceTypeResponse) MarshalJSON() ([]byte, error) {
...
func (o LdapMappingScimResourceTypeResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLdapMappingScimResourceTypeResponse struct {
	value *LdapMappingScimResourceTypeResponse
	isSet bool
}

func (v NullableLdapMappingScimResourceTypeResponse) Get() *LdapMappingScimResourceTypeResponse {
	return v.value
}

func (v *NullableLdapMappingScimResourceTypeResponse) Set(val *LdapMappingScimResourceTypeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLdapMappingScimResourceTypeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLdapMappingScimResourceTypeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLdapMappingScimResourceTypeResponse(val *LdapMappingScimResourceTypeResponse) *NullableLdapMappingScimResourceTypeResponse {
	return &NullableLdapMappingScimResourceTypeResponse{value: val, isSet: true}
}

func (v NullableLdapMappingScimResourceTypeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLdapMappingScimResourceTypeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
