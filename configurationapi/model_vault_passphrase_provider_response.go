...
// checks if the VaultPassphraseProviderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VaultPassphraseProviderResponse{}
