...
func (a *SaslMechanismHandlerApiService) DeleteSaslMechanismHandlerExecute(r ApiDeleteSaslMechanismHandlerRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"sasl-mechanism-handler-name"+"}", url.PathEscape(parameterValueToString(r.saslMechanismHandlerName, "saslMechanismHandlerName")), -1)
...
// SCIM filter
func (r ApiListSaslMechanismHandlersRequest) Filter(filter string) ApiListSaslMechanismHandlersRequest {
	r.filter = &filter
	return r
}

func (r ApiListSaslMechanismHandlersRequest) Execute() (*SaslMechanismHandlerListResponse, *http.Response, error) {
	return r.ApiService.ListSaslMechanismHandlersExecute(r)
}

/*
ListSaslMechanismHandlers Returns a list of all SASL Mechanism Handler objects
