...
// checks if the MockAccessTokenValidatorResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MockAccessTokenValidatorResponse{}
