...
// checks if the SynchronizeEncryptionSettingsExtendedOperationHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SynchronizeEncryptionSettingsExtendedOperationHandlerResponse{}

// SynchronizeEncryptionSettingsExtendedOperationHandlerResponse struct for SynchronizeEncryptionSettingsExtendedOperationHandlerResponse
type SynchronizeEncryptionSettingsExtendedOperationHandlerResponse struct {
	Meta                                          *MetaMeta                                                            `json:"meta,omitempty"`
	Urnpingidentityschemasconfigurationmessages20 *MetaUrnPingidentitySchemasConfigurationMessages20                   `json:"urn:pingidentity:schemas:configuration:messages:2.0,omitempty"`
	Schemas                                       []EnumsynchronizeEncryptionSettingsExtendedOperationHandlerSchemaUrn `json:"schemas"`
...
func NewSynchronizeEncryptionSettingsExtendedOperationHandlerResponse(schemas []EnumsynchronizeEncryptionSettingsExtendedOperationHandlerSchemaUrn, id string, enabled bool) *SynchronizeEncryptionSettingsExtendedOperationHandlerResponse {
	this := SynchronizeEncryptionSettingsExtendedOperationHandlerResponse{}
...
func (o *SynchronizeEncryptionSettingsExtendedOperationHandlerResponse) GetSchemas() []EnumsynchronizeEncryptionSettingsExtendedOperationHandlerSchemaUrn {
	if o == nil {
		var ret []EnumsynchronizeEncryptionSettingsExtendedOperationHandlerSchemaUrn
		return ret
	}
...
func (o SynchronizeEncryptionSettingsExtendedOperationHandlerResponse) MarshalJSON() ([]byte, error) {
...
func (o SynchronizeEncryptionSettingsExtendedOperationHandlerResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSynchronizeEncryptionSettingsExtendedOperationHandlerResponse struct {
	value *SynchronizeEncryptionSettingsExtendedOperationHandlerResponse
	isSet bool
}

func (v NullableSynchronizeEncryptionSettingsExtendedOperationHandlerResponse) Get() *SynchronizeEncryptionSettingsExtendedOperationHandlerResponse {
	return v.value
}

func (v *NullableSynchronizeEncryptionSettingsExtendedOperationHandlerResponse) Set(val *SynchronizeEncryptionSettingsExtendedOperationHandlerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSynchronizeEncryptionSettingsExtendedOperationHandlerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSynchronizeEncryptionSettingsExtendedOperationHandlerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSynchronizeEncryptionSettingsExtendedOperationHandlerResponse(val *SynchronizeEncryptionSettingsExtendedOperationHandlerResponse) *NullableSynchronizeEncryptionSettingsExtendedOperationHandlerResponse {
	return &NullableSynchronizeEncryptionSettingsExtendedOperationHandlerResponse{value: val, isSet: true}
}

func (v NullableSynchronizeEncryptionSettingsExtendedOperationHandlerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSynchronizeEncryptionSettingsExtendedOperationHandlerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
