...
func (a *PasswordStorageSchemeAPIService) DeletePasswordStorageSchemeExecute(r ApiDeletePasswordStorageSchemeRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"password-storage-scheme-name"+"}", url.PathEscape(parameterValueToString(r.passwordStorageSchemeName, "passwordStorageSchemeName")), -1)
...
// SCIM filter
func (r ApiListPasswordStorageSchemesRequest) Filter(filter string) ApiListPasswordStorageSchemesRequest {
	r.filter = &filter
	return r
}

func (r ApiListPasswordStorageSchemesRequest) Execute() (*PasswordStorageSchemeListResponse, *http.Response, error) {
	return r.ApiService.ListPasswordStorageSchemesExecute(r)
}

/*
ListPasswordStorageSchemes Returns a list of all Password Storage Scheme objects
