...
func (o *JsonErrorLogPublisherResponse) GetLogMessageExclusionPolicy() []string {
...
// and a boolean to check if the value has been set.
func (o *JsonErrorLogPublisherResponse) GetLogMessageExclusionPolicyOk() ([]string, bool) {
	if o == nil || IsNil(o.LogMessageExclusionPolicy) {
		return nil, false
	}
...
func (o *JsonErrorLogPublisherResponse) HasLogMessageExclusionPolicy() bool {
	if o != nil && !IsNil(o.LogMessageExclusionPolicy) {
		return true
	}
...
func (o *JsonErrorLogPublisherResponse) SetLogMessageExclusionPolicy(v []string) {
