...
// checks if the GroovyScriptedIdentityMapperResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroovyScriptedIdentityMapperResponse{}
...
func (o GroovyScriptedIdentityMapperResponse) ToMap() (map[string]interface{}, error) {
