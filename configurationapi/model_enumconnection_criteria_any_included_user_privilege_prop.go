...
const (
	...
	ENUMCONNECTIONCRITERIAANYINCLUDEDUSERPRIVILEGEPROP_PERMIT_VERIFY_PASSWORD_REQUEST             EnumconnectionCriteriaAnyIncludedUserPrivilegeProp = "permit-verify-password-request"
)
