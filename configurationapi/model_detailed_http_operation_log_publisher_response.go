...
// checks if the DetailedHttpOperationLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedHttpOperationLogPublisherResponse{}
...
func NewDetailedHttpOperationLogPublisherResponse(schemas []EnumdetailedHttpOperationLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool, id string) *DetailedHttpOperationLogPublisherResponse {
...
func (o DetailedHttpOperationLogPublisherResponse) ToMap() (map[string]interface{}, error) {
