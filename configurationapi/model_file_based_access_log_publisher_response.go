...
// checks if the FileBasedAccessLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileBasedAccessLogPublisherResponse{}
...
func NewFileBasedAccessLogPublisherResponse(schemas []EnumfileBasedAccessLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool, id string) *FileBasedAccessLogPublisherResponse {
...
func (o *FileBasedAccessLogPublisherResponse) GetIncludeConnectionDetailsInRequestMessages() bool {
...
// and a boolean to check if the value has been set.
func (o *FileBasedAccessLogPublisherResponse) GetIncludeConnectionDetailsInRequestMessagesOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeConnectionDetailsInRequestMessages) {
		return nil, false
	}
...
func (o *FileBasedAccessLogPublisherResponse) HasIncludeConnectionDetailsInRequestMessages() bool {
	if o != nil && !IsNil(o.IncludeConnectionDetailsInRequestMessages) {
		return true
	}
...
func (o *FileBasedAccessLogPublisherResponse) SetIncludeConnectionDetailsInRequestMessages(v bool) {
...
func (o FileBasedAccessLogPublisherResponse) ToMap() (map[string]interface{}, error) {
