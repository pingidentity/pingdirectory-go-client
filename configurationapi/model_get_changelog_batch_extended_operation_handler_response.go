...
// checks if the GetChangelogBatchExtendedOperationHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetChangelogBatchExtendedOperationHandlerResponse{}
...
func (o GetChangelogBatchExtendedOperationHandlerResponse) ToMap() (map[string]interface{}, error) {
