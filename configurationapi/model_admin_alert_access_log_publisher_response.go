...
// checks if the AdminAlertAccessLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminAlertAccessLogPublisherResponse{}
...
func (o *AdminAlertAccessLogPublisherResponse) GetIncludeConnectionDetailsInRequestMessages() bool {
...
// and a boolean to check if the value has been set.
func (o *AdminAlertAccessLogPublisherResponse) GetIncludeConnectionDetailsInRequestMessagesOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeConnectionDetailsInRequestMessages) {
		return nil, false
	}
...
func (o *AdminAlertAccessLogPublisherResponse) HasIncludeConnectionDetailsInRequestMessages() bool {
	if o != nil && !IsNil(o.IncludeConnectionDetailsInRequestMessages) {
		return true
	}
...
func (o *AdminAlertAccessLogPublisherResponse) SetIncludeConnectionDetailsInRequestMessages(v bool) {
...
type NullableAdminAlertAccessLogPublisherResponse struct {
	value *AdminAlertAccessLogPublisherResponse
	isSet bool
}

func (v NullableAdminAlertAccessLogPublisherResponse) Get() *AdminAlertAccessLogPublisherResponse {
	return v.value
}

func (v *NullableAdminAlertAccessLogPublisherResponse) Set(val *AdminAlertAccessLogPublisherResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminAlertAccessLogPublisherResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminAlertAccessLogPublisherResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminAlertAccessLogPublisherResponse(val *AdminAlertAccessLogPublisherResponse) *NullableAdminAlertAccessLogPublisherResponse {
	return &NullableAdminAlertAccessLogPublisherResponse{value: val, isSet: true}
}

func (v NullableAdminAlertAccessLogPublisherResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminAlertAccessLogPublisherResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
