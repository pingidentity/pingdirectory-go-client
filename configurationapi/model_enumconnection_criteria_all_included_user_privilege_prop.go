...
const (
	...
	ENUMCONNECTIONCRITERIAALLINCLUDEDUSERPRIVILEGEPROP_PERMIT_VERIFY_PASSWORD_REQUEST             EnumconnectionCriteriaAllIncludedUserPrivilegeProp = "permit-verify-password-request"
)
