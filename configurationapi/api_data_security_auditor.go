...
func (a *DataSecurityAuditorApiService) DeleteDataSecurityAuditorExecute(r ApiDeleteDataSecurityAuditorRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"data-security-auditor-name"+"}", url.PathEscape(parameterValueToString(r.dataSecurityAuditorName, "dataSecurityAuditorName")), -1)
...
// SCIM filter
func (r ApiListDataSecurityAuditorsRequest) Filter(filter string) ApiListDataSecurityAuditorsRequest {
	r.filter = &filter
	return r
}

func (r ApiListDataSecurityAuditorsRequest) Execute() (*DataSecurityAuditorListResponse, *http.Response, error) {
	return r.ApiService.ListDataSecurityAuditorsExecute(r)
}

/*
ListDataSecurityAuditors Returns a list of all Data Security Auditor objects
