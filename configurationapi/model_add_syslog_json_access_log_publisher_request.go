...
// checks if the AddSyslogJsonAccessLogPublisherRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddSyslogJsonAccessLogPublisherRequest{}

// AddSyslogJsonAccessLogPublisherRequest struct for AddSyslogJsonAccessLogPublisherRequest
type AddSyslogJsonAccessLogPublisherRequest struct {
...
func NewAddSyslogJsonAccessLogPublisherRequest(schemas []EnumsyslogJsonAccessLogPublisherSchemaUrn, syslogExternalServer []string, enabled bool, publisherName string) *AddSyslogJsonAccessLogPublisherRequest {
	this := AddSyslogJsonAccessLogPublisherRequest{}
...
func (o *AddSyslogJsonAccessLogPublisherRequest) HasSyslogFacility() bool {
	if o != nil && !IsNil(o.SyslogFacility) {
		return true
	}
...
func (o *AddSyslogJsonAccessLogPublisherRequest) HasSyslogSeverity() bool {
	if o != nil && !IsNil(o.SyslogSeverity) {
		return true
	}
...
func (o AddSyslogJsonAccessLogPublisherRequest) MarshalJSON() ([]byte, error) {
...
func (o AddSyslogJsonAccessLogPublisherRequest) ToMap() (map[string]interface{}, error) {
...
type NullableAddSyslogJsonAccessLogPublisherRequest struct {
	value *AddSyslogJsonAccessLogPublisherRequest
	isSet bool
}

func (v NullableAddSyslogJsonAccessLogPublisherRequest) Get() *AddSyslogJsonAccessLogPublisherRequest {
	return v.value
}

func (v *NullableAddSyslogJsonAccessLogPublisherRequest) Set(val *AddSyslogJsonAccessLogPublisherRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddSyslogJsonAccessLogPublisherRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddSyslogJsonAccessLogPublisherRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddSyslogJsonAccessLogPublisherRequest(val *AddSyslogJsonAccessLogPublisherRequest) *NullableAddSyslogJsonAccessLogPublisherRequest {
	return &NullableAddSyslogJsonAccessLogPublisherRequest{value: val, isSet: true}
}

func (v NullableAddSyslogJsonAccessLogPublisherRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddSyslogJsonAccessLogPublisherRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
