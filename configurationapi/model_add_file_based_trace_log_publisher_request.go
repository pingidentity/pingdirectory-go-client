...
// checks if the AddFileBasedTraceLogPublisherRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddFileBasedTraceLogPublisherRequest{}
...
func NewAddFileBasedTraceLogPublisherRequest(schemas []EnumfileBasedTraceLogPublisherSchemaUrn, logFile string, enabled bool, publisherName string) *AddFileBasedTraceLogPublisherRequest {
...
func (o *AddFileBasedTraceLogPublisherRequest) GetHttpEvent() []EnumlogPublisherHttpEventProp {
...
// and a boolean to check if the value has been set.
func (o *AddFileBasedTraceLogPublisherRequest) GetHttpEventOk() ([]EnumlogPublisherHttpEventProp, bool) {
	if o == nil || IsNil(o.HttpEvent) {
		return nil, false
	}
...
func (o *AddFileBasedTraceLogPublisherRequest) HasHttpEvent() bool {
	if o != nil && !IsNil(o.HttpEvent) {
		return true
	}
...
func (o *AddFileBasedTraceLogPublisherRequest) SetHttpEvent(v []EnumlogPublisherHttpEventProp) {
	o.HttpEvent = v
}
...
func (o AddFileBasedTraceLogPublisherRequest) ToMap() (map[string]interface{}, error) {
