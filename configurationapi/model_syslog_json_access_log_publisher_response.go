...
// checks if the SyslogJsonAccessLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogJsonAccessLogPublisherResponse{}

// SyslogJsonAccessLogPublisherResponse struct for SyslogJsonAccessLogPublisherResponse
type SyslogJsonAccessLogPublisherResponse struct {
	Schemas []EnumsyslogJsonAccessLogPublisherSchemaUrn `json:"schemas"`
...
func NewSyslogJsonAccessLogPublisherResponse(schemas []EnumsyslogJsonAccessLogPublisherSchemaUrn, syslogExternalServer []string, syslogFacility EnumlogPublisherSyslogFacilityProp, syslogSeverity EnumlogPublisherSyslogSeverityProp, enabled bool, id string) *SyslogJsonAccessLogPublisherResponse {
	this := SyslogJsonAccessLogPublisherResponse{}
...
func (o *SyslogJsonAccessLogPublisherResponse) GetSchemas() []EnumsyslogJsonAccessLogPublisherSchemaUrn {
	if o == nil {
		var ret []EnumsyslogJsonAccessLogPublisherSchemaUrn
		return ret
	}
...
func (o *SyslogJsonAccessLogPublisherResponse) GetQueueSize() int64 {
...
// and a boolean to check if the value has been set.
func (o *SyslogJsonAccessLogPublisherResponse) GetQueueSizeOk() (*int64, bool) {
	if o == nil || IsNil(o.QueueSize) {
		return nil, false
	}
...
func (o *SyslogJsonAccessLogPublisherResponse) SetQueueSize(v int64) {
	o.QueueSize = &v
}
...
func (o *SyslogJsonAccessLogPublisherResponse) GetIncludeConnectionDetailsInRequestMessages() bool {
...
// and a boolean to check if the value has been set.
func (o *SyslogJsonAccessLogPublisherResponse) GetIncludeConnectionDetailsInRequestMessagesOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeConnectionDetailsInRequestMessages) {
		return nil, false
	}
...
func (o *SyslogJsonAccessLogPublisherResponse) HasIncludeConnectionDetailsInRequestMessages() bool {
	if o != nil && !IsNil(o.IncludeConnectionDetailsInRequestMessages) {
		return true
	}
...
func (o *SyslogJsonAccessLogPublisherResponse) SetIncludeConnectionDetailsInRequestMessages(v bool) {
...
func (o *SyslogJsonAccessLogPublisherResponse) GetMaxStringLength() int64 {
...
// and a boolean to check if the value has been set.
func (o *SyslogJsonAccessLogPublisherResponse) GetMaxStringLengthOk() (*int64, bool) {
	if o == nil || IsNil(o.MaxStringLength) {
		return nil, false
	}
...
func (o *SyslogJsonAccessLogPublisherResponse) SetMaxStringLength(v int64) {
	o.MaxStringLength = &v
}
...
func (o SyslogJsonAccessLogPublisherResponse) MarshalJSON() ([]byte, error) {
...
func (o SyslogJsonAccessLogPublisherResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSyslogJsonAccessLogPublisherResponse struct {
	value *SyslogJsonAccessLogPublisherResponse
	isSet bool
}

func (v NullableSyslogJsonAccessLogPublisherResponse) Get() *SyslogJsonAccessLogPublisherResponse {
	return v.value
}

func (v *NullableSyslogJsonAccessLogPublisherResponse) Set(val *SyslogJsonAccessLogPublisherResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSyslogJsonAccessLogPublisherResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSyslogJsonAccessLogPublisherResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyslogJsonAccessLogPublisherResponse(val *SyslogJsonAccessLogPublisherResponse) *NullableSyslogJsonAccessLogPublisherResponse {
	return &NullableSyslogJsonAccessLogPublisherResponse{value: val, isSet: true}
}

func (v NullableSyslogJsonAccessLogPublisherResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyslogJsonAccessLogPublisherResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
