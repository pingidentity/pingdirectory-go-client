...
func NewThirdPartyFileBasedAccessLogPublisherResponse(schemas []EnumthirdPartyFileBasedAccessLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, extensionClass string, asynchronous bool, enabled bool, id string) *ThirdPartyFileBasedAccessLogPublisherResponse {
