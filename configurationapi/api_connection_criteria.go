...
func (a *ConnectionCriteriaAPIService) DeleteConnectionCriteriaExecute(r ApiDeleteConnectionCriteriaRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"connection-criteria-name"+"}", url.PathEscape(parameterValueToString(r.connectionCriteriaName, "connectionCriteriaName")), -1)
...
// SCIM filter
func (r ApiListConnectionCriteriaRequest) Filter(filter string) ApiListConnectionCriteriaRequest {
	r.filter = &filter
	return r
}

func (r ApiListConnectionCriteriaRequest) Execute() (*ConnectionCriteriaListResponse, *http.Response, error) {
	return r.ApiService.ListConnectionCriteriaExecute(r)
}

/*
ListConnectionCriteria Returns a list of all Connection Criteria objects
