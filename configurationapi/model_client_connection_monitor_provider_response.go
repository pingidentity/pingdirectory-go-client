...
// checks if the ClientConnectionMonitorProviderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientConnectionMonitorProviderResponse{}
...
func (o ClientConnectionMonitorProviderResponse) ToMap() (map[string]interface{}, error) {
