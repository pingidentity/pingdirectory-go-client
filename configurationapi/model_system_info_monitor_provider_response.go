...
// checks if the SystemInfoMonitorProviderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInfoMonitorProviderResponse{}
...
func (o SystemInfoMonitorProviderResponse) ToMap() (map[string]interface{}, error) {
