...
// checks if the SimpleConnectionCriteriaResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SimpleConnectionCriteriaResponse{}
