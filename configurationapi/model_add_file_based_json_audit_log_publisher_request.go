...
func NewAddFileBasedJsonAuditLogPublisherRequest(publisherName string, schemas []EnumfileBasedJsonAuditLogPublisherSchemaUrn, logFile string, enabled bool) *AddFileBasedJsonAuditLogPublisherRequest {
