...
func (a *LogFieldMappingApiService) DeleteLogFieldMappingExecute(r ApiDeleteLogFieldMappingRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"log-field-mapping-name"+"}", url.PathEscape(parameterValueToString(r.logFieldMappingName, "logFieldMappingName")), -1)
...
// SCIM filter
func (r ApiListLogFieldMappingsRequest) Filter(filter string) ApiListLogFieldMappingsRequest {
	r.filter = &filter
	return r
}

func (r ApiListLogFieldMappingsRequest) Execute() (*LogFieldMappingListResponse, *http.Response, error) {
	return r.ApiService.ListLogFieldMappingsExecute(r)
}

/*
ListLogFieldMappings Returns a list of all Log Field Mapping objects
