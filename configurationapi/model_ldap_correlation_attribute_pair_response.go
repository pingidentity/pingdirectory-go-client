...
// checks if the LdapCorrelationAttributePairResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LdapCorrelationAttributePairResponse{}
