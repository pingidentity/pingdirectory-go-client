...
func (a *LogFileRotationListenerApiService) DeleteLogFileRotationListenerExecute(r ApiDeleteLogFileRotationListenerRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"log-file-rotation-listener-name"+"}", url.PathEscape(parameterValueToString(r.logFileRotationListenerName, "logFileRotationListenerName")), -1)
...
// SCIM filter
func (r ApiListLogFileRotationListenersRequest) Filter(filter string) ApiListLogFileRotationListenersRequest {
	r.filter = &filter
	return r
}

func (r ApiListLogFileRotationListenersRequest) Execute() (*LogFileRotationListenerListResponse, *http.Response, error) {
	return r.ApiService.ListLogFileRotationListenersExecute(r)
}

/*
ListLogFileRotationListeners Returns a list of all Log File Rotation Listener objects
