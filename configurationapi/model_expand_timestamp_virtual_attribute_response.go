...
// checks if the ExpandTimestampVirtualAttributeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandTimestampVirtualAttributeResponse{}

// ExpandTimestampVirtualAttributeResponse struct for ExpandTimestampVirtualAttributeResponse
type ExpandTimestampVirtualAttributeResponse struct {
	Schemas []EnumexpandTimestampVirtualAttributeSchemaUrn `json:"schemas"`
...
func NewExpandTimestampVirtualAttributeResponse(schemas []EnumexpandTimestampVirtualAttributeSchemaUrn, id string, sourceAttribute string, enabled bool, attributeType string) *ExpandTimestampVirtualAttributeResponse {
	this := ExpandTimestampVirtualAttributeResponse{}
...
func (o *ExpandTimestampVirtualAttributeResponse) GetSchemas() []EnumexpandTimestampVirtualAttributeSchemaUrn {
	if o == nil {
		var ret []EnumexpandTimestampVirtualAttributeSchemaUrn
		return ret
	}
...
func (o ExpandTimestampVirtualAttributeResponse) MarshalJSON() ([]byte, error) {
...
func (o ExpandTimestampVirtualAttributeResponse) ToMap() (map[string]interface{}, error) {
...
type NullableExpandTimestampVirtualAttributeResponse struct {
	value *ExpandTimestampVirtualAttributeResponse
	isSet bool
}

func (v NullableExpandTimestampVirtualAttributeResponse) Get() *ExpandTimestampVirtualAttributeResponse {
	return v.value
}

func (v *NullableExpandTimestampVirtualAttributeResponse) Set(val *ExpandTimestampVirtualAttributeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandTimestampVirtualAttributeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandTimestampVirtualAttributeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandTimestampVirtualAttributeResponse(val *ExpandTimestampVirtualAttributeResponse) *NullableExpandTimestampVirtualAttributeResponse {
	return &NullableExpandTimestampVirtualAttributeResponse{value: val, isSet: true}
}

func (v NullableExpandTimestampVirtualAttributeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandTimestampVirtualAttributeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
