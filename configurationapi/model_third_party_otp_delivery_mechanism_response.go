...
// checks if the ThirdPartyOtpDeliveryMechanismResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThirdPartyOtpDeliveryMechanismResponse{}
...
func (o ThirdPartyOtpDeliveryMechanismResponse) ToMap() (map[string]interface{}, error) {
