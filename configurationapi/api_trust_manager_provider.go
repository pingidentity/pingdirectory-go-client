...
func (a *TrustManagerProviderApiService) DeleteTrustManagerProviderExecute(r ApiDeleteTrustManagerProviderRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"trust-manager-provider-name"+"}", url.PathEscape(parameterValueToString(r.trustManagerProviderName, "trustManagerProviderName")), -1)
...
// SCIM filter
func (r ApiListTrustManagerProvidersRequest) Filter(filter string) ApiListTrustManagerProvidersRequest {
	r.filter = &filter
	return r
}

func (r ApiListTrustManagerProvidersRequest) Execute() (*TrustManagerProviderListResponse, *http.Response, error) {
	return r.ApiService.ListTrustManagerProvidersExecute(r)
}

/*
ListTrustManagerProviders Returns a list of all Trust Manager Provider objects
