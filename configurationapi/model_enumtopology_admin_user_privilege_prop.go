...
const (
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_AUDIT_DATA_SECURITY                        EnumtopologyAdminUserPrivilegeProp = "-audit-data-security"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_BYPASS_READ_ACL                            EnumtopologyAdminUserPrivilegeProp = "-bypass-read-acl"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_MODIFY_ACL                                        EnumtopologyAdminUserPrivilegeProp = "modify-acl"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_MODIFY_ACL                                 EnumtopologyAdminUserPrivilegeProp = "-modify-acl"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_CONFIG_READ                                       EnumtopologyAdminUserPrivilegeProp = "config-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_CONFIG_READ                                EnumtopologyAdminUserPrivilegeProp = "-config-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_CONFIG_WRITE                                      EnumtopologyAdminUserPrivilegeProp = "config-write"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_CONFIG_WRITE                               EnumtopologyAdminUserPrivilegeProp = "-config-write"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_JMX_READ                                          EnumtopologyAdminUserPrivilegeProp = "jmx-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_JMX_READ                                   EnumtopologyAdminUserPrivilegeProp = "-jmx-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_JMX_WRITE                                         EnumtopologyAdminUserPrivilegeProp = "jmx-write"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_JMX_WRITE                                  EnumtopologyAdminUserPrivilegeProp = "-jmx-write"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_JMX_NOTIFY                                        EnumtopologyAdminUserPrivilegeProp = "jmx-notify"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_JMX_NOTIFY                                 EnumtopologyAdminUserPrivilegeProp = "-jmx-notify"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_LDIF_IMPORT                                       EnumtopologyAdminUserPrivilegeProp = "ldif-import"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_LDIF_IMPORT                                EnumtopologyAdminUserPrivilegeProp = "-ldif-import"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_LDIF_EXPORT                                       EnumtopologyAdminUserPrivilegeProp = "ldif-export"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_LDIF_EXPORT                                EnumtopologyAdminUserPrivilegeProp = "-ldif-export"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_BACKEND_BACKUP                                    EnumtopologyAdminUserPrivilegeProp = "backend-backup"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_BACKEND_BACKUP                             EnumtopologyAdminUserPrivilegeProp = "-backend-backup"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_BACKEND_RESTORE                                   EnumtopologyAdminUserPrivilegeProp = "backend-restore"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_BACKEND_RESTORE                            EnumtopologyAdminUserPrivilegeProp = "-backend-restore"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_SERVER_SHUTDOWN                                   EnumtopologyAdminUserPrivilegeProp = "server-shutdown"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_SERVER_SHUTDOWN                            EnumtopologyAdminUserPrivilegeProp = "-server-shutdown"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_SERVER_RESTART                                    EnumtopologyAdminUserPrivilegeProp = "server-restart"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_SERVER_RESTART                             EnumtopologyAdminUserPrivilegeProp = "-server-restart"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_PROXIED_AUTH                                      EnumtopologyAdminUserPrivilegeProp = "proxied-auth"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PROXIED_AUTH                               EnumtopologyAdminUserPrivilegeProp = "-proxied-auth"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_DISCONNECT_CLIENT                                 EnumtopologyAdminUserPrivilegeProp = "disconnect-client"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_DISCONNECT_CLIENT                          EnumtopologyAdminUserPrivilegeProp = "-disconnect-client"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_PASSWORD_RESET                                    EnumtopologyAdminUserPrivilegeProp = "password-reset"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PASSWORD_RESET                             EnumtopologyAdminUserPrivilegeProp = "-password-reset"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_UPDATE_SCHEMA                                     EnumtopologyAdminUserPrivilegeProp = "update-schema"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_UPDATE_SCHEMA                              EnumtopologyAdminUserPrivilegeProp = "-update-schema"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_PRIVILEGE_CHANGE                                  EnumtopologyAdminUserPrivilegeProp = "privilege-change"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PRIVILEGE_CHANGE                           EnumtopologyAdminUserPrivilegeProp = "-privilege-change"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_UNINDEXED_SEARCH                                  EnumtopologyAdminUserPrivilegeProp = "unindexed-search"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_UNINDEXED_SEARCH                           EnumtopologyAdminUserPrivilegeProp = "-unindexed-search"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_UNINDEXED_SEARCH_WITH_CONTROL              EnumtopologyAdminUserPrivilegeProp = "-unindexed-search-with-control"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_BYPASS_PW_POLICY                                  EnumtopologyAdminUserPrivilegeProp = "bypass-pw-policy"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_BYPASS_PW_POLICY                           EnumtopologyAdminUserPrivilegeProp = "-bypass-pw-policy"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_LOCKDOWN_MODE                                     EnumtopologyAdminUserPrivilegeProp = "lockdown-mode"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_LOCKDOWN_MODE                              EnumtopologyAdminUserPrivilegeProp = "-lockdown-mode"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_STREAM_VALUES                                     EnumtopologyAdminUserPrivilegeProp = "stream-values"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_STREAM_VALUES                              EnumtopologyAdminUserPrivilegeProp = "-stream-values"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_THIRD_PARTY_TASK                                  EnumtopologyAdminUserPrivilegeProp = "third-party-task"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_THIRD_PARTY_TASK                           EnumtopologyAdminUserPrivilegeProp = "-third-party-task"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_USE_ADMIN_SESSION                                 EnumtopologyAdminUserPrivilegeProp = "use-admin-session"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_USE_ADMIN_SESSION                          EnumtopologyAdminUserPrivilegeProp = "-use-admin-session"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_SOFT_DELETE_READ                                  EnumtopologyAdminUserPrivilegeProp = "soft-delete-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_SOFT_DELETE_READ                           EnumtopologyAdminUserPrivilegeProp = "-soft-delete-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_METRICS_READ                                      EnumtopologyAdminUserPrivilegeProp = "metrics-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_METRICS_READ                               EnumtopologyAdminUserPrivilegeProp = "-metrics-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REMOTE_LOG_READ                                   EnumtopologyAdminUserPrivilegeProp = "remote-log-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_REMOTE_LOG_READ                            EnumtopologyAdminUserPrivilegeProp = "-remote-log-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_MANAGE_TOPOLOGY                                   EnumtopologyAdminUserPrivilegeProp = "manage-topology"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_MANAGE_TOPOLOGY                            EnumtopologyAdminUserPrivilegeProp = "-manage-topology"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_GET_PASSWORD_POLICY_STATE_ISSUES    EnumtopologyAdminUserPrivilegeProp = "-permit-get-password-policy-state-issues"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_PROXIED_MSCHAPV2_DETAILS            EnumtopologyAdminUserPrivilegeProp = "-permit-proxied-mschapv2-details"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_EXTERNALLY_PROCESSED_AUTHENTICATION EnumtopologyAdminUserPrivilegeProp = "-permit-externally-processed-authentication"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_EXPORT_REVERSIBLE_PASSWORDS         EnumtopologyAdminUserPrivilegeProp = "-permit-export-reversible-passwords"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_FORWARDING_CLIENT_CONNECTION_POLICY EnumtopologyAdminUserPrivilegeProp = "-permit-forwarding-client-connection-policy"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_EXEC_TASK                                         EnumtopologyAdminUserPrivilegeProp = "exec-task"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_EXEC_TASK                                  EnumtopologyAdminUserPrivilegeProp = "-exec-task"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_COLLECT_SUPPORT_DATA                              EnumtopologyAdminUserPrivilegeProp = "collect-support-data"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_COLLECT_SUPPORT_DATA                       EnumtopologyAdminUserPrivilegeProp = "-collect-support-data"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_FILE_SERVLET_ACCESS                               EnumtopologyAdminUserPrivilegeProp = "file-servlet-access"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_FILE_SERVLET_ACCESS                        EnumtopologyAdminUserPrivilegeProp = "-file-servlet-access"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_REPLACE_CERTIFICATE_REQUEST         EnumtopologyAdminUserPrivilegeProp = "-permit-replace-certificate-request"
)
