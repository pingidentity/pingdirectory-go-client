...
const (
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_AUDIT_DATA_SECURITY2                        EnumtopologyAdminUserPrivilegeProp = "-audit-data-security"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_BYPASS_ACL                                         EnumtopologyAdminUserPrivilegeProp = "bypass-acl"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_BYPASS_ACL2                                 EnumtopologyAdminUserPrivilegeProp = "-bypass-acl"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_BYPASS_READ_ACL                                    EnumtopologyAdminUserPrivilegeProp = "bypass-read-acl"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_BYPASS_READ_ACL2                            EnumtopologyAdminUserPrivilegeProp = "-bypass-read-acl"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_MODIFY_ACL                                         EnumtopologyAdminUserPrivilegeProp = "modify-acl"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_MODIFY_ACL2                                 EnumtopologyAdminUserPrivilegeProp = "-modify-acl"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_CONFIG_READ                                        EnumtopologyAdminUserPrivilegeProp = "config-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_CONFIG_READ2                                EnumtopologyAdminUserPrivilegeProp = "-config-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_CONFIG_WRITE                                       EnumtopologyAdminUserPrivilegeProp = "config-write"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_CONFIG_WRITE2                               EnumtopologyAdminUserPrivilegeProp = "-config-write"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_JMX_READ                                           EnumtopologyAdminUserPrivilegeProp = "jmx-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_JMX_READ2                                   EnumtopologyAdminUserPrivilegeProp = "-jmx-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_JMX_WRITE                                          EnumtopologyAdminUserPrivilegeProp = "jmx-write"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_JMX_WRITE2                                  EnumtopologyAdminUserPrivilegeProp = "-jmx-write"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_JMX_NOTIFY                                         EnumtopologyAdminUserPrivilegeProp = "jmx-notify"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_JMX_NOTIFY2                                 EnumtopologyAdminUserPrivilegeProp = "-jmx-notify"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_LDIF_IMPORT                                        EnumtopologyAdminUserPrivilegeProp = "ldif-import"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_LDIF_IMPORT2                                EnumtopologyAdminUserPrivilegeProp = "-ldif-import"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_LDIF_EXPORT                                        EnumtopologyAdminUserPrivilegeProp = "ldif-export"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_LDIF_EXPORT2                                EnumtopologyAdminUserPrivilegeProp = "-ldif-export"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_BACKEND_BACKUP                                     EnumtopologyAdminUserPrivilegeProp = "backend-backup"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_BACKEND_BACKUP2                             EnumtopologyAdminUserPrivilegeProp = "-backend-backup"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_BACKEND_RESTORE                                    EnumtopologyAdminUserPrivilegeProp = "backend-restore"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_BACKEND_RESTORE2                            EnumtopologyAdminUserPrivilegeProp = "-backend-restore"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_SERVER_SHUTDOWN                                    EnumtopologyAdminUserPrivilegeProp = "server-shutdown"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_SERVER_SHUTDOWN2                            EnumtopologyAdminUserPrivilegeProp = "-server-shutdown"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_SERVER_RESTART                                     EnumtopologyAdminUserPrivilegeProp = "server-restart"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_SERVER_RESTART2                             EnumtopologyAdminUserPrivilegeProp = "-server-restart"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_PROXIED_AUTH                                       EnumtopologyAdminUserPrivilegeProp = "proxied-auth"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PROXIED_AUTH2                               EnumtopologyAdminUserPrivilegeProp = "-proxied-auth"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_DISCONNECT_CLIENT                                  EnumtopologyAdminUserPrivilegeProp = "disconnect-client"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_DISCONNECT_CLIENT2                          EnumtopologyAdminUserPrivilegeProp = "-disconnect-client"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_PASSWORD_RESET                                     EnumtopologyAdminUserPrivilegeProp = "password-reset"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PASSWORD_RESET2                             EnumtopologyAdminUserPrivilegeProp = "-password-reset"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_UPDATE_SCHEMA                                      EnumtopologyAdminUserPrivilegeProp = "update-schema"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_UPDATE_SCHEMA2                              EnumtopologyAdminUserPrivilegeProp = "-update-schema"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_PRIVILEGE_CHANGE                                   EnumtopologyAdminUserPrivilegeProp = "privilege-change"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PRIVILEGE_CHANGE2                           EnumtopologyAdminUserPrivilegeProp = "-privilege-change"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_UNINDEXED_SEARCH                                   EnumtopologyAdminUserPrivilegeProp = "unindexed-search"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_UNINDEXED_SEARCH2                           EnumtopologyAdminUserPrivilegeProp = "-unindexed-search"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_UNINDEXED_SEARCH_WITH_CONTROL2              EnumtopologyAdminUserPrivilegeProp = "-unindexed-search-with-control"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_BYPASS_PW_POLICY                                   EnumtopologyAdminUserPrivilegeProp = "bypass-pw-policy"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_BYPASS_PW_POLICY2                           EnumtopologyAdminUserPrivilegeProp = "-bypass-pw-policy"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_LOCKDOWN_MODE                                      EnumtopologyAdminUserPrivilegeProp = "lockdown-mode"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_LOCKDOWN_MODE2                              EnumtopologyAdminUserPrivilegeProp = "-lockdown-mode"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_STREAM_VALUES                                      EnumtopologyAdminUserPrivilegeProp = "stream-values"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_STREAM_VALUES2                              EnumtopologyAdminUserPrivilegeProp = "-stream-values"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_THIRD_PARTY_TASK                                   EnumtopologyAdminUserPrivilegeProp = "third-party-task"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_THIRD_PARTY_TASK2                           EnumtopologyAdminUserPrivilegeProp = "-third-party-task"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_USE_ADMIN_SESSION                                  EnumtopologyAdminUserPrivilegeProp = "use-admin-session"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_USE_ADMIN_SESSION2                          EnumtopologyAdminUserPrivilegeProp = "-use-admin-session"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_SOFT_DELETE_READ                                   EnumtopologyAdminUserPrivilegeProp = "soft-delete-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_SOFT_DELETE_READ2                           EnumtopologyAdminUserPrivilegeProp = "-soft-delete-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_METRICS_READ                                       EnumtopologyAdminUserPrivilegeProp = "metrics-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_METRICS_READ2                               EnumtopologyAdminUserPrivilegeProp = "-metrics-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REMOTE_LOG_READ                                    EnumtopologyAdminUserPrivilegeProp = "remote-log-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_REMOTE_LOG_READ2                            EnumtopologyAdminUserPrivilegeProp = "-remote-log-read"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_MANAGE_TOPOLOGY                                    EnumtopologyAdminUserPrivilegeProp = "manage-topology"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_MANAGE_TOPOLOGY2                            EnumtopologyAdminUserPrivilegeProp = "-manage-topology"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_GET_PASSWORD_POLICY_STATE_ISSUES2    EnumtopologyAdminUserPrivilegeProp = "-permit-get-password-policy-state-issues"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_PROXIED_MSCHAPV2_DETAILS2            EnumtopologyAdminUserPrivilegeProp = "-permit-proxied-mschapv2-details"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_EXTERNALLY_PROCESSED_AUTHENTICATION2 EnumtopologyAdminUserPrivilegeProp = "-permit-externally-processed-authentication"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_EXPORT_REVERSIBLE_PASSWORDS2         EnumtopologyAdminUserPrivilegeProp = "-permit-export-reversible-passwords"
	...
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_PERMIT_FORWARDING_CLIENT_CONNECTION_POLICY2 EnumtopologyAdminUserPrivilegeProp = "-permit-forwarding-client-connection-policy"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_EXEC_TASK                                          EnumtopologyAdminUserPrivilegeProp = "exec-task"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_EXEC_TASK2                                  EnumtopologyAdminUserPrivilegeProp = "-exec-task"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_COLLECT_SUPPORT_DATA                               EnumtopologyAdminUserPrivilegeProp = "collect-support-data"
	ENUMTOPOLOGYADMINUSERPRIVILEGEPROP_REVOKE_COLLECT_SUPPORT_DATA2                       EnumtopologyAdminUserPrivilegeProp = "-collect-support-data"
