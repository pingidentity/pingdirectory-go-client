...
type AddNokiaProxyServerExternalServerRequest struct {
	...
	ConnectionSecurity   *EnumexternalServerNokiaProxyServerConnectionSecurityProp   `json:"connectionSecurity,omitempty"`
	AuthenticationMethod *EnumexternalServerNokiaProxyServerAuthenticationMethodProp `json:"authenticationMethod,omitempty"`
...
// SetConnectionSecurity gets a reference to the given EnumexternalServerNokiaProxyServerConnectionSecurityProp and assigns it to the ConnectionSecurity field.
...
// SetAuthenticationMethod gets a reference to the given EnumexternalServerNokiaProxyServerAuthenticationMethodProp and assigns it to the AuthenticationMethod field.
...
type NullableAddNokiaProxyServerExternalServerRequest struct {
	value *AddNokiaProxyServerExternalServerRequest
	isSet bool
}

func (v NullableAddNokiaProxyServerExternalServerRequest) Get() *AddNokiaProxyServerExternalServerRequest {
	return v.value
}

func (v *NullableAddNokiaProxyServerExternalServerRequest) Set(val *AddNokiaProxyServerExternalServerRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddNokiaProxyServerExternalServerRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddNokiaProxyServerExternalServerRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddNokiaProxyServerExternalServerRequest(val *AddNokiaProxyServerExternalServerRequest) *NullableAddNokiaProxyServerExternalServerRequest {
	return &NullableAddNokiaProxyServerExternalServerRequest{value: val, isSet: true}
}

func (v NullableAddNokiaProxyServerExternalServerRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddNokiaProxyServerExternalServerRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
