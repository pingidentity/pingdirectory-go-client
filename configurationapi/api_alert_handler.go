...
// SCIM filter
func (r ApiListAlertHandlersRequest) Filter(filter string) ApiListAlertHandlersRequest {
	r.filter = &filter
	return r
}

func (r ApiListAlertHandlersRequest) Execute() (*AlertHandlerListResponse, *http.Response, error) {
	return r.ApiService.ListAlertHandlersExecute(r)
}

/*
ListAlertHandlers Returns a list of all Alert Handler objects
