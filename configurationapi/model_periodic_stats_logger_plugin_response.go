...
func (o *PeriodicStatsLoggerPluginResponse) GetIncludeHTTPMetrics() bool {
...
// and a boolean to check if the value has been set.
func (o *PeriodicStatsLoggerPluginResponse) GetIncludeHTTPMetricsOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeHTTPMetrics) {
		return nil, false
	}
...
func (o *PeriodicStatsLoggerPluginResponse) HasIncludeHTTPMetrics() bool {
	if o != nil && !IsNil(o.IncludeHTTPMetrics) {
		return true
	}
...
func (o *PeriodicStatsLoggerPluginResponse) SetIncludeHTTPMetrics(v bool) {
