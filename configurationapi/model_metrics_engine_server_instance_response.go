...
// checks if the MetricsEngineServerInstanceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricsEngineServerInstanceResponse{}
...
func NewMetricsEngineServerInstanceResponse(schemas []EnummetricsEngineServerInstanceSchemaUrn, id string, serverInstanceName string, clusterName string, serverVersion string) *MetricsEngineServerInstanceResponse {
	this := MetricsEngineServerInstanceResponse{}
...
func (o *MetricsEngineServerInstanceResponse) GetSchemas() []EnummetricsEngineServerInstanceSchemaUrn {
	if o == nil {
		var ret []EnummetricsEngineServerInstanceSchemaUrn
		return ret
	}
...
func (o MetricsEngineServerInstanceResponse) MarshalJSON() ([]byte, error) {
...
func (o MetricsEngineServerInstanceResponse) ToMap() (map[string]interface{}, error) {
...
type NullableMetricsEngineServerInstanceResponse struct {
	value *MetricsEngineServerInstanceResponse
	isSet bool
}

func (v NullableMetricsEngineServerInstanceResponse) Get() *MetricsEngineServerInstanceResponse {
	return v.value
}

func (v *NullableMetricsEngineServerInstanceResponse) Set(val *MetricsEngineServerInstanceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricsEngineServerInstanceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricsEngineServerInstanceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricsEngineServerInstanceResponse(val *MetricsEngineServerInstanceResponse) *NullableMetricsEngineServerInstanceResponse {
	return &NullableMetricsEngineServerInstanceResponse{value: val, isSet: true}
}

func (v NullableMetricsEngineServerInstanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricsEngineServerInstanceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
