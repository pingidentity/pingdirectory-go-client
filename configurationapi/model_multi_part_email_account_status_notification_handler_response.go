...
// checks if the MultiPartEmailAccountStatusNotificationHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiPartEmailAccountStatusNotificationHandlerResponse{}
...
type NullableMultiPartEmailAccountStatusNotificationHandlerResponse struct {
	value *MultiPartEmailAccountStatusNotificationHandlerResponse
	isSet bool
}

func (v NullableMultiPartEmailAccountStatusNotificationHandlerResponse) Get() *MultiPartEmailAccountStatusNotificationHandlerResponse {
	return v.value
}

func (v *NullableMultiPartEmailAccountStatusNotificationHandlerResponse) Set(val *MultiPartEmailAccountStatusNotificationHandlerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiPartEmailAccountStatusNotificationHandlerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiPartEmailAccountStatusNotificationHandlerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiPartEmailAccountStatusNotificationHandlerResponse(val *MultiPartEmailAccountStatusNotificationHandlerResponse) *NullableMultiPartEmailAccountStatusNotificationHandlerResponse {
	return &NullableMultiPartEmailAccountStatusNotificationHandlerResponse{value: val, isSet: true}
}

func (v NullableMultiPartEmailAccountStatusNotificationHandlerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiPartEmailAccountStatusNotificationHandlerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
