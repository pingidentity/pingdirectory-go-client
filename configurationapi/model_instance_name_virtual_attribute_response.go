...
// checks if the InstanceNameVirtualAttributeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceNameVirtualAttributeResponse{}
...
func NewInstanceNameVirtualAttributeResponse(schemas []EnuminstanceNameVirtualAttributeSchemaUrn, id string, attributeType string, enabled bool) *InstanceNameVirtualAttributeResponse {
	this := InstanceNameVirtualAttributeResponse{}
...
func (o *InstanceNameVirtualAttributeResponse) GetSchemas() []EnuminstanceNameVirtualAttributeSchemaUrn {
	if o == nil {
		var ret []EnuminstanceNameVirtualAttributeSchemaUrn
		return ret
	}
...
func (o InstanceNameVirtualAttributeResponse) MarshalJSON() ([]byte, error) {
...
func (o InstanceNameVirtualAttributeResponse) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceNameVirtualAttributeResponse struct {
	value *InstanceNameVirtualAttributeResponse
	isSet bool
}

func (v NullableInstanceNameVirtualAttributeResponse) Get() *InstanceNameVirtualAttributeResponse {
	return v.value
}

func (v *NullableInstanceNameVirtualAttributeResponse) Set(val *InstanceNameVirtualAttributeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceNameVirtualAttributeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceNameVirtualAttributeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceNameVirtualAttributeResponse(val *InstanceNameVirtualAttributeResponse) *NullableInstanceNameVirtualAttributeResponse {
	return &NullableInstanceNameVirtualAttributeResponse{value: val, isSet: true}
}

func (v NullableInstanceNameVirtualAttributeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceNameVirtualAttributeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
