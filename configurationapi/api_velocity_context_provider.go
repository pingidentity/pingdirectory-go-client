...
func (a *VelocityContextProviderApiService) DeleteVelocityContextProviderExecute(r ApiDeleteVelocityContextProviderRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"velocity-context-provider-name"+"}", url.PathEscape(parameterValueToString(r.velocityContextProviderName, "velocityContextProviderName")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"http-servlet-extension-name"+"}", url.PathEscape(parameterValueToString(r.httpServletExtensionName, "httpServletExtensionName")), -1)
...
// SCIM filter
func (r ApiListVelocityContextProvidersRequest) Filter(filter string) ApiListVelocityContextProvidersRequest {
	r.filter = &filter
	return r
}

func (r ApiListVelocityContextProvidersRequest) Execute() (*VelocityContextProviderListResponse, *http.Response, error) {
	return r.ApiService.ListVelocityContextProvidersExecute(r)
}

/*
ListVelocityContextProviders Returns a list of all Velocity Context Provider objects
