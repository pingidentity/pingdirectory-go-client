...
// checks if the OpendjExternalServerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpendjExternalServerResponse{}
