...
// checks if the AddLastAccessTimeUncachedEntryCriteriaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddLastAccessTimeUncachedEntryCriteriaRequest{}
