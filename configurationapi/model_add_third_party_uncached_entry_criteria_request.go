...
// checks if the AddThirdPartyUncachedEntryCriteriaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddThirdPartyUncachedEntryCriteriaRequest{}
