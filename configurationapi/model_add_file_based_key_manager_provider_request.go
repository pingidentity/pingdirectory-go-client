...
// checks if the AddFileBasedKeyManagerProviderRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddFileBasedKeyManagerProviderRequest{}
