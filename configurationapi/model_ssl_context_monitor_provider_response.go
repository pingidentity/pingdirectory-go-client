...
// checks if the SslContextMonitorProviderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SslContextMonitorProviderResponse{}
...
func (o SslContextMonitorProviderResponse) ToMap() (map[string]interface{}, error) {
