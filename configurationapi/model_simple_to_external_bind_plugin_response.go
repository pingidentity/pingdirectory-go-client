...
// checks if the SimpleToExternalBindPluginResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SimpleToExternalBindPluginResponse{}
