...
// checks if the SnmpSubAgentAlertHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnmpSubAgentAlertHandlerResponse{}
...
func (o SnmpSubAgentAlertHandlerResponse) ToMap() (map[string]interface{}, error) {
