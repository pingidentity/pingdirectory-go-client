...
func (a *ServerGroupApiService) DeleteServerGroupExecute(r ApiDeleteServerGroupRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"server-group-name"+"}", url.PathEscape(parameterValueToString(r.serverGroupName, "serverGroupName")), -1)
...
// SCIM filter
func (r ApiListServerGroupsRequest) Filter(filter string) ApiListServerGroupsRequest {
	r.filter = &filter
	return r
}

func (r ApiListServerGroupsRequest) Execute() (*ServerGroupListResponse, *http.Response, error) {
	return r.ApiService.ListServerGroupsExecute(r)
}

/*
ListServerGroups Returns a list of all Server Group objects
