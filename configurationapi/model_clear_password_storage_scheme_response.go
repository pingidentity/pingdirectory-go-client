...
// checks if the ClearPasswordStorageSchemeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClearPasswordStorageSchemeResponse{}
...
func (o ClearPasswordStorageSchemeResponse) ToMap() (map[string]interface{}, error) {
