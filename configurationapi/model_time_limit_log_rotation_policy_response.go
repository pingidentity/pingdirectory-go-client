...
// checks if the TimeLimitLogRotationPolicyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeLimitLogRotationPolicyResponse{}
...
func (o TimeLimitLogRotationPolicyResponse) ToMap() (map[string]interface{}, error) {
