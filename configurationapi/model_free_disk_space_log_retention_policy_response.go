...
// checks if the FreeDiskSpaceLogRetentionPolicyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FreeDiskSpaceLogRetentionPolicyResponse{}
