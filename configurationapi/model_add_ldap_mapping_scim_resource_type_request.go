...
// checks if the AddLdapMappingScimResourceTypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddLdapMappingScimResourceTypeRequest{}
...
type NullableAddLdapMappingScimResourceTypeRequest struct {
	value *AddLdapMappingScimResourceTypeRequest
	isSet bool
}

func (v NullableAddLdapMappingScimResourceTypeRequest) Get() *AddLdapMappingScimResourceTypeRequest {
	return v.value
}

func (v *NullableAddLdapMappingScimResourceTypeRequest) Set(val *AddLdapMappingScimResourceTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddLdapMappingScimResourceTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddLdapMappingScimResourceTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddLdapMappingScimResourceTypeRequest(val *AddLdapMappingScimResourceTypeRequest) *NullableAddLdapMappingScimResourceTypeRequest {
	return &NullableAddLdapMappingScimResourceTypeRequest{value: val, isSet: true}
}

func (v NullableAddLdapMappingScimResourceTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddLdapMappingScimResourceTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
