...
// checks if the ThirdPartyErrorLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThirdPartyErrorLogPublisherResponse{}
...
type NullableThirdPartyErrorLogPublisherResponse struct {
	value *ThirdPartyErrorLogPublisherResponse
	isSet bool
}

func (v NullableThirdPartyErrorLogPublisherResponse) Get() *ThirdPartyErrorLogPublisherResponse {
	return v.value
}

func (v *NullableThirdPartyErrorLogPublisherResponse) Set(val *ThirdPartyErrorLogPublisherResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableThirdPartyErrorLogPublisherResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableThirdPartyErrorLogPublisherResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThirdPartyErrorLogPublisherResponse(val *ThirdPartyErrorLogPublisherResponse) *NullableThirdPartyErrorLogPublisherResponse {
	return &NullableThirdPartyErrorLogPublisherResponse{value: val, isSet: true}
}

func (v NullableThirdPartyErrorLogPublisherResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThirdPartyErrorLogPublisherResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
