...
// checks if the LargeAttributeVirtualAttributeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LargeAttributeVirtualAttributeResponse{}

// LargeAttributeVirtualAttributeResponse struct for LargeAttributeVirtualAttributeResponse
type LargeAttributeVirtualAttributeResponse struct {
	Meta                                          *MetaMeta                                          `json:"meta,omitempty"`
	Urnpingidentityschemasconfigurationmessages20 *MetaUrnPingidentitySchemasConfigurationMessages20 `json:"urn:pingidentity:schemas:configuration:messages:2.0,omitempty"`
	Schemas                                       []EnumlargeAttributeVirtualAttributeSchemaUrn      `json:"schemas"`
...
func NewLargeAttributeVirtualAttributeResponse(schemas []EnumlargeAttributeVirtualAttributeSchemaUrn, id string, enabled bool, attributeType string) *LargeAttributeVirtualAttributeResponse {
	this := LargeAttributeVirtualAttributeResponse{}
...
func (o *LargeAttributeVirtualAttributeResponse) GetSchemas() []EnumlargeAttributeVirtualAttributeSchemaUrn {
	if o == nil {
		var ret []EnumlargeAttributeVirtualAttributeSchemaUrn
		return ret
	}
...
func (o LargeAttributeVirtualAttributeResponse) MarshalJSON() ([]byte, error) {
...
func (o LargeAttributeVirtualAttributeResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLargeAttributeVirtualAttributeResponse struct {
	value *LargeAttributeVirtualAttributeResponse
	isSet bool
}

func (v NullableLargeAttributeVirtualAttributeResponse) Get() *LargeAttributeVirtualAttributeResponse {
	return v.value
}

func (v *NullableLargeAttributeVirtualAttributeResponse) Set(val *LargeAttributeVirtualAttributeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLargeAttributeVirtualAttributeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLargeAttributeVirtualAttributeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLargeAttributeVirtualAttributeResponse(val *LargeAttributeVirtualAttributeResponse) *NullableLargeAttributeVirtualAttributeResponse {
	return &NullableLargeAttributeVirtualAttributeResponse{value: val, isSet: true}
}

func (v NullableLargeAttributeVirtualAttributeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLargeAttributeVirtualAttributeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
