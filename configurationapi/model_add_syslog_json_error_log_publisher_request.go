...
func NewAddSyslogJsonErrorLogPublisherRequest(schemas []EnumsyslogJsonErrorLogPublisherSchemaUrn, syslogExternalServer []string, enabled bool, publisherName string) *AddSyslogJsonErrorLogPublisherRequest {
...
func (o *AddSyslogJsonErrorLogPublisherRequest) GetQueueSize() int64 {
...
// and a boolean to check if the value has been set.
func (o *AddSyslogJsonErrorLogPublisherRequest) GetQueueSizeOk() (*int64, bool) {
	if o == nil || IsNil(o.QueueSize) {
		return nil, false
	}
...
func (o *AddSyslogJsonErrorLogPublisherRequest) SetQueueSize(v int64) {
	o.QueueSize = &v
}
...
func (o *AddSyslogJsonErrorLogPublisherRequest) GetLogMessageExclusionPolicy() []string {
...
// and a boolean to check if the value has been set.
func (o *AddSyslogJsonErrorLogPublisherRequest) GetLogMessageExclusionPolicyOk() ([]string, bool) {
	if o == nil || IsNil(o.LogMessageExclusionPolicy) {
		return nil, false
	}
...
func (o *AddSyslogJsonErrorLogPublisherRequest) HasLogMessageExclusionPolicy() bool {
	if o != nil && !IsNil(o.LogMessageExclusionPolicy) {
		return true
	}
...
func (o *AddSyslogJsonErrorLogPublisherRequest) SetLogMessageExclusionPolicy(v []string) {
