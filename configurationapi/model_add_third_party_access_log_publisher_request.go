...
// checks if the AddThirdPartyAccessLogPublisherRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddThirdPartyAccessLogPublisherRequest{}
