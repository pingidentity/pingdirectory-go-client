...
func (a *PluginAPIService) AddPluginExecute(r ApiAddPluginRequest) (*AddPlugin200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/plugin-root/plugins"
...
func (a *PluginAPIService) DeletePluginExecute(r ApiDeletePluginRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/plugin-root/plugins/{plugin-name}"
...
// SCIM filter
func (r ApiListPluginsRequest) Filter(filter string) ApiListPluginsRequest {
	r.filter = &filter
	return r
}

func (r ApiListPluginsRequest) Execute() (*PluginListResponse, *http.Response, error) {
	return r.ApiService.ListPluginsExecute(r)
}

/*
ListPlugins Returns a list of all Plugin objects
