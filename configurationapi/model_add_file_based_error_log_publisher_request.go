...
func NewAddFileBasedErrorLogPublisherRequest(publisherName string, schemas []EnumfileBasedErrorLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool) *AddFileBasedErrorLogPublisherRequest {
