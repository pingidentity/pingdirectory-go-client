...
type NullablePasswordPolicyStateJsonVirtualAttributeResponse struct {
	value *PasswordPolicyStateJsonVirtualAttributeResponse
	isSet bool
}

func (v NullablePasswordPolicyStateJsonVirtualAttributeResponse) Get() *PasswordPolicyStateJsonVirtualAttributeResponse {
	return v.value
}

func (v *NullablePasswordPolicyStateJsonVirtualAttributeResponse) Set(val *PasswordPolicyStateJsonVirtualAttributeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePasswordPolicyStateJsonVirtualAttributeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePasswordPolicyStateJsonVirtualAttributeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePasswordPolicyStateJsonVirtualAttributeResponse(val *PasswordPolicyStateJsonVirtualAttributeResponse) *NullablePasswordPolicyStateJsonVirtualAttributeResponse {
	return &NullablePasswordPolicyStateJsonVirtualAttributeResponse{value: val, isSet: true}
}

func (v NullablePasswordPolicyStateJsonVirtualAttributeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePasswordPolicyStateJsonVirtualAttributeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
