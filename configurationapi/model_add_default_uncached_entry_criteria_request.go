...
// checks if the AddDefaultUncachedEntryCriteriaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddDefaultUncachedEntryCriteriaRequest{}
...
func (o AddDefaultUncachedEntryCriteriaRequest) ToMap() (map[string]interface{}, error) {
