...
// checks if the EnvironmentVariablePassphraseProviderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentVariablePassphraseProviderResponse{}
...
func (o EnvironmentVariablePassphraseProviderResponse) ToMap() (map[string]interface{}, error) {
