...
// checks if the TwilioOtpDeliveryMechanismResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TwilioOtpDeliveryMechanismResponse{}
