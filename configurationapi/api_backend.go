...
// SCIM filter
func (r ApiListBackendsRequest) Filter(filter string) ApiListBackendsRequest {
	r.filter = &filter
	return r
}

func (r ApiListBackendsRequest) Execute() (*BackendListResponse, *http.Response, error) {
	return r.ApiService.ListBackendsExecute(r)
}

/*
ListBackends Returns a list of all Backend objects
