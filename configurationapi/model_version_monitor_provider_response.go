...
// checks if the VersionMonitorProviderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VersionMonitorProviderResponse{}
...
func (o VersionMonitorProviderResponse) ToMap() (map[string]interface{}, error) {
