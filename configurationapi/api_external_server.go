...
// SCIM filter
func (r ApiListExternalServersRequest) Filter(filter string) ApiListExternalServersRequest {
	r.filter = &filter
	return r
}

func (r ApiListExternalServersRequest) Execute() (*ExternalServerListResponse, *http.Response, error) {
	return r.ApiService.ListExternalServersExecute(r)
}

/*
ListExternalServers Returns a list of all External Server objects
