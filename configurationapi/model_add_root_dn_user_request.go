...
// checks if the AddRootDnUserRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddRootDnUserRequest{}
...
type AddRootDnUserRequest struct {
	...
	SearchResultEntryLimit *int64 `json:"searchResultEntryLimit,omitempty"`
	...
	LookThroughEntryLimit *int64 `json:"lookThroughEntryLimit,omitempty"`
...
// SetSearchResultEntryLimit gets a reference to the given int64 and assigns it to the SearchResultEntryLimit field.
...
// SetTimeLimitSeconds gets a reference to the given int64 and assigns it to the TimeLimitSeconds field.
...
// SetLookThroughEntryLimit gets a reference to the given int64 and assigns it to the LookThroughEntryLimit field.
...
// SetIdleTimeLimitSeconds gets a reference to the given int64 and assigns it to the IdleTimeLimitSeconds field.
...
type NullableAddRootDnUserRequest struct {
	value *AddRootDnUserRequest
	isSet bool
}

func (v NullableAddRootDnUserRequest) Get() *AddRootDnUserRequest {
	return v.value
}

func (v *NullableAddRootDnUserRequest) Set(val *AddRootDnUserRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddRootDnUserRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddRootDnUserRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddRootDnUserRequest(val *AddRootDnUserRequest) *NullableAddRootDnUserRequest {
	return &NullableAddRootDnUserRequest{value: val, isSet: true}
}

func (v NullableAddRootDnUserRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddRootDnUserRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
