...
// checks if the ConsoleJsonAuditLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsoleJsonAuditLogPublisherResponse{}

// ConsoleJsonAuditLogPublisherResponse struct for ConsoleJsonAuditLogPublisherResponse
type ConsoleJsonAuditLogPublisherResponse struct {
...
func NewConsoleJsonAuditLogPublisherResponse(schemas []EnumconsoleJsonAuditLogPublisherSchemaUrn, enabled bool, id string) *ConsoleJsonAuditLogPublisherResponse {
	this := ConsoleJsonAuditLogPublisherResponse{}
...
func (o *ConsoleJsonAuditLogPublisherResponse) GetUrnpingidentityschemasconfigurationmessages20() MetaUrnPingidentitySchemasConfigurationMessages20 {
...
// and a boolean to check if the value has been set.
func (o *ConsoleJsonAuditLogPublisherResponse) GetUrnpingidentityschemasconfigurationmessages20Ok() (*MetaUrnPingidentitySchemasConfigurationMessages20, bool) {
	if o == nil || IsNil(o.Urnpingidentityschemasconfigurationmessages20) {
		return nil, false
	}
...
func (o *ConsoleJsonAuditLogPublisherResponse) HasUrnpingidentityschemasconfigurationmessages20() bool {
	if o != nil && !IsNil(o.Urnpingidentityschemasconfigurationmessages20) {
		return true
	}
...
func (o *ConsoleJsonAuditLogPublisherResponse) SetUrnpingidentityschemasconfigurationmessages20(v MetaUrnPingidentitySchemasConfigurationMessages20) {
...
func (o ConsoleJsonAuditLogPublisherResponse) ToMap() (map[string]interface{}, error) {
...
type NullableConsoleJsonAuditLogPublisherResponse struct {
	value *ConsoleJsonAuditLogPublisherResponse
	isSet bool
}

func (v NullableConsoleJsonAuditLogPublisherResponse) Get() *ConsoleJsonAuditLogPublisherResponse {
	return v.value
}

func (v *NullableConsoleJsonAuditLogPublisherResponse) Set(val *ConsoleJsonAuditLogPublisherResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableConsoleJsonAuditLogPublisherResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableConsoleJsonAuditLogPublisherResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConsoleJsonAuditLogPublisherResponse(val *ConsoleJsonAuditLogPublisherResponse) *NullableConsoleJsonAuditLogPublisherResponse {
	return &NullableConsoleJsonAuditLogPublisherResponse{value: val, isSet: true}
}

func (v NullableConsoleJsonAuditLogPublisherResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConsoleJsonAuditLogPublisherResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
