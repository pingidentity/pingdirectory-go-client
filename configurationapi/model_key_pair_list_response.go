...
type KeyPairListResponse struct {
	...
	Resources    []KeyPairResponse `json:"Resources,omitempty"`
}
...
// SetResources gets a reference to the given []KeyPairResponse and assigns it to the Resources field.
