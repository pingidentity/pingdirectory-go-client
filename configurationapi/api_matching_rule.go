...
func (a *MatchingRuleApiService) GetMatchingRuleExecute(r ApiGetMatchingRuleRequest) (*GetMatchingRule200Response, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"matching-rule-name"+"}", url.PathEscape(parameterValueToString(r.matchingRuleName, "matchingRuleName")), -1)
...
// SCIM filter
func (r ApiListMatchingRulesRequest) Filter(filter string) ApiListMatchingRulesRequest {
	r.filter = &filter
	return r
}

func (r ApiListMatchingRulesRequest) Execute() (*MatchingRuleListResponse, *http.Response, error) {
	return r.ApiService.ListMatchingRulesExecute(r)
}

/*
ListMatchingRules Returns a list of all Matching Rule objects
...
func (a *MatchingRuleApiService) ListMatchingRulesExecute(r ApiListMatchingRulesRequest) (*MatchingRuleListResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/matching-rules"
