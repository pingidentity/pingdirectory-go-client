...
// checks if the PasswordPolicyListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PasswordPolicyListResponse{}

// PasswordPolicyListResponse struct for PasswordPolicyListResponse
type PasswordPolicyListResponse struct {
	Schemas      []string                 `json:"schemas,omitempty"`
	TotalResults *float64                 `json:"totalResults,omitempty"`
	Resources    []PasswordPolicyResponse `json:"Resources,omitempty"`
}
...
func NewPasswordPolicyListResponse() *PasswordPolicyListResponse {
	this := PasswordPolicyListResponse{}
	return &this
}
...
func (o *PasswordPolicyListResponse) GetResources() []PasswordPolicyResponse {
	if o == nil || IsNil(o.Resources) {
		var ret []PasswordPolicyResponse
		return ret
	}
	return o.Resources
}
...
// SetResources gets a reference to the given []PasswordPolicyResponse and assigns it to the Resources field.
func (o *PasswordPolicyListResponse) SetResources(v []PasswordPolicyResponse) {
	o.Resources = v
}

func (o PasswordPolicyListResponse) MarshalJSON() ([]byte, error) {
...
func (o PasswordPolicyListResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePasswordPolicyListResponse struct {
	value *PasswordPolicyListResponse
	isSet bool
}

func (v NullablePasswordPolicyListResponse) Get() *PasswordPolicyListResponse {
	return v.value
}

func (v *NullablePasswordPolicyListResponse) Set(val *PasswordPolicyListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePasswordPolicyListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePasswordPolicyListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePasswordPolicyListResponse(val *PasswordPolicyListResponse) *NullablePasswordPolicyListResponse {
	return &NullablePasswordPolicyListResponse{value: val, isSet: true}
}

func (v NullablePasswordPolicyListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePasswordPolicyListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
