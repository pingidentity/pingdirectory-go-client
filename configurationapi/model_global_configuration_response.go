...
type GlobalConfigurationResponse struct {
	...
	UnauthenticatedSizeLimit *int64 `json:"unauthenticatedSizeLimit,omitempty"`
	...
	UnauthenticatedLookthroughLimit *int64 `json:"unauthenticatedLookthroughLimit,omitempty"`
...
// SetUnauthenticatedSizeLimit gets a reference to the given int64 and assigns it to the UnauthenticatedSizeLimit field.
...
// SetUnauthenticatedLookthroughLimit gets a reference to the given int64 and assigns it to the UnauthenticatedLookthroughLimit field.
