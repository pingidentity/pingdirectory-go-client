...
// checks if the IntegerAttributeSyntaxResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegerAttributeSyntaxResponse{}
...
func (o IntegerAttributeSyntaxResponse) ToMap() (map[string]interface{}, error) {
