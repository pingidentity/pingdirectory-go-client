...
// checks if the GetConnectionIdExtendedOperationHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetConnectionIdExtendedOperationHandlerResponse{}
...
func (o GetConnectionIdExtendedOperationHandlerResponse) ToMap() (map[string]interface{}, error) {
