...
// checks if the DebugAccessLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DebugAccessLogPublisherResponse{}
...
func NewDebugAccessLogPublisherResponse(schemas []EnumdebugAccessLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool, id string) *DebugAccessLogPublisherResponse {
...
func (o DebugAccessLogPublisherResponse) ToMap() (map[string]interface{}, error) {
