...
// checks if the AddGenericRestResourceTypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddGenericRestResourceTypeRequest{}
