...
// checks if the SunDsExternalServerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SunDsExternalServerResponse{}

// SunDsExternalServerResponse struct for SunDsExternalServerResponse
type SunDsExternalServerResponse struct {
	Meta                                          *MetaMeta                                          `json:"meta,omitempty"`
	Urnpingidentityschemasconfigurationmessages20 *MetaUrnPingidentitySchemasConfigurationMessages20 `json:"urn:pingidentity:schemas:configuration:messages:2.0,omitempty"`
	Schemas                                       []EnumsunDsExternalServerSchemaUrn                 `json:"schemas"`
	...
	ConnectionSecurity      EnumexternalServerSunDsConnectionSecurityProp   `json:"connectionSecurity"`
	AuthenticationMethod    EnumexternalServerSunDsAuthenticationMethodProp `json:"authenticationMethod"`
...
func NewSunDsExternalServerResponse(schemas []EnumsunDsExternalServerSchemaUrn, id string, serverHostName string, serverPort int64, connectionSecurity EnumexternalServerSunDsConnectionSecurityProp, authenticationMethod EnumexternalServerSunDsAuthenticationMethodProp, verifyCredentialsMethod EnumexternalServerVerifyCredentialsMethodProp, maxConnectionAge string, connectTimeout string, maxResponseSize string) *SunDsExternalServerResponse {
	this := SunDsExternalServerResponse{}
...
func (o *SunDsExternalServerResponse) GetSchemas() []EnumsunDsExternalServerSchemaUrn {
	if o == nil {
		var ret []EnumsunDsExternalServerSchemaUrn
		return ret
	}
...
func (o *SunDsExternalServerResponse) GetConnectionSecurity() EnumexternalServerSunDsConnectionSecurityProp {
	if o == nil {
		var ret EnumexternalServerSunDsConnectionSecurityProp
		return ret
	}
...
func (o *SunDsExternalServerResponse) GetAuthenticationMethod() EnumexternalServerSunDsAuthenticationMethodProp {
	if o == nil {
		var ret EnumexternalServerSunDsAuthenticationMethodProp
		return ret
	}
...
func (o SunDsExternalServerResponse) MarshalJSON() ([]byte, error) {
...
func (o SunDsExternalServerResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSunDsExternalServerResponse struct {
	value *SunDsExternalServerResponse
	isSet bool
}

func (v NullableSunDsExternalServerResponse) Get() *SunDsExternalServerResponse {
	return v.value
}

func (v *NullableSunDsExternalServerResponse) Set(val *SunDsExternalServerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSunDsExternalServerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSunDsExternalServerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSunDsExternalServerResponse(val *SunDsExternalServerResponse) *NullableSunDsExternalServerResponse {
	return &NullableSunDsExternalServerResponse{value: val, isSet: true}
}

func (v NullableSunDsExternalServerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSunDsExternalServerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
