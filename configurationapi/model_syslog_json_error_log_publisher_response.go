...
func (o *SyslogJsonErrorLogPublisherResponse) GetLogMessageExclusionPolicy() []string {
...
// and a boolean to check if the value has been set.
func (o *SyslogJsonErrorLogPublisherResponse) GetLogMessageExclusionPolicyOk() ([]string, bool) {
	if o == nil || IsNil(o.LogMessageExclusionPolicy) {
		return nil, false
	}
...
func (o *SyslogJsonErrorLogPublisherResponse) HasLogMessageExclusionPolicy() bool {
	if o != nil && !IsNil(o.LogMessageExclusionPolicy) {
		return true
	}
...
func (o *SyslogJsonErrorLogPublisherResponse) SetLogMessageExclusionPolicy(v []string) {
