...
// SCIM filter
func (r ApiListConjurAuthenticationMethodsRequest) Filter(filter string) ApiListConjurAuthenticationMethodsRequest {
	r.filter = &filter
	return r
}

func (r ApiListConjurAuthenticationMethodsRequest) Execute() (*ConjurAuthenticationMethodListResponse, *http.Response, error) {
	return r.ApiService.ListConjurAuthenticationMethodsExecute(r)
}

/*
ListConjurAuthenticationMethods Returns a list of all Conjur Authentication Method objects
