...
// checks if the EqualityMatchingRuleResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EqualityMatchingRuleResponse{}
...
func (o EqualityMatchingRuleResponse) ToMap() (map[string]interface{}, error) {
