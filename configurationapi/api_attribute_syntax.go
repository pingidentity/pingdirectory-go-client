...
func (a *AttributeSyntaxApiService) GetAttributeSyntaxExecute(r ApiGetAttributeSyntaxRequest) (*GetAttributeSyntax200Response, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"attribute-syntax-name"+"}", url.PathEscape(parameterValueToString(r.attributeSyntaxName, "attributeSyntaxName")), -1)
...
// SCIM filter
func (r ApiListAttributeSyntaxesRequest) Filter(filter string) ApiListAttributeSyntaxesRequest {
	r.filter = &filter
	return r
}

func (r ApiListAttributeSyntaxesRequest) Execute() (*AttributeSyntaxListResponse, *http.Response, error) {
	return r.ApiService.ListAttributeSyntaxesExecute(r)
}

/*
ListAttributeSyntaxes Returns a list of all Attribute Syntax objects
...
func (a *AttributeSyntaxApiService) ListAttributeSyntaxesExecute(r ApiListAttributeSyntaxesRequest) (*AttributeSyntaxListResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/attribute-syntaxes"
