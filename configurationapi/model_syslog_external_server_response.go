...
// checks if the SyslogExternalServerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogExternalServerResponse{}
