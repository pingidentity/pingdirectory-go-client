...
// checks if the SizeLimitLogRotationPolicyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SizeLimitLogRotationPolicyResponse{}
...
func (o SizeLimitLogRotationPolicyResponse) ToMap() (map[string]interface{}, error) {
