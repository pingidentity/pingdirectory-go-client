...
// checks if the ThirdPartySearchEntryCriteriaResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThirdPartySearchEntryCriteriaResponse{}
...
func (o ThirdPartySearchEntryCriteriaResponse) ToMap() (map[string]interface{}, error) {
