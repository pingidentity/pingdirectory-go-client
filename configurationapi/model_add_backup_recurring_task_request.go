...
// checks if the AddBackupRecurringTaskRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddBackupRecurringTaskRequest{}
