...
`func (o *AddScimResourceTypeRequest) GetIdAttribute() string`

GetIdAttribute returns the IdAttribute field if non-nil, zero value otherwise.

### GetIdAttributeOk

`func (o *AddScimResourceTypeRequest) GetIdAttributeOk() (*string, bool)`
...
`func (o *AddScimResourceTypeRequest) SetIdAttribute(v string)`

SetIdAttribute sets IdAttribute field to given value.

### HasIdAttribute

`func (o *AddScimResourceTypeRequest) HasIdAttribute() bool`
