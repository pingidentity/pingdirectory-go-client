...
`func (o *AddGroovyScriptedErrorLogPublisherRequest) GetLogMessageExclusionPolicy() []string`
...
`func (o *AddGroovyScriptedErrorLogPublisherRequest) GetLogMessageExclusionPolicyOk() (*[]string, bool)`
...
`func (o *AddGroovyScriptedErrorLogPublisherRequest) SetLogMessageExclusionPolicy(v []string)`

SetLogMessageExclusionPolicy sets LogMessageExclusionPolicy field to given value.

### HasLogMessageExclusionPolicy

`func (o *AddGroovyScriptedErrorLogPublisherRequest) HasLogMessageExclusionPolicy() bool`
