...
`func NewStatsdMonitoringEndpointResponse(schemas []EnumstatsdMonitoringEndpointSchemaUrn, hostname string, serverPort int64, connectionType EnummonitoringEndpointConnectionTypeProp, enabled bool, id string, ) *StatsdMonitoringEndpointResponse`
