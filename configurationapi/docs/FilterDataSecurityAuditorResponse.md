...
`func NewFilterDataSecurityAuditorResponse(schemas []EnumfilterDataSecurityAuditorSchemaUrn, reportFile string, filter []string, enabled bool, id string, ) *FilterDataSecurityAuditorResponse`
