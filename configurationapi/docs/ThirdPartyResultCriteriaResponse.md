...
`func NewThirdPartyResultCriteriaResponse(schemas []EnumthirdPartyResultCriteriaSchemaUrn, extensionClass string, id string, ) *ThirdPartyResultCriteriaResponse`
