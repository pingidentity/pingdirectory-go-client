...
`func (o *AddCipherStreamProviderRequest) GetIterationCount() int64`

GetIterationCount returns the IterationCount field if non-nil, zero value otherwise.

### GetIterationCountOk

`func (o *AddCipherStreamProviderRequest) GetIterationCountOk() (*int64, bool)`
...
`func (o *AddCipherStreamProviderRequest) SetIterationCount(v int64)`

SetIterationCount sets IterationCount field to given value.

### HasIterationCount

`func (o *AddCipherStreamProviderRequest) HasIterationCount() bool`
...
`func (o *AddCipherStreamProviderRequest) GetKeyWrappingTransformation() string`
...
`func (o *AddCipherStreamProviderRequest) GetKeyWrappingTransformationOk() (*string, bool)`
...
`func (o *AddCipherStreamProviderRequest) SetKeyWrappingTransformation(v string)`

SetKeyWrappingTransformation sets KeyWrappingTransformation field to given value.

### HasKeyWrappingTransformation

`func (o *AddCipherStreamProviderRequest) HasKeyWrappingTransformation() bool`
