...
`func NewIndicatorGaugeDataSourceResponse(schemas []EnumindicatorGaugeDataSourceSchemaUrn, monitorObjectclass string, monitorAttribute string, id string, ) *IndicatorGaugeDataSourceResponse`
