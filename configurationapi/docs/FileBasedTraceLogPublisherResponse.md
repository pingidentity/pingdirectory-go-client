...
`func NewFileBasedTraceLogPublisherResponse(schemas []EnumfileBasedTraceLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool, id string, ) *FileBasedTraceLogPublisherResponse`
