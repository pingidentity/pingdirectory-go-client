...
`func NewThirdPartyVelocityContextProviderResponse(schemas []EnumthirdPartyVelocityContextProviderSchemaUrn, extensionClass string, id string, ) *ThirdPartyVelocityContextProviderResponse`
