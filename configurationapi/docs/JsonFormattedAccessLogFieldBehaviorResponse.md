...
`func NewJsonFormattedAccessLogFieldBehaviorResponse(schemas []EnumjsonFormattedAccessLogFieldBehaviorSchemaUrn, id string, ) *JsonFormattedAccessLogFieldBehaviorResponse`
