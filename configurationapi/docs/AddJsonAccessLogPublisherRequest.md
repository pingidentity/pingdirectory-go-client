...
**LogFilePermissions** | Pointer to **string** | The UNIX permissions of the log files created by this JSON Access Log Publisher. | [optional] 
**RotationPolicy** | Pointer to **[]string** | The rotation policy to use for the JSON Access Log Publisher . | [optional] 
...
**RetentionPolicy** | Pointer to **[]string** | The retention policy to use for the JSON Access Log Publisher . | [optional] 
...
**Asynchronous** | Pointer to **bool** | Indicates whether the JSON Access Log Publisher will publish records asynchronously. | [optional] 
