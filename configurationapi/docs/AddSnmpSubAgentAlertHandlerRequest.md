...
`func NewAddSnmpSubAgentAlertHandlerRequest(schemas []EnumsnmpSubAgentAlertHandlerSchemaUrn, enabled bool, handlerName string, ) *AddSnmpSubAgentAlertHandlerRequest`
