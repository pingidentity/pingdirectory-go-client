...
**LogFilePermissions** | Pointer to **string** | The UNIX permissions of the log files created by this File Based Debug Log Publisher. | [optional] 
**RotationPolicy** | Pointer to **[]string** | The rotation policy to use for the File Based Debug Log Publisher . | [optional] 
...
**RetentionPolicy** | Pointer to **[]string** | The retention policy to use for the File Based Debug Log Publisher . | [optional] 
...
**Asynchronous** | Pointer to **bool** | Indicates whether the File Based Debug Log Publisher will publish records asynchronously. | [optional] 
...
`func NewAddFileBasedDebugLogPublisherRequest(schemas []EnumfileBasedDebugLogPublisherSchemaUrn, logFile string, enabled bool, publisherName string, ) *AddFileBasedDebugLogPublisherRequest`
