...
`func NewLdapPassThroughScimResourceTypeResponse(schemas []EnumldapPassThroughScimResourceTypeSchemaUrn, enabled bool, endpoint string, idAttribute string, id string, ) *LdapPassThroughScimResourceTypeResponse`
...
`func (o *LdapPassThroughScimResourceTypeResponse) GetIdAttribute() string`

GetIdAttribute returns the IdAttribute field if non-nil, zero value otherwise.

### GetIdAttributeOk

`func (o *LdapPassThroughScimResourceTypeResponse) GetIdAttributeOk() (*string, bool)`
...
`func (o *LdapPassThroughScimResourceTypeResponse) SetIdAttribute(v string)`
