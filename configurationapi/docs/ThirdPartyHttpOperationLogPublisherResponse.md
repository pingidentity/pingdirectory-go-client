...
`func NewThirdPartyHttpOperationLogPublisherResponse(schemas []EnumthirdPartyHttpOperationLogPublisherSchemaUrn, extensionClass string, enabled bool, id string, ) *ThirdPartyHttpOperationLogPublisherResponse`
