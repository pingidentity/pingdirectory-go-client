...
**LogFilePermissions** | Pointer to **string** | The UNIX permissions of the log files created by this File Based Audit Log Publisher. | [optional] 
**RotationPolicy** | Pointer to **[]string** | The rotation policy to use for the File Based Audit Log Publisher . | [optional] 
...
**RetentionPolicy** | Pointer to **[]string** | The retention policy to use for the File Based Audit Log Publisher . | [optional] 
...
**Asynchronous** | Pointer to **bool** | Indicates whether the File Based Audit Log Publisher will publish records asynchronously. | [optional] 
