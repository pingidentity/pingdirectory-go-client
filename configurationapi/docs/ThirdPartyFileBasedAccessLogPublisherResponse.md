...
**RotationPolicy** | **[]string** | The rotation policy to use for the Third Party File Based Access Log Publisher . | 
...
**RetentionPolicy** | **[]string** | The retention policy to use for the Third Party File Based Access Log Publisher . | 
