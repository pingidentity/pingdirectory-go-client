...
**RotationPolicy** | **[]string** | The rotation policy to use for the Debug Access Log Publisher . | 
...
**RetentionPolicy** | **[]string** | The retention policy to use for the Debug Access Log Publisher . | 
