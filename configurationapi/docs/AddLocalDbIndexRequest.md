...
**IndexType** | [**[]EnumlocalDbIndexIndexTypeProp**](EnumlocalDbIndexIndexTypeProp.md) | Specifies the type(s) of indexing that should be performed for the associated attribute. | 
