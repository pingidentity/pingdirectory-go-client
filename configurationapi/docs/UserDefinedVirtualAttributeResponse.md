...
`func NewUserDefinedVirtualAttributeResponse(schemas []EnumuserDefinedVirtualAttributeSchemaUrn, value []string, enabled bool, attributeType string, id string, ) *UserDefinedVirtualAttributeResponse`
