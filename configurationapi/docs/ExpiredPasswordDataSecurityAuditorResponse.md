...
`func NewExpiredPasswordDataSecurityAuditorResponse(schemas []EnumexpiredPasswordDataSecurityAuditorSchemaUrn, reportFile string, enabled bool, id string, ) *ExpiredPasswordDataSecurityAuditorResponse`
