...
`func NewAddScimResourceType200Response(id string, schemas []EnumldapMappingScimResourceTypeSchemaUrn, enabled bool, endpoint string, idAttribute string, coreSchema string, ) *AddScimResourceType200Response`
...
`func (o *AddScimResourceType200Response) GetIdAttribute() string`

GetIdAttribute returns the IdAttribute field if non-nil, zero value otherwise.

### GetIdAttributeOk

`func (o *AddScimResourceType200Response) GetIdAttributeOk() (*string, bool)`
...
`func (o *AddScimResourceType200Response) SetIdAttribute(v string)`
