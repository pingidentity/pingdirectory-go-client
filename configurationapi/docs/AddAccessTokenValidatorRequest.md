...
`func NewAddAccessTokenValidatorRequest(validatorName string, schemas []EnumthirdPartyAccessTokenValidatorSchemaUrn, clientID string, evaluationOrderIndex int64, enabled bool, extensionClass string, ) *AddAccessTokenValidatorRequest`
...
`func (o *AddAccessTokenValidatorRequest) GetEvaluationOrderIndex() int64`

GetEvaluationOrderIndex returns the EvaluationOrderIndex field if non-nil, zero value otherwise.

### GetEvaluationOrderIndexOk

`func (o *AddAccessTokenValidatorRequest) GetEvaluationOrderIndexOk() (*int64, bool)`
...
`func (o *AddAccessTokenValidatorRequest) SetEvaluationOrderIndex(v int64)`
