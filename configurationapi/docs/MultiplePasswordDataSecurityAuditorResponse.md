...
`func NewMultiplePasswordDataSecurityAuditorResponse(schemas []EnummultiplePasswordDataSecurityAuditorSchemaUrn, reportFile string, enabled bool, id string, ) *MultiplePasswordDataSecurityAuditorResponse`
