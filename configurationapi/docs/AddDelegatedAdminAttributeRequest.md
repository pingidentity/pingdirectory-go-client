...
`func (o *AddDelegatedAdminAttributeRequest) GetDisplayOrderIndex() int64`

GetDisplayOrderIndex returns the DisplayOrderIndex field if non-nil, zero value otherwise.

### GetDisplayOrderIndexOk

`func (o *AddDelegatedAdminAttributeRequest) GetDisplayOrderIndexOk() (*int64, bool)`
...
`func (o *AddDelegatedAdminAttributeRequest) SetDisplayOrderIndex(v int64)`
