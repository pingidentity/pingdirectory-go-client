...
// checks if the LdapPassThroughAuthenticationHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LdapPassThroughAuthenticationHandlerResponse{}
...
type NullableLdapPassThroughAuthenticationHandlerResponse struct {
	value *LdapPassThroughAuthenticationHandlerResponse
	isSet bool
}

func (v NullableLdapPassThroughAuthenticationHandlerResponse) Get() *LdapPassThroughAuthenticationHandlerResponse {
	return v.value
}

func (v *NullableLdapPassThroughAuthenticationHandlerResponse) Set(val *LdapPassThroughAuthenticationHandlerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLdapPassThroughAuthenticationHandlerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLdapPassThroughAuthenticationHandlerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLdapPassThroughAuthenticationHandlerResponse(val *LdapPassThroughAuthenticationHandlerResponse) *NullableLdapPassThroughAuthenticationHandlerResponse {
	return &NullableLdapPassThroughAuthenticationHandlerResponse{value: val, isSet: true}
}

func (v NullableLdapPassThroughAuthenticationHandlerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLdapPassThroughAuthenticationHandlerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
