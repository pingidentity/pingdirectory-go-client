...
// checks if the JsonPdpApiHttpServletExtensionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JsonPdpApiHttpServletExtensionResponse{}

// JsonPdpApiHttpServletExtensionResponse struct for JsonPdpApiHttpServletExtensionResponse
type JsonPdpApiHttpServletExtensionResponse struct {
	Schemas []EnumjsonPdpApiHttpServletExtensionSchemaUrn `json:"schemas"`
...
func NewJsonPdpApiHttpServletExtensionResponse(schemas []EnumjsonPdpApiHttpServletExtensionSchemaUrn, id string, sharedSecretHeaderName string) *JsonPdpApiHttpServletExtensionResponse {
	this := JsonPdpApiHttpServletExtensionResponse{}
...
func (o *JsonPdpApiHttpServletExtensionResponse) GetSchemas() []EnumjsonPdpApiHttpServletExtensionSchemaUrn {
	if o == nil {
		var ret []EnumjsonPdpApiHttpServletExtensionSchemaUrn
		return ret
	}
...
func (o JsonPdpApiHttpServletExtensionResponse) MarshalJSON() ([]byte, error) {
...
func (o JsonPdpApiHttpServletExtensionResponse) ToMap() (map[string]interface{}, error) {
...
type NullableJsonPdpApiHttpServletExtensionResponse struct {
	value *JsonPdpApiHttpServletExtensionResponse
	isSet bool
}

func (v NullableJsonPdpApiHttpServletExtensionResponse) Get() *JsonPdpApiHttpServletExtensionResponse {
	return v.value
}

func (v *NullableJsonPdpApiHttpServletExtensionResponse) Set(val *JsonPdpApiHttpServletExtensionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableJsonPdpApiHttpServletExtensionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableJsonPdpApiHttpServletExtensionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJsonPdpApiHttpServletExtensionResponse(val *JsonPdpApiHttpServletExtensionResponse) *NullableJsonPdpApiHttpServletExtensionResponse {
	return &NullableJsonPdpApiHttpServletExtensionResponse{value: val, isSet: true}
}

func (v NullableJsonPdpApiHttpServletExtensionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJsonPdpApiHttpServletExtensionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
