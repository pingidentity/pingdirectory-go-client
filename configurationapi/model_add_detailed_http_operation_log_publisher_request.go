...
// checks if the AddDetailedHttpOperationLogPublisherRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddDetailedHttpOperationLogPublisherRequest{}
...
func NewAddDetailedHttpOperationLogPublisherRequest(schemas []EnumdetailedHttpOperationLogPublisherSchemaUrn, logFile string, enabled bool, publisherName string) *AddDetailedHttpOperationLogPublisherRequest {
...
func (o AddDetailedHttpOperationLogPublisherRequest) ToMap() (map[string]interface{}, error) {
