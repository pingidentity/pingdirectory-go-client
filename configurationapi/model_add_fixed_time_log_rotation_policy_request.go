...
// checks if the AddFixedTimeLogRotationPolicyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddFixedTimeLogRotationPolicyRequest{}
...
func (o AddFixedTimeLogRotationPolicyRequest) ToMap() (map[string]interface{}, error) {
