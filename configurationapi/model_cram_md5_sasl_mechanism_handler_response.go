...
// checks if the CramMd5SaslMechanismHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CramMd5SaslMechanismHandlerResponse{}
...
func (o CramMd5SaslMechanismHandlerResponse) ToMap() (map[string]interface{}, error) {
