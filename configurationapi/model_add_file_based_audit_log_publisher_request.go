...
func NewAddFileBasedAuditLogPublisherRequest(publisherName string, schemas []EnumfileBasedAuditLogPublisherSchemaUrn, logFile string, enabled bool) *AddFileBasedAuditLogPublisherRequest {
