...
// checks if the AddFileBasedAuditLogPublisherRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddFileBasedAuditLogPublisherRequest{}

// AddFileBasedAuditLogPublisherRequest struct for AddFileBasedAuditLogPublisherRequest
type AddFileBasedAuditLogPublisherRequest struct {
...
func NewAddFileBasedAuditLogPublisherRequest(schemas []EnumfileBasedAuditLogPublisherSchemaUrn, logFile string, enabled bool, publisherName string) *AddFileBasedAuditLogPublisherRequest {
	this := AddFileBasedAuditLogPublisherRequest{}
...
func (o *AddFileBasedAuditLogPublisherRequest) HasLogFilePermissions() bool {
	if o != nil && !IsNil(o.LogFilePermissions) {
		return true
	}
...
func (o *AddFileBasedAuditLogPublisherRequest) HasRotationPolicy() bool {
	if o != nil && !IsNil(o.RotationPolicy) {
		return true
	}
...
func (o *AddFileBasedAuditLogPublisherRequest) HasRetentionPolicy() bool {
	if o != nil && !IsNil(o.RetentionPolicy) {
		return true
	}
...
func (o *AddFileBasedAuditLogPublisherRequest) GetSuppressVirtualAttributesInDeleteRecords() bool {
...
// and a boolean to check if the value has been set.
func (o *AddFileBasedAuditLogPublisherRequest) GetSuppressVirtualAttributesInDeleteRecordsOk() (*bool, bool) {
	if o == nil || IsNil(o.SuppressVirtualAttributesInDeleteRecords) {
		return nil, false
	}
...
func (o *AddFileBasedAuditLogPublisherRequest) HasSuppressVirtualAttributesInDeleteRecords() bool {
	if o != nil && !IsNil(o.SuppressVirtualAttributesInDeleteRecords) {
		return true
	}
...
func (o *AddFileBasedAuditLogPublisherRequest) SetSuppressVirtualAttributesInDeleteRecords(v bool) {
...
func (o *AddFileBasedAuditLogPublisherRequest) HasAsynchronous() bool {
	if o != nil && !IsNil(o.Asynchronous) {
		return true
	}
...
func (o *AddFileBasedAuditLogPublisherRequest) GetQueueSize() int64 {
...
// and a boolean to check if the value has been set.
func (o *AddFileBasedAuditLogPublisherRequest) GetQueueSizeOk() (*int64, bool) {
	if o == nil || IsNil(o.QueueSize) {
		return nil, false
	}
...
func (o *AddFileBasedAuditLogPublisherRequest) SetQueueSize(v int64) {
	o.QueueSize = &v
}
...
func (o AddFileBasedAuditLogPublisherRequest) MarshalJSON() ([]byte, error) {
...
func (o AddFileBasedAuditLogPublisherRequest) ToMap() (map[string]interface{}, error) {
...
type NullableAddFileBasedAuditLogPublisherRequest struct {
	value *AddFileBasedAuditLogPublisherRequest
	isSet bool
}

func (v NullableAddFileBasedAuditLogPublisherRequest) Get() *AddFileBasedAuditLogPublisherRequest {
	return v.value
}

func (v *NullableAddFileBasedAuditLogPublisherRequest) Set(val *AddFileBasedAuditLogPublisherRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddFileBasedAuditLogPublisherRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddFileBasedAuditLogPublisherRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddFileBasedAuditLogPublisherRequest(val *AddFileBasedAuditLogPublisherRequest) *NullableAddFileBasedAuditLogPublisherRequest {
	return &NullableAddFileBasedAuditLogPublisherRequest{value: val, isSet: true}
}

func (v NullableAddFileBasedAuditLogPublisherRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddFileBasedAuditLogPublisherRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
