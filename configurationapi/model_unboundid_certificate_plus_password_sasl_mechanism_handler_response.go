...
// checks if the UnboundidCertificatePlusPasswordSaslMechanismHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnboundidCertificatePlusPasswordSaslMechanismHandlerResponse{}
...
func (o UnboundidCertificatePlusPasswordSaslMechanismHandlerResponse) ToMap() (map[string]interface{}, error) {
