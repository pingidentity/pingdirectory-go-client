...
// checks if the ThirdPartyResultCriteriaResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThirdPartyResultCriteriaResponse{}
...
func (o ThirdPartyResultCriteriaResponse) ToMap() (map[string]interface{}, error) {
