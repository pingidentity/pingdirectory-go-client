...
// checks if the FileBasedErrorLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileBasedErrorLogPublisherResponse{}

// FileBasedErrorLogPublisherResponse struct for FileBasedErrorLogPublisherResponse
type FileBasedErrorLogPublisherResponse struct {
...
func NewFileBasedErrorLogPublisherResponse(schemas []EnumfileBasedErrorLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool, id string) *FileBasedErrorLogPublisherResponse {
	this := FileBasedErrorLogPublisherResponse{}
...
func (o *FileBasedErrorLogPublisherResponse) GetLogMessageExclusionPolicy() []string {
...
// and a boolean to check if the value has been set.
func (o *FileBasedErrorLogPublisherResponse) GetLogMessageExclusionPolicyOk() ([]string, bool) {
	if o == nil || IsNil(o.LogMessageExclusionPolicy) {
		return nil, false
	}
...
func (o *FileBasedErrorLogPublisherResponse) HasLogMessageExclusionPolicy() bool {
	if o != nil && !IsNil(o.LogMessageExclusionPolicy) {
		return true
	}
...
func (o *FileBasedErrorLogPublisherResponse) SetLogMessageExclusionPolicy(v []string) {
...
func (o FileBasedErrorLogPublisherResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFileBasedErrorLogPublisherResponse struct {
	value *FileBasedErrorLogPublisherResponse
	isSet bool
}

func (v NullableFileBasedErrorLogPublisherResponse) Get() *FileBasedErrorLogPublisherResponse {
	return v.value
}

func (v *NullableFileBasedErrorLogPublisherResponse) Set(val *FileBasedErrorLogPublisherResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileBasedErrorLogPublisherResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileBasedErrorLogPublisherResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileBasedErrorLogPublisherResponse(val *FileBasedErrorLogPublisherResponse) *NullableFileBasedErrorLogPublisherResponse {
	return &NullableFileBasedErrorLogPublisherResponse{value: val, isSet: true}
}

func (v NullableFileBasedErrorLogPublisherResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileBasedErrorLogPublisherResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
