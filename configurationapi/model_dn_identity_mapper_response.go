...
// checks if the DnIdentityMapperResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnIdentityMapperResponse{}

// DnIdentityMapperResponse struct for DnIdentityMapperResponse
type DnIdentityMapperResponse struct {
...
func (o DnIdentityMapperResponse) MarshalJSON() ([]byte, error) {
...
func (o DnIdentityMapperResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDnIdentityMapperResponse struct {
	value *DnIdentityMapperResponse
	isSet bool
}

func (v NullableDnIdentityMapperResponse) Get() *DnIdentityMapperResponse {
	return v.value
}

func (v *NullableDnIdentityMapperResponse) Set(val *DnIdentityMapperResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDnIdentityMapperResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDnIdentityMapperResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnIdentityMapperResponse(val *DnIdentityMapperResponse) *NullableDnIdentityMapperResponse {
	return &NullableDnIdentityMapperResponse{value: val, isSet: true}
}

func (v NullableDnIdentityMapperResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnIdentityMapperResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
