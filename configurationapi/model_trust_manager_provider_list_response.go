...
// checks if the TrustManagerProviderListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrustManagerProviderListResponse{}
...
func NewTrustManagerProviderListResponse() *TrustManagerProviderListResponse {
	this := TrustManagerProviderListResponse{}
	return &this
}
...
func (o TrustManagerProviderListResponse) MarshalJSON() ([]byte, error) {
...
func (o TrustManagerProviderListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableTrustManagerProviderListResponse struct {
	value *TrustManagerProviderListResponse
	isSet bool
}

func (v NullableTrustManagerProviderListResponse) Get() *TrustManagerProviderListResponse {
	return v.value
}

func (v *NullableTrustManagerProviderListResponse) Set(val *TrustManagerProviderListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTrustManagerProviderListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTrustManagerProviderListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrustManagerProviderListResponse(val *TrustManagerProviderListResponse) *NullableTrustManagerProviderListResponse {
	return &NullableTrustManagerProviderListResponse{value: val, isSet: true}
}

func (v NullableTrustManagerProviderListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrustManagerProviderListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
