...
func (a *ChangeSubscriptionHandlerApiService) DeleteChangeSubscriptionHandlerExecute(r ApiDeleteChangeSubscriptionHandlerRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"change-subscription-handler-name"+"}", url.PathEscape(parameterValueToString(r.changeSubscriptionHandlerName, "changeSubscriptionHandlerName")), -1)
...
// SCIM filter
func (r ApiListChangeSubscriptionHandlersRequest) Filter(filter string) ApiListChangeSubscriptionHandlersRequest {
	r.filter = &filter
	return r
}

func (r ApiListChangeSubscriptionHandlersRequest) Execute() (*ChangeSubscriptionHandlerListResponse, *http.Response, error) {
	return r.ApiService.ListChangeSubscriptionHandlersExecute(r)
}

/*
ListChangeSubscriptionHandlers Returns a list of all Change Subscription Handler objects
