...
// checks if the GetSupportedOtpDeliveryMechanismsExtendedOperationHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSupportedOtpDeliveryMechanismsExtendedOperationHandlerResponse{}
...
func (o GetSupportedOtpDeliveryMechanismsExtendedOperationHandlerResponse) ToMap() (map[string]interface{}, error) {
