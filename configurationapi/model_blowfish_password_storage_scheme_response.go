...
// checks if the BlowfishPasswordStorageSchemeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlowfishPasswordStorageSchemeResponse{}
...
func (o BlowfishPasswordStorageSchemeResponse) ToMap() (map[string]interface{}, error) {
