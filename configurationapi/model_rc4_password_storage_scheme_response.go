...
// checks if the Rc4PasswordStorageSchemeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Rc4PasswordStorageSchemeResponse{}
...
func (o Rc4PasswordStorageSchemeResponse) ToMap() (map[string]interface{}, error) {
