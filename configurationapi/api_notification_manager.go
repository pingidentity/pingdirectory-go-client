...
// SCIM filter
func (r ApiListNotificationManagersRequest) Filter(filter string) ApiListNotificationManagersRequest {
	r.filter = &filter
	return r
}

func (r ApiListNotificationManagersRequest) Execute() (*NotificationManagerListResponse, *http.Response, error) {
	return r.ApiService.ListNotificationManagersExecute(r)
}

/*
ListNotificationManagers Returns a list of all Notification Manager objects
