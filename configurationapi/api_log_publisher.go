...
// SCIM filter
func (r ApiListLogPublishersRequest) Filter(filter string) ApiListLogPublishersRequest {
	r.filter = &filter
	return r
}

func (r ApiListLogPublishersRequest) Execute() (*LogPublisherListResponse, *http.Response, error) {
	return r.ApiService.ListLogPublishersExecute(r)
}

/*
ListLogPublishers Returns a list of all Log Publisher objects
