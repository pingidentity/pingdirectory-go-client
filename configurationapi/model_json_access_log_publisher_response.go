...
// checks if the JsonAccessLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JsonAccessLogPublisherResponse{}
...
func (o JsonAccessLogPublisherResponse) ToMap() (map[string]interface{}, error) {
