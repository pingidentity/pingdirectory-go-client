...
func NewJsonAccessLogPublisherResponse(schemas []EnumjsonAccessLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool, id string) *JsonAccessLogPublisherResponse {
