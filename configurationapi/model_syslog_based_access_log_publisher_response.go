...
// checks if the SyslogBasedAccessLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogBasedAccessLogPublisherResponse{}
...
func NewSyslogBasedAccessLogPublisherResponse(schemas []EnumsyslogBasedAccessLogPublisherSchemaUrn, enabled bool, serverHostName string, serverPort int64, syslogFacility int64, asynchronous bool, id string) *SyslogBasedAccessLogPublisherResponse {
...
func (o *SyslogBasedAccessLogPublisherResponse) GetIncludeConnectionDetailsInRequestMessages() bool {
...
// and a boolean to check if the value has been set.
func (o *SyslogBasedAccessLogPublisherResponse) GetIncludeConnectionDetailsInRequestMessagesOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeConnectionDetailsInRequestMessages) {
		return nil, false
	}
...
func (o *SyslogBasedAccessLogPublisherResponse) HasIncludeConnectionDetailsInRequestMessages() bool {
	if o != nil && !IsNil(o.IncludeConnectionDetailsInRequestMessages) {
		return true
	}
...
func (o *SyslogBasedAccessLogPublisherResponse) SetIncludeConnectionDetailsInRequestMessages(v bool) {
...
func (o SyslogBasedAccessLogPublisherResponse) ToMap() (map[string]interface{}, error) {
