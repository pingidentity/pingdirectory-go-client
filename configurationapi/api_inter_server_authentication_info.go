...
// SCIM filter
func (r ApiListInterServerAuthenticationInfoRequest) Filter(filter string) ApiListInterServerAuthenticationInfoRequest {
	r.filter = &filter
	return r
}

func (r ApiListInterServerAuthenticationInfoRequest) Execute() (*InterServerAuthenticationInfoListResponse, *http.Response, error) {
	return r.ApiService.ListInterServerAuthenticationInfoExecute(r)
}

/*
ListInterServerAuthenticationInfo Returns a list of all Inter Server Authentication Info objects
...
func (a *InterServerAuthenticationInfoApiService) ListInterServerAuthenticationInfoExecute(r ApiListInterServerAuthenticationInfoRequest) (*InterServerAuthenticationInfoListResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/server-instances/{server-instance-name}/server-instance-listeners/{server-instance-listener-name}/inter-server-authentication-info"
	localVarPath = strings.Replace(localVarPath, "{"+"server-instance-listener-name"+"}", url.PathEscape(parameterValueToString(r.serverInstanceListenerName, "serverInstanceListenerName")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"server-instance-name"+"}", url.PathEscape(parameterValueToString(r.serverInstanceName, "serverInstanceName")), -1)
