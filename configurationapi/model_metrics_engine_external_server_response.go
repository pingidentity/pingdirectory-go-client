...
// checks if the MetricsEngineExternalServerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricsEngineExternalServerResponse{}

// MetricsEngineExternalServerResponse struct for MetricsEngineExternalServerResponse
type MetricsEngineExternalServerResponse struct {
	Meta                                          *MetaMeta                                          `json:"meta,omitempty"`
	Urnpingidentityschemasconfigurationmessages20 *MetaUrnPingidentitySchemasConfigurationMessages20 `json:"urn:pingidentity:schemas:configuration:messages:2.0,omitempty"`
	Schemas                                       []EnummetricsEngineExternalServerSchemaUrn         `json:"schemas"`
	...
	ConnectionSecurity   EnumexternalServerMetricsEngineConnectionSecurityProp   `json:"connectionSecurity"`
	AuthenticationMethod EnumexternalServerMetricsEngineAuthenticationMethodProp `json:"authenticationMethod"`
...
func NewMetricsEngineExternalServerResponse(schemas []EnummetricsEngineExternalServerSchemaUrn, id string, verifyCredentialsMethod EnumexternalServerVerifyCredentialsMethodProp, serverHostName string, serverPort int64, connectionSecurity EnumexternalServerMetricsEngineConnectionSecurityProp, authenticationMethod EnumexternalServerMetricsEngineAuthenticationMethodProp, maxConnectionAge string, connectTimeout string, maxResponseSize string) *MetricsEngineExternalServerResponse {
	this := MetricsEngineExternalServerResponse{}
...
func (o *MetricsEngineExternalServerResponse) GetSchemas() []EnummetricsEngineExternalServerSchemaUrn {
	if o == nil {
		var ret []EnummetricsEngineExternalServerSchemaUrn
		return ret
	}
...
func (o *MetricsEngineExternalServerResponse) GetConnectionSecurity() EnumexternalServerMetricsEngineConnectionSecurityProp {
	if o == nil {
		var ret EnumexternalServerMetricsEngineConnectionSecurityProp
		return ret
	}
...
func (o *MetricsEngineExternalServerResponse) GetAuthenticationMethod() EnumexternalServerMetricsEngineAuthenticationMethodProp {
	if o == nil {
		var ret EnumexternalServerMetricsEngineAuthenticationMethodProp
		return ret
	}
...
func (o MetricsEngineExternalServerResponse) MarshalJSON() ([]byte, error) {
...
func (o MetricsEngineExternalServerResponse) ToMap() (map[string]interface{}, error) {
...
type NullableMetricsEngineExternalServerResponse struct {
	value *MetricsEngineExternalServerResponse
	isSet bool
}

func (v NullableMetricsEngineExternalServerResponse) Get() *MetricsEngineExternalServerResponse {
	return v.value
}

func (v *NullableMetricsEngineExternalServerResponse) Set(val *MetricsEngineExternalServerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricsEngineExternalServerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricsEngineExternalServerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricsEngineExternalServerResponse(val *MetricsEngineExternalServerResponse) *NullableMetricsEngineExternalServerResponse {
	return &NullableMetricsEngineExternalServerResponse{value: val, isSet: true}
}

func (v NullableMetricsEngineExternalServerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricsEngineExternalServerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
