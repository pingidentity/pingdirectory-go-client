...
func NewFileBasedJsonHttpOperationLogPublisherResponse(schemas []EnumfileBasedJsonHttpOperationLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool, id string) *FileBasedJsonHttpOperationLogPublisherResponse {
