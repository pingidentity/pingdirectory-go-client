...
// checks if the WhoAmIExtendedOperationHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WhoAmIExtendedOperationHandlerResponse{}
...
func (o WhoAmIExtendedOperationHandlerResponse) ToMap() (map[string]interface{}, error) {
