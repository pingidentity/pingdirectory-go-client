...
func (o *ConsoleJsonErrorLogPublisherResponse) GetLogMessageExclusionPolicy() []string {
...
// and a boolean to check if the value has been set.
func (o *ConsoleJsonErrorLogPublisherResponse) GetLogMessageExclusionPolicyOk() ([]string, bool) {
	if o == nil || IsNil(o.LogMessageExclusionPolicy) {
		return nil, false
	}
...
func (o *ConsoleJsonErrorLogPublisherResponse) HasLogMessageExclusionPolicy() bool {
	if o != nil && !IsNil(o.LogMessageExclusionPolicy) {
		return true
	}
...
func (o *ConsoleJsonErrorLogPublisherResponse) SetLogMessageExclusionPolicy(v []string) {
