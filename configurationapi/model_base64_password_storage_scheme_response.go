...
// checks if the Base64PasswordStorageSchemeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Base64PasswordStorageSchemeResponse{}
...
func (o Base64PasswordStorageSchemeResponse) ToMap() (map[string]interface{}, error) {
