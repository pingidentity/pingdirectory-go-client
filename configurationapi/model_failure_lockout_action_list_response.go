...
// checks if the FailureLockoutActionListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailureLockoutActionListResponse{}
...
func NewFailureLockoutActionListResponse() *FailureLockoutActionListResponse {
	this := FailureLockoutActionListResponse{}
	return &this
}
...
func (o FailureLockoutActionListResponse) MarshalJSON() ([]byte, error) {
...
func (o FailureLockoutActionListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFailureLockoutActionListResponse struct {
	value *FailureLockoutActionListResponse
	isSet bool
}

func (v NullableFailureLockoutActionListResponse) Get() *FailureLockoutActionListResponse {
	return v.value
}

func (v *NullableFailureLockoutActionListResponse) Set(val *FailureLockoutActionListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFailureLockoutActionListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFailureLockoutActionListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFailureLockoutActionListResponse(val *FailureLockoutActionListResponse) *NullableFailureLockoutActionListResponse {
	return &NullableFailureLockoutActionListResponse{value: val, isSet: true}
}

func (v NullableFailureLockoutActionListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFailureLockoutActionListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
