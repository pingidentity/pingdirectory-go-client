...
// checks if the AddGroovyScriptedFileBasedAccessLogPublisherRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddGroovyScriptedFileBasedAccessLogPublisherRequest{}

// AddGroovyScriptedFileBasedAccessLogPublisherRequest struct for AddGroovyScriptedFileBasedAccessLogPublisherRequest
type AddGroovyScriptedFileBasedAccessLogPublisherRequest struct {
...
func NewAddGroovyScriptedFileBasedAccessLogPublisherRequest(publisherName string, schemas []EnumgroovyScriptedFileBasedAccessLogPublisherSchemaUrn, scriptClass string, logFile string, enabled bool) *AddGroovyScriptedFileBasedAccessLogPublisherRequest {
	this := AddGroovyScriptedFileBasedAccessLogPublisherRequest{}
...
func (o AddGroovyScriptedFileBasedAccessLogPublisherRequest) MarshalJSON() ([]byte, error) {
...
func (o AddGroovyScriptedFileBasedAccessLogPublisherRequest) ToMap() (map[string]interface{}, error) {
...
type NullableAddGroovyScriptedFileBasedAccessLogPublisherRequest struct {
	value *AddGroovyScriptedFileBasedAccessLogPublisherRequest
	isSet bool
}

func (v NullableAddGroovyScriptedFileBasedAccessLogPublisherRequest) Get() *AddGroovyScriptedFileBasedAccessLogPublisherRequest {
	return v.value
}

func (v *NullableAddGroovyScriptedFileBasedAccessLogPublisherRequest) Set(val *AddGroovyScriptedFileBasedAccessLogPublisherRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddGroovyScriptedFileBasedAccessLogPublisherRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddGroovyScriptedFileBasedAccessLogPublisherRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddGroovyScriptedFileBasedAccessLogPublisherRequest(val *AddGroovyScriptedFileBasedAccessLogPublisherRequest) *NullableAddGroovyScriptedFileBasedAccessLogPublisherRequest {
	return &NullableAddGroovyScriptedFileBasedAccessLogPublisherRequest{value: val, isSet: true}
}

func (v NullableAddGroovyScriptedFileBasedAccessLogPublisherRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddGroovyScriptedFileBasedAccessLogPublisherRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
