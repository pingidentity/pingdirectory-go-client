...
// checks if the PasswordPolicyStateExtendedOperationHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PasswordPolicyStateExtendedOperationHandlerResponse{}
...
func (o PasswordPolicyStateExtendedOperationHandlerResponse) ToMap() (map[string]interface{}, error) {
