...
// checks if the NeverDeleteLogRetentionPolicyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NeverDeleteLogRetentionPolicyResponse{}
...
func (o NeverDeleteLogRetentionPolicyResponse) ToMap() (map[string]interface{}, error) {
