...
// checks if the AddEntryDnVirtualAttributeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddEntryDnVirtualAttributeRequest{}
