...
// SCIM filter
func (r ApiListHttpServletCrossOriginPoliciesRequest) Filter(filter string) ApiListHttpServletCrossOriginPoliciesRequest {
	r.filter = &filter
	return r
}

func (r ApiListHttpServletCrossOriginPoliciesRequest) Execute() (*HttpServletCrossOriginPolicyListResponse, *http.Response, error) {
	return r.ApiService.ListHttpServletCrossOriginPoliciesExecute(r)
}

/*
ListHttpServletCrossOriginPolicies Returns a list of all HTTP Servlet Cross Origin Policy objects
