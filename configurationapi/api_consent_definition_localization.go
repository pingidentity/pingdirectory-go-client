...
// SCIM filter
func (r ApiListConsentDefinitionLocalizationsRequest) Filter(filter string) ApiListConsentDefinitionLocalizationsRequest {
	r.filter = &filter
	return r
}

func (r ApiListConsentDefinitionLocalizationsRequest) Execute() (*ConsentDefinitionLocalizationListResponse, *http.Response, error) {
	return r.ApiService.ListConsentDefinitionLocalizationsExecute(r)
}

/*
ListConsentDefinitionLocalizations Returns a list of all Consent Definition Localization objects
