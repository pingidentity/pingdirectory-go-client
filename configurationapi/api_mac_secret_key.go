...
func (r ApiGetMacSecretKeyRequest) Execute() (*MacSecretKeyResponse, *http.Response, error) {
	return r.ApiService.GetMacSecretKeyExecute(r)
}

/*
GetMacSecretKey Returns a single Mac Secret Key

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param macSecretKeyName Name of the Mac Secret Key
...
func (a *MacSecretKeyApiService) GetMacSecretKey(ctx context.Context, macSecretKeyName string, serverInstanceName string) ApiGetMacSecretKeyRequest {
	return ApiGetMacSecretKeyRequest{
		ApiService:         a,
		ctx:                ctx,
		macSecretKeyName:   macSecretKeyName,
...
func (a *MacSecretKeyApiService) GetMacSecretKeyExecute(r ApiGetMacSecretKeyRequest) (*MacSecretKeyResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/server-instances/{server-instance-name}/mac-secret-keys/{mac-secret-key-name}"
	localVarPath = strings.Replace(localVarPath, "{"+"mac-secret-key-name"+"}", url.PathEscape(parameterValueToString(r.macSecretKeyName, "macSecretKeyName")), -1)
...
// SCIM filter
func (r ApiListMacSecretKeysRequest) Filter(filter string) ApiListMacSecretKeysRequest {
	r.filter = &filter
	return r
}

func (r ApiListMacSecretKeysRequest) Execute() (*MacSecretKeyListResponse, *http.Response, error) {
	return r.ApiService.ListMacSecretKeysExecute(r)
}

/*
ListMacSecretKeys Returns a list of all Mac Secret Key objects
...
func (a *MacSecretKeyApiService) ListMacSecretKeysExecute(r ApiListMacSecretKeysRequest) (*MacSecretKeyListResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/server-instances/{server-instance-name}/mac-secret-keys"
	localVarPath = strings.Replace(localVarPath, "{"+"server-instance-name"+"}", url.PathEscape(parameterValueToString(r.serverInstanceName, "serverInstanceName")), -1)
...
// Update an existing Mac Secret Key
func (r ApiUpdateMacSecretKeyRequest) UpdateRequest(updateRequest UpdateRequest) ApiUpdateMacSecretKeyRequest {
	r.updateRequest = &updateRequest
	return r
}

func (r ApiUpdateMacSecretKeyRequest) Execute() (*MacSecretKeyResponse, *http.Response, error) {
	return r.ApiService.UpdateMacSecretKeyExecute(r)
}

/*
UpdateMacSecretKey Update an existing Mac Secret Key by name
