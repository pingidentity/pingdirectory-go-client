...
func (a *RecurringTaskChainApiService) DeleteRecurringTaskChainExecute(r ApiDeleteRecurringTaskChainRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"recurring-task-chain-name"+"}", url.PathEscape(parameterValueToString(r.recurringTaskChainName, "recurringTaskChainName")), -1)
