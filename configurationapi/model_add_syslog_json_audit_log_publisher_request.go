...
// checks if the AddSyslogJsonAuditLogPublisherRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddSyslogJsonAuditLogPublisherRequest{}
...
type AddSyslogJsonAuditLogPublisherRequest struct {
	...
	SoftDeleteEntryAuditBehavior *EnumlogPublisherSyslogJsonAuditSoftDeleteEntryAuditBehaviorProp `json:"softDeleteEntryAuditBehavior,omitempty"`
...
func (o *AddSyslogJsonAuditLogPublisherRequest) GetQueueSize() int64 {
...
// and a boolean to check if the value has been set.
func (o *AddSyslogJsonAuditLogPublisherRequest) GetQueueSizeOk() (*int64, bool) {
	if o == nil || IsNil(o.QueueSize) {
		return nil, false
	}
...
func (o *AddSyslogJsonAuditLogPublisherRequest) SetQueueSize(v int64) {
	o.QueueSize = &v
}
...
func (o *AddSyslogJsonAuditLogPublisherRequest) GetSoftDeleteEntryAuditBehavior() EnumlogPublisherSyslogJsonAuditSoftDeleteEntryAuditBehaviorProp {
	if o == nil || IsNil(o.SoftDeleteEntryAuditBehavior) {
		var ret EnumlogPublisherSyslogJsonAuditSoftDeleteEntryAuditBehaviorProp
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AddSyslogJsonAuditLogPublisherRequest) GetSoftDeleteEntryAuditBehaviorOk() (*EnumlogPublisherSyslogJsonAuditSoftDeleteEntryAuditBehaviorProp, bool) {
	if o == nil || IsNil(o.SoftDeleteEntryAuditBehavior) {
		return nil, false
	}
...
// SetSoftDeleteEntryAuditBehavior gets a reference to the given EnumlogPublisherSyslogJsonAuditSoftDeleteEntryAuditBehaviorProp and assigns it to the SoftDeleteEntryAuditBehavior field.
func (o *AddSyslogJsonAuditLogPublisherRequest) SetSoftDeleteEntryAuditBehavior(v EnumlogPublisherSyslogJsonAuditSoftDeleteEntryAuditBehaviorProp) {
