...
// checks if the StackTraceMonitorProviderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StackTraceMonitorProviderResponse{}
...
func (o StackTraceMonitorProviderResponse) ToMap() (map[string]interface{}, error) {
