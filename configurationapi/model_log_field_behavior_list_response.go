...
// checks if the LogFieldBehaviorListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogFieldBehaviorListResponse{}
...
func NewLogFieldBehaviorListResponse() *LogFieldBehaviorListResponse {
	this := LogFieldBehaviorListResponse{}
	return &this
}
...
func (o LogFieldBehaviorListResponse) MarshalJSON() ([]byte, error) {
...
func (o LogFieldBehaviorListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLogFieldBehaviorListResponse struct {
	value *LogFieldBehaviorListResponse
	isSet bool
}

func (v NullableLogFieldBehaviorListResponse) Get() *LogFieldBehaviorListResponse {
	return v.value
}

func (v *NullableLogFieldBehaviorListResponse) Set(val *LogFieldBehaviorListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLogFieldBehaviorListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLogFieldBehaviorListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogFieldBehaviorListResponse(val *LogFieldBehaviorListResponse) *NullableLogFieldBehaviorListResponse {
	return &NullableLogFieldBehaviorListResponse{value: val, isSet: true}
}

func (v NullableLogFieldBehaviorListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogFieldBehaviorListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
