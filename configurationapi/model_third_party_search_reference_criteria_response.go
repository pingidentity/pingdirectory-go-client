...
// checks if the ThirdPartySearchReferenceCriteriaResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThirdPartySearchReferenceCriteriaResponse{}
