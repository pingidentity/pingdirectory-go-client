...
// checks if the AddGroovyScriptedPasswordGeneratorRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddGroovyScriptedPasswordGeneratorRequest{}
