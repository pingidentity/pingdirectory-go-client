...
// checks if the AddConstructedVirtualAttributeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddConstructedVirtualAttributeRequest{}

// AddConstructedVirtualAttributeRequest struct for AddConstructedVirtualAttributeRequest
type AddConstructedVirtualAttributeRequest struct {
...
func NewAddConstructedVirtualAttributeRequest(name string, schemas []EnumconstructedVirtualAttributeSchemaUrn, valuePattern []string, enabled bool, attributeType string) *AddConstructedVirtualAttributeRequest {
	this := AddConstructedVirtualAttributeRequest{}
	this.Name = name
...
func (o AddConstructedVirtualAttributeRequest) MarshalJSON() ([]byte, error) {
...
func (o AddConstructedVirtualAttributeRequest) ToMap() (map[string]interface{}, error) {
...
type NullableAddConstructedVirtualAttributeRequest struct {
	value *AddConstructedVirtualAttributeRequest
	isSet bool
}

func (v NullableAddConstructedVirtualAttributeRequest) Get() *AddConstructedVirtualAttributeRequest {
	return v.value
}

func (v *NullableAddConstructedVirtualAttributeRequest) Set(val *AddConstructedVirtualAttributeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddConstructedVirtualAttributeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddConstructedVirtualAttributeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddConstructedVirtualAttributeRequest(val *AddConstructedVirtualAttributeRequest) *NullableAddConstructedVirtualAttributeRequest {
	return &NullableAddConstructedVirtualAttributeRequest{value: val, isSet: true}
}

func (v NullableAddConstructedVirtualAttributeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddConstructedVirtualAttributeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
