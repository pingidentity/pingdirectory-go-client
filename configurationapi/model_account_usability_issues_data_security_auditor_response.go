...
// checks if the AccountUsabilityIssuesDataSecurityAuditorResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountUsabilityIssuesDataSecurityAuditorResponse{}
...
type NullableAccountUsabilityIssuesDataSecurityAuditorResponse struct {
	value *AccountUsabilityIssuesDataSecurityAuditorResponse
	isSet bool
}

func (v NullableAccountUsabilityIssuesDataSecurityAuditorResponse) Get() *AccountUsabilityIssuesDataSecurityAuditorResponse {
	return v.value
}

func (v *NullableAccountUsabilityIssuesDataSecurityAuditorResponse) Set(val *AccountUsabilityIssuesDataSecurityAuditorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountUsabilityIssuesDataSecurityAuditorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountUsabilityIssuesDataSecurityAuditorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountUsabilityIssuesDataSecurityAuditorResponse(val *AccountUsabilityIssuesDataSecurityAuditorResponse) *NullableAccountUsabilityIssuesDataSecurityAuditorResponse {
	return &NullableAccountUsabilityIssuesDataSecurityAuditorResponse{value: val, isSet: true}
}

func (v NullableAccountUsabilityIssuesDataSecurityAuditorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountUsabilityIssuesDataSecurityAuditorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
