...
func NewReferralOnUpdatePluginResponse(schemas []EnumreferralOnUpdatePluginSchemaUrn, pluginType []EnumpluginPluginTypeProp, referralBaseURL []string, enabled bool, id string) *ReferralOnUpdatePluginResponse {
