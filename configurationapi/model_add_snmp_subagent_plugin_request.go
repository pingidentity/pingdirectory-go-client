...
// checks if the AddSnmpSubagentPluginRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddSnmpSubagentPluginRequest{}
