...
// checks if the AddGroovyScriptedVirtualAttributeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddGroovyScriptedVirtualAttributeRequest{}
...
type NullableAddGroovyScriptedVirtualAttributeRequest struct {
	value *AddGroovyScriptedVirtualAttributeRequest
	isSet bool
}

func (v NullableAddGroovyScriptedVirtualAttributeRequest) Get() *AddGroovyScriptedVirtualAttributeRequest {
	return v.value
}

func (v *NullableAddGroovyScriptedVirtualAttributeRequest) Set(val *AddGroovyScriptedVirtualAttributeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddGroovyScriptedVirtualAttributeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddGroovyScriptedVirtualAttributeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddGroovyScriptedVirtualAttributeRequest(val *AddGroovyScriptedVirtualAttributeRequest) *NullableAddGroovyScriptedVirtualAttributeRequest {
	return &NullableAddGroovyScriptedVirtualAttributeRequest{value: val, isSet: true}
}

func (v NullableAddGroovyScriptedVirtualAttributeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddGroovyScriptedVirtualAttributeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
