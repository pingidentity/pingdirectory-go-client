...
// checks if the SyslogJsonAuditLogPublisherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogJsonAuditLogPublisherResponse{}
