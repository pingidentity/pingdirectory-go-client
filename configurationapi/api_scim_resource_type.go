...
// SCIM filter
func (r ApiListScimResourceTypesRequest) Filter(filter string) ApiListScimResourceTypesRequest {
	r.filter = &filter
	return r
}

func (r ApiListScimResourceTypesRequest) Execute() (*ScimResourceTypeListResponse, *http.Response, error) {
	return r.ApiService.ListScimResourceTypesExecute(r)
}

/*
ListScimResourceTypes Returns a list of all SCIM Resource Type objects
