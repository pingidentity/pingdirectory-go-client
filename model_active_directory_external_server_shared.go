...
// ActiveDirectoryExternalServerShared struct for ActiveDirectoryExternalServerShared
type ActiveDirectoryExternalServerShared struct {
...
func NewActiveDirectoryExternalServerShared(schemas []EnumactiveDirectoryExternalServerSchemaUrn, serverHostName string, serverPort int32, connectionSecurity EnumexternalServerConnectionSecurityProp, authenticationMethod EnumexternalServerAuthenticationMethodProp, verifyCredentialsMethod EnumexternalServerVerifyCredentialsMethodProp, maxConnectionAge string, connectTimeout string, maxResponseSize string) *ActiveDirectoryExternalServerShared {
	this := ActiveDirectoryExternalServerShared{}
...
func (o ActiveDirectoryExternalServerShared) MarshalJSON() ([]byte, error) {
...
type NullableActiveDirectoryExternalServerShared struct {
	value *ActiveDirectoryExternalServerShared
	isSet bool
}

func (v NullableActiveDirectoryExternalServerShared) Get() *ActiveDirectoryExternalServerShared {
	return v.value
}

func (v *NullableActiveDirectoryExternalServerShared) Set(val *ActiveDirectoryExternalServerShared) {
	v.value = val
	v.isSet = true
}

func (v NullableActiveDirectoryExternalServerShared) IsSet() bool {
	return v.isSet
}

func (v *NullableActiveDirectoryExternalServerShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActiveDirectoryExternalServerShared(val *ActiveDirectoryExternalServerShared) *NullableActiveDirectoryExternalServerShared {
	return &NullableActiveDirectoryExternalServerShared{value: val, isSet: true}
}

func (v NullableActiveDirectoryExternalServerShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActiveDirectoryExternalServerShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
