...
// MemberVirtualAttributeShared struct for MemberVirtualAttributeShared
type MemberVirtualAttributeShared struct {
...
func NewMemberVirtualAttributeShared(schemas []EnummemberVirtualAttributeSchemaUrn, allowRetrievingMembership bool, enabled bool, attributeType string) *MemberVirtualAttributeShared {
	this := MemberVirtualAttributeShared{}
...
func (o MemberVirtualAttributeShared) MarshalJSON() ([]byte, error) {
...
type NullableMemberVirtualAttributeShared struct {
	value *MemberVirtualAttributeShared
	isSet bool
}

func (v NullableMemberVirtualAttributeShared) Get() *MemberVirtualAttributeShared {
	return v.value
}

func (v *NullableMemberVirtualAttributeShared) Set(val *MemberVirtualAttributeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberVirtualAttributeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberVirtualAttributeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberVirtualAttributeShared(val *MemberVirtualAttributeShared) *NullableMemberVirtualAttributeShared {
	return &NullableMemberVirtualAttributeShared{value: val, isSet: true}
}

func (v NullableMemberVirtualAttributeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberVirtualAttributeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
