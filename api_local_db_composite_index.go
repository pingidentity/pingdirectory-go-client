...
*/
func (a *LocalDbCompositeIndexApiService) AddLocalDbCompositeIndex(ctx context.Context) ApiAddLocalDbCompositeIndexRequest {
	return ApiAddLocalDbCompositeIndexRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *LocalDbCompositeIndexApiService) AddLocalDbCompositeIndexExecute(r ApiAddLocalDbCompositeIndexRequest) (*LocalDbCompositeIndexResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/local-db-composite-indexes"
...
DeleteLocalDbCompositeIndex Delete a Local DB Composite Index
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param localDbCompositeIndexName Name of the Local DB Composite Index to be deleted
	@return ApiDeleteLocalDbCompositeIndexRequest
*/
func (a *LocalDbCompositeIndexApiService) DeleteLocalDbCompositeIndex(ctx context.Context, localDbCompositeIndexName string) ApiDeleteLocalDbCompositeIndexRequest {
	return ApiDeleteLocalDbCompositeIndexRequest{
		ApiService:                a,
		ctx:                       ctx,
...
func (a *LocalDbCompositeIndexApiService) DeleteLocalDbCompositeIndexExecute(r ApiDeleteLocalDbCompositeIndexRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/local-db-composite-indexes/{local-db-composite-index-name}"
...
GetLocalDbCompositeIndex Returns a single Local DB Composite Index
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param localDbCompositeIndexName Name of the Local DB Composite Index to be read
	@return ApiGetLocalDbCompositeIndexRequest
*/
func (a *LocalDbCompositeIndexApiService) GetLocalDbCompositeIndex(ctx context.Context, localDbCompositeIndexName string) ApiGetLocalDbCompositeIndexRequest {
	return ApiGetLocalDbCompositeIndexRequest{
		ApiService:                a,
		ctx:                       ctx,
		localDbCompositeIndexName: localDbCompositeIndexName,
...
UpdateLocalDbCompositeIndex Update an existing Local DB Composite Index by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param localDbCompositeIndexName Name of the Local DB Composite Index to be updated
	@return ApiUpdateLocalDbCompositeIndexRequest
*/
func (a *LocalDbCompositeIndexApiService) UpdateLocalDbCompositeIndex(ctx context.Context, localDbCompositeIndexName string) ApiUpdateLocalDbCompositeIndexRequest {
	return ApiUpdateLocalDbCompositeIndexRequest{
		ApiService:                a,
		ctx:                       ctx,
		localDbCompositeIndexName: localDbCompositeIndexName,
