...
const (
	ACCOUNT_USABLE EnumpasswordPolicyAllowedPasswordResetTokenUseConditionProp = "account-usable"
	PASSWORD_EXPIRED EnumpasswordPolicyAllowedPasswordResetTokenUseConditionProp = "password-expired"
	ACCOUNT_LOCKED_DUE_TO_FAILURES EnumpasswordPolicyAllowedPasswordResetTokenUseConditionProp = "account-locked-due-to-failures"
	ACCOUNT_LOCKED_DUE_TO_IDLE_TIME_LIMIT EnumpasswordPolicyAllowedPasswordResetTokenUseConditionProp = "account-locked-due-to-idle-time-limit"
	ACCOUNT_LOCKED_DUE_TO_ADMIN_RESET_TIMEOUT EnumpasswordPolicyAllowedPasswordResetTokenUseConditionProp = "account-locked-due-to-admin-reset-timeout"
	ACCOUNT_LOCKED_DUE_TO_VALIDATION_FAILURE EnumpasswordPolicyAllowedPasswordResetTokenUseConditionProp = "account-locked-due-to-validation-failure"
)
