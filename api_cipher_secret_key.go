...
GetCipherSecretKey Returns a single Cipher Secret Key
	...
	@param cipherSecretKeyName Name of the Cipher Secret Key to be read
	@return ApiGetCipherSecretKeyRequest
*/
func (a *CipherSecretKeyApiService) GetCipherSecretKey(ctx context.Context, cipherSecretKeyName string) ApiGetCipherSecretKeyRequest {
	return ApiGetCipherSecretKeyRequest{
		ApiService:          a,
		ctx:                 ctx,
...
func (a *CipherSecretKeyApiService) GetCipherSecretKeyExecute(r ApiGetCipherSecretKeyRequest) (*CipherSecretKeyResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/cipher-secret-keys/{cipher-secret-key-name}"
...
UpdateCipherSecretKey Update an existing Cipher Secret Key by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param cipherSecretKeyName Name of the Cipher Secret Key to be updated
	@return ApiUpdateCipherSecretKeyRequest
*/
func (a *CipherSecretKeyApiService) UpdateCipherSecretKey(ctx context.Context, cipherSecretKeyName string) ApiUpdateCipherSecretKeyRequest {
	return ApiUpdateCipherSecretKeyRequest{
		ApiService:          a,
		ctx:                 ctx,
		cipherSecretKeyName: cipherSecretKeyName,
