...
// SyslogTextErrorLogPublisherShared struct for SyslogTextErrorLogPublisherShared
type SyslogTextErrorLogPublisherShared struct {
...
func NewSyslogTextErrorLogPublisherShared(schemas []EnumsyslogTextErrorLogPublisherSchemaUrn, syslogExternalServer []string, syslogFacility EnumlogPublisherSyslogFacilityProp, enabled bool) *SyslogTextErrorLogPublisherShared {
	this := SyslogTextErrorLogPublisherShared{}
...
func (o SyslogTextErrorLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableSyslogTextErrorLogPublisherShared struct {
	value *SyslogTextErrorLogPublisherShared
	isSet bool
}

func (v NullableSyslogTextErrorLogPublisherShared) Get() *SyslogTextErrorLogPublisherShared {
	return v.value
}

func (v *NullableSyslogTextErrorLogPublisherShared) Set(val *SyslogTextErrorLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableSyslogTextErrorLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableSyslogTextErrorLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyslogTextErrorLogPublisherShared(val *SyslogTextErrorLogPublisherShared) *NullableSyslogTextErrorLogPublisherShared {
	return &NullableSyslogTextErrorLogPublisherShared{value: val, isSet: true}
}

func (v NullableSyslogTextErrorLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyslogTextErrorLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
