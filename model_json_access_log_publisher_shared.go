...
// JsonAccessLogPublisherShared struct for JsonAccessLogPublisherShared
type JsonAccessLogPublisherShared struct {
...
func NewJsonAccessLogPublisherShared(schemas []EnumjsonAccessLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool) *JsonAccessLogPublisherShared {
	this := JsonAccessLogPublisherShared{}
...
func (o JsonAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableJsonAccessLogPublisherShared struct {
	value *JsonAccessLogPublisherShared
	isSet bool
}

func (v NullableJsonAccessLogPublisherShared) Get() *JsonAccessLogPublisherShared {
	return v.value
}

func (v *NullableJsonAccessLogPublisherShared) Set(val *JsonAccessLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableJsonAccessLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableJsonAccessLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJsonAccessLogPublisherShared(val *JsonAccessLogPublisherShared) *NullableJsonAccessLogPublisherShared {
	return &NullableJsonAccessLogPublisherShared{value: val, isSet: true}
}

func (v NullableJsonAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJsonAccessLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
