...
func NewAddFileBasedJsonHttpOperationLogPublisherRequest(publisherName string, schemas []EnumfileBasedJsonHttpOperationLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool) *AddFileBasedJsonHttpOperationLogPublisherRequest {
