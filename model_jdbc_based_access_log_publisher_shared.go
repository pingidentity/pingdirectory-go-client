...
// JdbcBasedAccessLogPublisherShared struct for JdbcBasedAccessLogPublisherShared
type JdbcBasedAccessLogPublisherShared struct {
...
func NewJdbcBasedAccessLogPublisherShared(schemas []EnumjdbcBasedAccessLogPublisherSchemaUrn, server string, logFieldMapping string, logTableName string, enabled bool) *JdbcBasedAccessLogPublisherShared {
	this := JdbcBasedAccessLogPublisherShared{}
...
func (o JdbcBasedAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableJdbcBasedAccessLogPublisherShared struct {
	value *JdbcBasedAccessLogPublisherShared
	isSet bool
}

func (v NullableJdbcBasedAccessLogPublisherShared) Get() *JdbcBasedAccessLogPublisherShared {
	return v.value
}

func (v *NullableJdbcBasedAccessLogPublisherShared) Set(val *JdbcBasedAccessLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableJdbcBasedAccessLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableJdbcBasedAccessLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJdbcBasedAccessLogPublisherShared(val *JdbcBasedAccessLogPublisherShared) *NullableJdbcBasedAccessLogPublisherShared {
	return &NullableJdbcBasedAccessLogPublisherShared{value: val, isSet: true}
}

func (v NullableJdbcBasedAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJdbcBasedAccessLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
