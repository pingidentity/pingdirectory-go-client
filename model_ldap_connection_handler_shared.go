...
// LdapConnectionHandlerShared struct for LdapConnectionHandlerShared
type LdapConnectionHandlerShared struct {
...
func NewLdapConnectionHandlerShared(schemas []EnumldapConnectionHandlerSchemaUrn, listenPort int32, enabled bool) *LdapConnectionHandlerShared {
	this := LdapConnectionHandlerShared{}
...
func (o LdapConnectionHandlerShared) MarshalJSON() ([]byte, error) {
...
type NullableLdapConnectionHandlerShared struct {
	value *LdapConnectionHandlerShared
	isSet bool
}

func (v NullableLdapConnectionHandlerShared) Get() *LdapConnectionHandlerShared {
	return v.value
}

func (v *NullableLdapConnectionHandlerShared) Set(val *LdapConnectionHandlerShared) {
	v.value = val
	v.isSet = true
}

func (v NullableLdapConnectionHandlerShared) IsSet() bool {
	return v.isSet
}

func (v *NullableLdapConnectionHandlerShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLdapConnectionHandlerShared(val *LdapConnectionHandlerShared) *NullableLdapConnectionHandlerShared {
	return &NullableLdapConnectionHandlerShared{value: val, isSet: true}
}

func (v NullableLdapConnectionHandlerShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLdapConnectionHandlerShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
