...
// ThirdPartyPasswordGeneratorShared struct for ThirdPartyPasswordGeneratorShared
type ThirdPartyPasswordGeneratorShared struct {
...
func NewThirdPartyPasswordGeneratorShared(schemas []EnumthirdPartyPasswordGeneratorSchemaUrn, extensionClass string, enabled bool) *ThirdPartyPasswordGeneratorShared {
	this := ThirdPartyPasswordGeneratorShared{}
...
func (o ThirdPartyPasswordGeneratorShared) MarshalJSON() ([]byte, error) {
...
type NullableThirdPartyPasswordGeneratorShared struct {
	value *ThirdPartyPasswordGeneratorShared
	isSet bool
}

func (v NullableThirdPartyPasswordGeneratorShared) Get() *ThirdPartyPasswordGeneratorShared {
	return v.value
}

func (v *NullableThirdPartyPasswordGeneratorShared) Set(val *ThirdPartyPasswordGeneratorShared) {
	v.value = val
	v.isSet = true
}

func (v NullableThirdPartyPasswordGeneratorShared) IsSet() bool {
	return v.isSet
}

func (v *NullableThirdPartyPasswordGeneratorShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThirdPartyPasswordGeneratorShared(val *ThirdPartyPasswordGeneratorShared) *NullableThirdPartyPasswordGeneratorShared {
	return &NullableThirdPartyPasswordGeneratorShared{value: val, isSet: true}
}

func (v NullableThirdPartyPasswordGeneratorShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThirdPartyPasswordGeneratorShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
