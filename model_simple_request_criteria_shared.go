...
// SimpleRequestCriteriaShared struct for SimpleRequestCriteriaShared
type SimpleRequestCriteriaShared struct {
...
func NewSimpleRequestCriteriaShared(schemas []EnumsimpleRequestCriteriaSchemaUrn) *SimpleRequestCriteriaShared {
	this := SimpleRequestCriteriaShared{}
...
func (o SimpleRequestCriteriaShared) MarshalJSON() ([]byte, error) {
...
type NullableSimpleRequestCriteriaShared struct {
	value *SimpleRequestCriteriaShared
	isSet bool
}

func (v NullableSimpleRequestCriteriaShared) Get() *SimpleRequestCriteriaShared {
	return v.value
}

func (v *NullableSimpleRequestCriteriaShared) Set(val *SimpleRequestCriteriaShared) {
	v.value = val
	v.isSet = true
}

func (v NullableSimpleRequestCriteriaShared) IsSet() bool {
	return v.isSet
}

func (v *NullableSimpleRequestCriteriaShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSimpleRequestCriteriaShared(val *SimpleRequestCriteriaShared) *NullableSimpleRequestCriteriaShared {
	return &NullableSimpleRequestCriteriaShared{value: val, isSet: true}
}

func (v NullableSimpleRequestCriteriaShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSimpleRequestCriteriaShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
