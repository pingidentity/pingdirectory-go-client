...
// ConstructedVirtualAttributeShared struct for ConstructedVirtualAttributeShared
type ConstructedVirtualAttributeShared struct {
...
func NewConstructedVirtualAttributeShared(schemas []EnumconstructedVirtualAttributeSchemaUrn, valuePattern []string, enabled bool, attributeType string) *ConstructedVirtualAttributeShared {
	this := ConstructedVirtualAttributeShared{}
...
func (o ConstructedVirtualAttributeShared) MarshalJSON() ([]byte, error) {
...
type NullableConstructedVirtualAttributeShared struct {
	value *ConstructedVirtualAttributeShared
	isSet bool
}

func (v NullableConstructedVirtualAttributeShared) Get() *ConstructedVirtualAttributeShared {
	return v.value
}

func (v *NullableConstructedVirtualAttributeShared) Set(val *ConstructedVirtualAttributeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableConstructedVirtualAttributeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableConstructedVirtualAttributeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConstructedVirtualAttributeShared(val *ConstructedVirtualAttributeShared) *NullableConstructedVirtualAttributeShared {
	return &NullableConstructedVirtualAttributeShared{value: val, isSet: true}
}

func (v NullableConstructedVirtualAttributeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConstructedVirtualAttributeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
