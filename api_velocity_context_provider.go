...
*/
func (a *VelocityContextProviderApiService) AddVelocityContextProvider(ctx context.Context) ApiAddVelocityContextProviderRequest {
	return ApiAddVelocityContextProviderRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *VelocityContextProviderApiService) AddVelocityContextProviderExecute(r ApiAddVelocityContextProviderRequest) (*AddVelocityContextProvider200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/velocity-context-providers"
...
DeleteVelocityContextProvider Delete a Velocity Context Provider
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param velocityContextProviderName Name of the Velocity Context Provider to be deleted
	@return ApiDeleteVelocityContextProviderRequest
*/
func (a *VelocityContextProviderApiService) DeleteVelocityContextProvider(ctx context.Context, velocityContextProviderName string) ApiDeleteVelocityContextProviderRequest {
	return ApiDeleteVelocityContextProviderRequest{
		ApiService:                  a,
		ctx:                         ctx,
...
func (a *VelocityContextProviderApiService) DeleteVelocityContextProviderExecute(r ApiDeleteVelocityContextProviderRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/velocity-context-providers/{velocity-context-provider-name}"
...
GetVelocityContextProvider Returns a single Velocity Context Provider
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param velocityContextProviderName Name of the Velocity Context Provider to be read
	@return ApiGetVelocityContextProviderRequest
*/
func (a *VelocityContextProviderApiService) GetVelocityContextProvider(ctx context.Context, velocityContextProviderName string) ApiGetVelocityContextProviderRequest {
	return ApiGetVelocityContextProviderRequest{
		ApiService:                  a,
		ctx:                         ctx,
		velocityContextProviderName: velocityContextProviderName,
...
UpdateVelocityContextProvider Update an existing Velocity Context Provider by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param velocityContextProviderName Name of the Velocity Context Provider to be updated
	@return ApiUpdateVelocityContextProviderRequest
*/
func (a *VelocityContextProviderApiService) UpdateVelocityContextProvider(ctx context.Context, velocityContextProviderName string) ApiUpdateVelocityContextProviderRequest {
	return ApiUpdateVelocityContextProviderRequest{
		ApiService:                  a,
		ctx:                         ctx,
		velocityContextProviderName: velocityContextProviderName,
