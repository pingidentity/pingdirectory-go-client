...
// NumericGaugeShared struct for NumericGaugeShared
type NumericGaugeShared struct {
...
func (o NumericGaugeShared) MarshalJSON() ([]byte, error) {
...
type NullableNumericGaugeShared struct {
	value *NumericGaugeShared
	isSet bool
}

func (v NullableNumericGaugeShared) Get() *NumericGaugeShared {
	return v.value
}

func (v *NullableNumericGaugeShared) Set(val *NumericGaugeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableNumericGaugeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableNumericGaugeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNumericGaugeShared(val *NumericGaugeShared) *NullableNumericGaugeShared {
	return &NullableNumericGaugeShared{value: val, isSet: true}
}

func (v NullableNumericGaugeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNumericGaugeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
