...
type NullableAttributeValuePasswordValidatorResponse struct {
	value *AttributeValuePasswordValidatorResponse
	isSet bool
}

func (v NullableAttributeValuePasswordValidatorResponse) Get() *AttributeValuePasswordValidatorResponse {
	return v.value
}

func (v *NullableAttributeValuePasswordValidatorResponse) Set(val *AttributeValuePasswordValidatorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAttributeValuePasswordValidatorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAttributeValuePasswordValidatorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttributeValuePasswordValidatorResponse(val *AttributeValuePasswordValidatorResponse) *NullableAttributeValuePasswordValidatorResponse {
	return &NullableAttributeValuePasswordValidatorResponse{value: val, isSet: true}
}

func (v NullableAttributeValuePasswordValidatorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttributeValuePasswordValidatorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
