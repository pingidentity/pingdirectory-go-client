...
// NokiaDsExternalServerShared struct for NokiaDsExternalServerShared
type NokiaDsExternalServerShared struct {
...
func NewNokiaDsExternalServerShared(schemas []EnumnokiaDsExternalServerSchemaUrn, verifyCredentialsMethod EnumexternalServerVerifyCredentialsMethodProp, serverHostName string, serverPort int32, connectionSecurity EnumexternalServerConnectionSecurityProp, authenticationMethod EnumexternalServerAuthenticationMethodProp, maxConnectionAge string, connectTimeout string, maxResponseSize string) *NokiaDsExternalServerShared {
	this := NokiaDsExternalServerShared{}
...
func (o NokiaDsExternalServerShared) MarshalJSON() ([]byte, error) {
...
type NullableNokiaDsExternalServerShared struct {
	value *NokiaDsExternalServerShared
	isSet bool
}

func (v NullableNokiaDsExternalServerShared) Get() *NokiaDsExternalServerShared {
	return v.value
}

func (v *NullableNokiaDsExternalServerShared) Set(val *NokiaDsExternalServerShared) {
	v.value = val
	v.isSet = true
}

func (v NullableNokiaDsExternalServerShared) IsSet() bool {
	return v.isSet
}

func (v *NullableNokiaDsExternalServerShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNokiaDsExternalServerShared(val *NokiaDsExternalServerShared) *NullableNokiaDsExternalServerShared {
	return &NullableNokiaDsExternalServerShared{value: val, isSet: true}
}

func (v NullableNokiaDsExternalServerShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNokiaDsExternalServerShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
