...
*/
func (a *ScimAttributeMappingApiService) AddScimAttributeMapping(ctx context.Context) ApiAddScimAttributeMappingRequest {
	return ApiAddScimAttributeMappingRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ScimAttributeMappingApiService) AddScimAttributeMappingExecute(r ApiAddScimAttributeMappingRequest) (*ScimAttributeMappingResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/scim-attribute-mappings"
...
DeleteScimAttributeMapping Delete a SCIM Attribute Mapping
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param scimAttributeMappingName Name of the SCIM Attribute Mapping to be deleted
	@return ApiDeleteScimAttributeMappingRequest
*/
func (a *ScimAttributeMappingApiService) DeleteScimAttributeMapping(ctx context.Context, scimAttributeMappingName string) ApiDeleteScimAttributeMappingRequest {
	return ApiDeleteScimAttributeMappingRequest{
		ApiService:               a,
		ctx:                      ctx,
...
func (a *ScimAttributeMappingApiService) DeleteScimAttributeMappingExecute(r ApiDeleteScimAttributeMappingRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/scim-attribute-mappings/{scim-attribute-mapping-name}"
	localVarPath = strings.Replace(localVarPath, "{"+"scim-attribute-mapping-name"+"}", url.PathEscape(parameterToString(r.scimAttributeMappingName, "")), -1)
...
GetScimAttributeMapping Returns a single SCIM Attribute Mapping
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param scimAttributeMappingName Name of the SCIM Attribute Mapping to be read
	@return ApiGetScimAttributeMappingRequest
*/
func (a *ScimAttributeMappingApiService) GetScimAttributeMapping(ctx context.Context, scimAttributeMappingName string) ApiGetScimAttributeMappingRequest {
	return ApiGetScimAttributeMappingRequest{
		ApiService:               a,
		ctx:                      ctx,
		scimAttributeMappingName: scimAttributeMappingName,
...
UpdateScimAttributeMapping Update an existing SCIM Attribute Mapping by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param scimAttributeMappingName Name of the SCIM Attribute Mapping to be updated
	@return ApiUpdateScimAttributeMappingRequest
*/
func (a *ScimAttributeMappingApiService) UpdateScimAttributeMapping(ctx context.Context, scimAttributeMappingName string) ApiUpdateScimAttributeMappingRequest {
	return ApiUpdateScimAttributeMappingRequest{
		ApiService:               a,
		ctx:                      ctx,
		scimAttributeMappingName: scimAttributeMappingName,
