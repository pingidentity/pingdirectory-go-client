...
// ThirdPartyPassphraseProviderShared struct for ThirdPartyPassphraseProviderShared
type ThirdPartyPassphraseProviderShared struct {
...
func NewThirdPartyPassphraseProviderShared(schemas []EnumthirdPartyPassphraseProviderSchemaUrn, extensionClass string, enabled bool) *ThirdPartyPassphraseProviderShared {
	this := ThirdPartyPassphraseProviderShared{}
...
func (o ThirdPartyPassphraseProviderShared) MarshalJSON() ([]byte, error) {
...
type NullableThirdPartyPassphraseProviderShared struct {
	value *ThirdPartyPassphraseProviderShared
	isSet bool
}

func (v NullableThirdPartyPassphraseProviderShared) Get() *ThirdPartyPassphraseProviderShared {
	return v.value
}

func (v *NullableThirdPartyPassphraseProviderShared) Set(val *ThirdPartyPassphraseProviderShared) {
	v.value = val
	v.isSet = true
}

func (v NullableThirdPartyPassphraseProviderShared) IsSet() bool {
	return v.isSet
}

func (v *NullableThirdPartyPassphraseProviderShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThirdPartyPassphraseProviderShared(val *ThirdPartyPassphraseProviderShared) *NullableThirdPartyPassphraseProviderShared {
	return &NullableThirdPartyPassphraseProviderShared{value: val, isSet: true}
}

func (v NullableThirdPartyPassphraseProviderShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThirdPartyPassphraseProviderShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
