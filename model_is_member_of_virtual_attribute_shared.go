...
// IsMemberOfVirtualAttributeShared struct for IsMemberOfVirtualAttributeShared
type IsMemberOfVirtualAttributeShared struct {
...
func NewIsMemberOfVirtualAttributeShared(schemas []EnumisMemberOfVirtualAttributeSchemaUrn, attributeType string, enabled bool) *IsMemberOfVirtualAttributeShared {
	this := IsMemberOfVirtualAttributeShared{}
...
func (o IsMemberOfVirtualAttributeShared) MarshalJSON() ([]byte, error) {
...
type NullableIsMemberOfVirtualAttributeShared struct {
	value *IsMemberOfVirtualAttributeShared
	isSet bool
}

func (v NullableIsMemberOfVirtualAttributeShared) Get() *IsMemberOfVirtualAttributeShared {
	return v.value
}

func (v *NullableIsMemberOfVirtualAttributeShared) Set(val *IsMemberOfVirtualAttributeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableIsMemberOfVirtualAttributeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableIsMemberOfVirtualAttributeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIsMemberOfVirtualAttributeShared(val *IsMemberOfVirtualAttributeShared) *NullableIsMemberOfVirtualAttributeShared {
	return &NullableIsMemberOfVirtualAttributeShared{value: val, isSet: true}
}

func (v NullableIsMemberOfVirtualAttributeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIsMemberOfVirtualAttributeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
