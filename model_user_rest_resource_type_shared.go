...
// UserRestResourceTypeShared struct for UserRestResourceTypeShared
type UserRestResourceTypeShared struct {
...
func NewUserRestResourceTypeShared(schemas []EnumuserRestResourceTypeSchemaUrn, enabled bool, resourceEndpoint string, structuralLDAPObjectclass string, searchBaseDN string) *UserRestResourceTypeShared {
	this := UserRestResourceTypeShared{}
...
func (o UserRestResourceTypeShared) MarshalJSON() ([]byte, error) {
...
type NullableUserRestResourceTypeShared struct {
	value *UserRestResourceTypeShared
	isSet bool
}

func (v NullableUserRestResourceTypeShared) Get() *UserRestResourceTypeShared {
	return v.value
}

func (v *NullableUserRestResourceTypeShared) Set(val *UserRestResourceTypeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableUserRestResourceTypeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableUserRestResourceTypeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserRestResourceTypeShared(val *UserRestResourceTypeShared) *NullableUserRestResourceTypeShared {
	return &NullableUserRestResourceTypeShared{value: val, isSet: true}
}

func (v NullableUserRestResourceTypeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserRestResourceTypeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
