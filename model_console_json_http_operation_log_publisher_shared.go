...
// ConsoleJsonHttpOperationLogPublisherShared struct for ConsoleJsonHttpOperationLogPublisherShared
type ConsoleJsonHttpOperationLogPublisherShared struct {
...
func NewConsoleJsonHttpOperationLogPublisherShared(schemas []EnumconsoleJsonHttpOperationLogPublisherSchemaUrn, enabled bool) *ConsoleJsonHttpOperationLogPublisherShared {
	this := ConsoleJsonHttpOperationLogPublisherShared{}
...
func (o ConsoleJsonHttpOperationLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableConsoleJsonHttpOperationLogPublisherShared struct {
	value *ConsoleJsonHttpOperationLogPublisherShared
	isSet bool
}

func (v NullableConsoleJsonHttpOperationLogPublisherShared) Get() *ConsoleJsonHttpOperationLogPublisherShared {
	return v.value
}

func (v *NullableConsoleJsonHttpOperationLogPublisherShared) Set(val *ConsoleJsonHttpOperationLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableConsoleJsonHttpOperationLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableConsoleJsonHttpOperationLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConsoleJsonHttpOperationLogPublisherShared(val *ConsoleJsonHttpOperationLogPublisherShared) *NullableConsoleJsonHttpOperationLogPublisherShared {
	return &NullableConsoleJsonHttpOperationLogPublisherShared{value: val, isSet: true}
}

func (v NullableConsoleJsonHttpOperationLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConsoleJsonHttpOperationLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
