...
*/
func (a *ScimAttributeApiService) AddScimAttribute(ctx context.Context) ApiAddScimAttributeRequest {
	return ApiAddScimAttributeRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ScimAttributeApiService) AddScimAttributeExecute(r ApiAddScimAttributeRequest) (*ScimAttributeResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/scim-attributes"
...
DeleteScimAttribute Delete a SCIM Attribute
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param scimAttributeName Name of the SCIM Attribute to be deleted
	@return ApiDeleteScimAttributeRequest
*/
func (a *ScimAttributeApiService) DeleteScimAttribute(ctx context.Context, scimAttributeName string) ApiDeleteScimAttributeRequest {
	return ApiDeleteScimAttributeRequest{
		ApiService:        a,
		ctx:               ctx,
...
func (a *ScimAttributeApiService) DeleteScimAttributeExecute(r ApiDeleteScimAttributeRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/scim-attributes/{scim-attribute-name}"
...
GetScimAttribute Returns a single SCIM Attribute
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param scimAttributeName Name of the SCIM Attribute to be read
	@return ApiGetScimAttributeRequest
*/
func (a *ScimAttributeApiService) GetScimAttribute(ctx context.Context, scimAttributeName string) ApiGetScimAttributeRequest {
	return ApiGetScimAttributeRequest{
		ApiService:        a,
		ctx:               ctx,
		scimAttributeName: scimAttributeName,
...
UpdateScimAttribute Update an existing SCIM Attribute by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param scimAttributeName Name of the SCIM Attribute to be updated
	@return ApiUpdateScimAttributeRequest
*/
func (a *ScimAttributeApiService) UpdateScimAttribute(ctx context.Context, scimAttributeName string) ApiUpdateScimAttributeRequest {
	return ApiUpdateScimAttributeRequest{
		ApiService:        a,
		ctx:               ctx,
		scimAttributeName: scimAttributeName,
