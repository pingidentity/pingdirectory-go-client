...
const (
	REPLACE_LISTENER_CERTIFICATE EnumextendedOperationHandlerAllowedOperationProp = "replace-listener-certificate"
	REPLACE_INTER_SERVER_CERTIFICATE EnumextendedOperationHandlerAllowedOperationProp = "replace-inter-server-certificate"
	PURGE_RETIRED_LISTENER_CERTIFICATES EnumextendedOperationHandlerAllowedOperationProp = "purge-retired-listener-certificates"
	PURGE_RETIRED_INTER_SERVER_CERTIFICATES EnumextendedOperationHandlerAllowedOperationProp = "purge-retired-inter-server-certificates"
)
