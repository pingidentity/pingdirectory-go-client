...
// ReplaceCertificateExtendedOperationHandlerShared struct for ReplaceCertificateExtendedOperationHandlerShared
type ReplaceCertificateExtendedOperationHandlerShared struct {
...
func NewReplaceCertificateExtendedOperationHandlerShared(schemas []EnumreplaceCertificateExtendedOperationHandlerSchemaUrn, enabled bool) *ReplaceCertificateExtendedOperationHandlerShared {
	this := ReplaceCertificateExtendedOperationHandlerShared{}
...
func (o ReplaceCertificateExtendedOperationHandlerShared) MarshalJSON() ([]byte, error) {
...
type NullableReplaceCertificateExtendedOperationHandlerShared struct {
	value *ReplaceCertificateExtendedOperationHandlerShared
	isSet bool
}

func (v NullableReplaceCertificateExtendedOperationHandlerShared) Get() *ReplaceCertificateExtendedOperationHandlerShared {
	return v.value
}

func (v *NullableReplaceCertificateExtendedOperationHandlerShared) Set(val *ReplaceCertificateExtendedOperationHandlerShared) {
	v.value = val
	v.isSet = true
}

func (v NullableReplaceCertificateExtendedOperationHandlerShared) IsSet() bool {
	return v.isSet
}

func (v *NullableReplaceCertificateExtendedOperationHandlerShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReplaceCertificateExtendedOperationHandlerShared(val *ReplaceCertificateExtendedOperationHandlerShared) *NullableReplaceCertificateExtendedOperationHandlerShared {
	return &NullableReplaceCertificateExtendedOperationHandlerShared{value: val, isSet: true}
}

func (v NullableReplaceCertificateExtendedOperationHandlerShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReplaceCertificateExtendedOperationHandlerShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
