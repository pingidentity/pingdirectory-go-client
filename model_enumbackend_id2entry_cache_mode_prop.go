...
const (
	CACHE_KEYS_AND_VALUES EnumbackendId2entryCacheModeProp = "cache-keys-and-values"
	CACHE_KEYS_ONLY EnumbackendId2entryCacheModeProp = "cache-keys-only"
	NO_CACHING EnumbackendId2entryCacheModeProp = "no-caching"
	KEEP_HOT EnumbackendId2entryCacheModeProp = "keep-hot"
	DEFAULT EnumbackendId2entryCacheModeProp = "default"
	MAKE_COLD EnumbackendId2entryCacheModeProp = "make-cold"
	EVICT_LEAF_IMMEDIATELY EnumbackendId2entryCacheModeProp = "evict-leaf-immediately"
	EVICT_BIN_IMMEDIATELY EnumbackendId2entryCacheModeProp = "evict-bin-immediately"
)
