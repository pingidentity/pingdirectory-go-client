...
func NewAddFileBasedAccessLogPublisherRequest(publisherName string, schemas []EnumfileBasedAccessLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool) *AddFileBasedAccessLogPublisherRequest {
