...
// EntryDnVirtualAttributeShared struct for EntryDnVirtualAttributeShared
type EntryDnVirtualAttributeShared struct {
...
func NewEntryDnVirtualAttributeShared(schemas []EnumentryDnVirtualAttributeSchemaUrn, attributeType string, enabled bool) *EntryDnVirtualAttributeShared {
	this := EntryDnVirtualAttributeShared{}
...
func (o EntryDnVirtualAttributeShared) MarshalJSON() ([]byte, error) {
...
type NullableEntryDnVirtualAttributeShared struct {
	value *EntryDnVirtualAttributeShared
	isSet bool
}

func (v NullableEntryDnVirtualAttributeShared) Get() *EntryDnVirtualAttributeShared {
	return v.value
}

func (v *NullableEntryDnVirtualAttributeShared) Set(val *EntryDnVirtualAttributeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableEntryDnVirtualAttributeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableEntryDnVirtualAttributeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntryDnVirtualAttributeShared(val *EntryDnVirtualAttributeShared) *NullableEntryDnVirtualAttributeShared {
	return &NullableEntryDnVirtualAttributeShared{value: val, isSet: true}
}

func (v NullableEntryDnVirtualAttributeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntryDnVirtualAttributeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
