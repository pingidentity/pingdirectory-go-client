...
// ErrorLogFieldMappingShared struct for ErrorLogFieldMappingShared
type ErrorLogFieldMappingShared struct {
...
func NewErrorLogFieldMappingShared(schemas []EnumerrorLogFieldMappingSchemaUrn) *ErrorLogFieldMappingShared {
	this := ErrorLogFieldMappingShared{}
...
func (o ErrorLogFieldMappingShared) MarshalJSON() ([]byte, error) {
...
type NullableErrorLogFieldMappingShared struct {
	value *ErrorLogFieldMappingShared
	isSet bool
}

func (v NullableErrorLogFieldMappingShared) Get() *ErrorLogFieldMappingShared {
	return v.value
}

func (v *NullableErrorLogFieldMappingShared) Set(val *ErrorLogFieldMappingShared) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorLogFieldMappingShared) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorLogFieldMappingShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorLogFieldMappingShared(val *ErrorLogFieldMappingShared) *NullableErrorLogFieldMappingShared {
	return &NullableErrorLogFieldMappingShared{value: val, isSet: true}
}

func (v NullableErrorLogFieldMappingShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorLogFieldMappingShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
