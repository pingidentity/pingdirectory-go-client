...
// IdentifyReferencesVirtualAttributeShared struct for IdentifyReferencesVirtualAttributeShared
type IdentifyReferencesVirtualAttributeShared struct {
...
func NewIdentifyReferencesVirtualAttributeShared(schemas []EnumidentifyReferencesVirtualAttributeSchemaUrn, referencedByAttribute []string, enabled bool, attributeType string) *IdentifyReferencesVirtualAttributeShared {
	this := IdentifyReferencesVirtualAttributeShared{}
...
func (o IdentifyReferencesVirtualAttributeShared) MarshalJSON() ([]byte, error) {
...
type NullableIdentifyReferencesVirtualAttributeShared struct {
	value *IdentifyReferencesVirtualAttributeShared
	isSet bool
}

func (v NullableIdentifyReferencesVirtualAttributeShared) Get() *IdentifyReferencesVirtualAttributeShared {
	return v.value
}

func (v *NullableIdentifyReferencesVirtualAttributeShared) Set(val *IdentifyReferencesVirtualAttributeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentifyReferencesVirtualAttributeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentifyReferencesVirtualAttributeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentifyReferencesVirtualAttributeShared(val *IdentifyReferencesVirtualAttributeShared) *NullableIdentifyReferencesVirtualAttributeShared {
	return &NullableIdentifyReferencesVirtualAttributeShared{value: val, isSet: true}
}

func (v NullableIdentifyReferencesVirtualAttributeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentifyReferencesVirtualAttributeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
