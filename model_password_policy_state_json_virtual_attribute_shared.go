...
// PasswordPolicyStateJsonVirtualAttributeShared struct for PasswordPolicyStateJsonVirtualAttributeShared
type PasswordPolicyStateJsonVirtualAttributeShared struct {
...
func NewPasswordPolicyStateJsonVirtualAttributeShared(schemas []EnumpasswordPolicyStateJsonVirtualAttributeSchemaUrn, enabled bool, attributeType string) *PasswordPolicyStateJsonVirtualAttributeShared {
	this := PasswordPolicyStateJsonVirtualAttributeShared{}
...
func (o PasswordPolicyStateJsonVirtualAttributeShared) MarshalJSON() ([]byte, error) {
...
type NullablePasswordPolicyStateJsonVirtualAttributeShared struct {
	value *PasswordPolicyStateJsonVirtualAttributeShared
	isSet bool
}

func (v NullablePasswordPolicyStateJsonVirtualAttributeShared) Get() *PasswordPolicyStateJsonVirtualAttributeShared {
	return v.value
}

func (v *NullablePasswordPolicyStateJsonVirtualAttributeShared) Set(val *PasswordPolicyStateJsonVirtualAttributeShared) {
	v.value = val
	v.isSet = true
}

func (v NullablePasswordPolicyStateJsonVirtualAttributeShared) IsSet() bool {
	return v.isSet
}

func (v *NullablePasswordPolicyStateJsonVirtualAttributeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePasswordPolicyStateJsonVirtualAttributeShared(val *PasswordPolicyStateJsonVirtualAttributeShared) *NullablePasswordPolicyStateJsonVirtualAttributeShared {
	return &NullablePasswordPolicyStateJsonVirtualAttributeShared{value: val, isSet: true}
}

func (v NullablePasswordPolicyStateJsonVirtualAttributeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePasswordPolicyStateJsonVirtualAttributeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
