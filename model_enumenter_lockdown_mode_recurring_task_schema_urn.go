...
const (
	URNPINGIDENTITYSCHEMASCONFIGURATION2_0RECURRING_TASKENTER_LOCKDOWN_MODE EnumenterLockdownModeRecurringTaskSchemaUrn = "urn:pingidentity:schemas:configuration:2.0:recurring-task:enter-lockdown-mode"
)
