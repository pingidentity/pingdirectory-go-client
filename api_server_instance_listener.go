...
GetServerInstanceListener Returns a single Server Instance Listener
	...
	@param serverInstanceListenerName Name of the Server Instance Listener to be read
	@return ApiGetServerInstanceListenerRequest
*/
func (a *ServerInstanceListenerApiService) GetServerInstanceListener(ctx context.Context, serverInstanceListenerName string) ApiGetServerInstanceListenerRequest {
	return ApiGetServerInstanceListenerRequest{
		ApiService:                 a,
		ctx:                        ctx,
...
func (a *ServerInstanceListenerApiService) GetServerInstanceListenerExecute(r ApiGetServerInstanceListenerRequest) (*GetServerInstanceListener200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/server-instance-listeners/{server-instance-listener-name}"
...
UpdateServerInstanceListener Update an existing Server Instance Listener by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param serverInstanceListenerName Name of the Server Instance Listener to be updated
	@return ApiUpdateServerInstanceListenerRequest
*/
func (a *ServerInstanceListenerApiService) UpdateServerInstanceListener(ctx context.Context, serverInstanceListenerName string) ApiUpdateServerInstanceListenerRequest {
	return ApiUpdateServerInstanceListenerRequest{
		ApiService:                 a,
		ctx:                        ctx,
		serverInstanceListenerName: serverInstanceListenerName,
