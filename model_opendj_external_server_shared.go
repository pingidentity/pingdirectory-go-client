...
// OpendjExternalServerShared struct for OpendjExternalServerShared
type OpendjExternalServerShared struct {
...
func NewOpendjExternalServerShared(schemas []EnumopendjExternalServerSchemaUrn, serverHostName string, serverPort int32, connectionSecurity EnumexternalServerConnectionSecurityProp, authenticationMethod EnumexternalServerAuthenticationMethodProp, verifyCredentialsMethod EnumexternalServerVerifyCredentialsMethodProp, maxConnectionAge string, connectTimeout string, maxResponseSize string) *OpendjExternalServerShared {
	this := OpendjExternalServerShared{}
...
func (o OpendjExternalServerShared) MarshalJSON() ([]byte, error) {
...
type NullableOpendjExternalServerShared struct {
	value *OpendjExternalServerShared
	isSet bool
}

func (v NullableOpendjExternalServerShared) Get() *OpendjExternalServerShared {
	return v.value
}

func (v *NullableOpendjExternalServerShared) Set(val *OpendjExternalServerShared) {
	v.value = val
	v.isSet = true
}

func (v NullableOpendjExternalServerShared) IsSet() bool {
	return v.isSet
}

func (v *NullableOpendjExternalServerShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpendjExternalServerShared(val *OpendjExternalServerShared) *NullableOpendjExternalServerShared {
	return &NullableOpendjExternalServerShared{value: val, isSet: true}
}

func (v NullableOpendjExternalServerShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpendjExternalServerShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
