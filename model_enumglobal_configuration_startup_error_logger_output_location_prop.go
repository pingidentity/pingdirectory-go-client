...
const (
	STANDARD_OUTPUT EnumglobalConfigurationStartupErrorLoggerOutputLocationProp = "standard-output"
	STANDARD_ERROR EnumglobalConfigurationStartupErrorLoggerOutputLocationProp = "standard-error"
	SERVER_OUT_FILE EnumglobalConfigurationStartupErrorLoggerOutputLocationProp = "server-out-file"
	STANDARD_OUTPUT_AND_SERVER_OUT_FILE EnumglobalConfigurationStartupErrorLoggerOutputLocationProp = "standard-output-and-server-out-file"
	STANDARD_ERROR_AND_SERVER_OUT_FILE EnumglobalConfigurationStartupErrorLoggerOutputLocationProp = "standard-error-and-server-out-file"
	DISABLED EnumglobalConfigurationStartupErrorLoggerOutputLocationProp = "disabled"
)
