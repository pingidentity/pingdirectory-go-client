...
const (
	NONE EnumlogPublisherLogRequestHeadersProp = "none"
	HEADER_NAMES EnumlogPublisherLogRequestHeadersProp = "header-names"
	HEADER_NAMES_AND_VALUES EnumlogPublisherLogRequestHeadersProp = "header-names-and-values"
)
