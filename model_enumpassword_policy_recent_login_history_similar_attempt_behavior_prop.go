...
const (
	COLLAPSE_SIMILAR_ATTEMPTS_ON_THE_SAME_DATE EnumpasswordPolicyRecentLoginHistorySimilarAttemptBehaviorProp = "collapse-similar-attempts-on-the-same-date"
	MAINTAIN_EVERY_ATTEMPT EnumpasswordPolicyRecentLoginHistorySimilarAttemptBehaviorProp = "maintain-every-attempt"
	UPDATE_AT_MOST_ONCE_PER_DAY EnumpasswordPolicyRecentLoginHistorySimilarAttemptBehaviorProp = "update-at-most-once-per-day"
)
