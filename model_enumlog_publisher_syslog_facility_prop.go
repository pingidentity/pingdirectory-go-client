...
const (
	USER_LEVEL_MESSAGES EnumlogPublisherSyslogFacilityProp = "user-level-messages"
	SYSTEM_DAEMONS EnumlogPublisherSyslogFacilityProp = "system-daemons"
	SECURITY_AND_AUTHORIZATION EnumlogPublisherSyslogFacilityProp = "security-and-authorization"
	SECURITY_AND_AUTHORIZATION_ALTERNATIVE EnumlogPublisherSyslogFacilityProp = "security-and-authorization-alternative"
	LOG_AUDIT EnumlogPublisherSyslogFacilityProp = "log-audit"
	LOG_ALERT EnumlogPublisherSyslogFacilityProp = "log-alert"
	LOCAL_USE_0 EnumlogPublisherSyslogFacilityProp = "local-use-0"
	LOCAL_USE_1 EnumlogPublisherSyslogFacilityProp = "local-use-1"
	LOCAL_USE_2 EnumlogPublisherSyslogFacilityProp = "local-use-2"
	LOCAL_USE_3 EnumlogPublisherSyslogFacilityProp = "local-use-3"
	LOCAL_USE_4 EnumlogPublisherSyslogFacilityProp = "local-use-4"
	LOCAL_USE_5 EnumlogPublisherSyslogFacilityProp = "local-use-5"
	LOCAL_USE_6 EnumlogPublisherSyslogFacilityProp = "local-use-6"
	LOCAL_USE_7 EnumlogPublisherSyslogFacilityProp = "local-use-7"
	KERNEL_MESSAGES EnumlogPublisherSyslogFacilityProp = "kernel-messages"
	MAIL_SYSTEM EnumlogPublisherSyslogFacilityProp = "mail-system"
	SYSLOGD_INTERNAL_MESSAGES EnumlogPublisherSyslogFacilityProp = "syslogd-internal-messages"
	LINE_PRINTER EnumlogPublisherSyslogFacilityProp = "line-printer"
	NETWORK_NEWS EnumlogPublisherSyslogFacilityProp = "network-news"
	UUCP EnumlogPublisherSyslogFacilityProp = "uucp"
	CLOCK_DAEMON EnumlogPublisherSyslogFacilityProp = "clock-daemon"
	FTP_DAEMON EnumlogPublisherSyslogFacilityProp = "ftp-daemon"
	NTP_DAEMON EnumlogPublisherSyslogFacilityProp = "ntp-daemon"
	CLOCK_DAEMON_ALTERNATIVE EnumlogPublisherSyslogFacilityProp = "clock-daemon-alternative"
)
