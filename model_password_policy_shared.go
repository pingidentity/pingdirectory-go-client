...
// PasswordPolicyShared struct for PasswordPolicyShared
type PasswordPolicyShared struct {
...
func (o PasswordPolicyShared) MarshalJSON() ([]byte, error) {
...
type NullablePasswordPolicyShared struct {
	value *PasswordPolicyShared
	isSet bool
}

func (v NullablePasswordPolicyShared) Get() *PasswordPolicyShared {
	return v.value
}

func (v *NullablePasswordPolicyShared) Set(val *PasswordPolicyShared) {
	v.value = val
	v.isSet = true
}

func (v NullablePasswordPolicyShared) IsSet() bool {
	return v.isSet
}

func (v *NullablePasswordPolicyShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePasswordPolicyShared(val *PasswordPolicyShared) *NullablePasswordPolicyShared {
	return &NullablePasswordPolicyShared{value: val, isSet: true}
}

func (v NullablePasswordPolicyShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePasswordPolicyShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
