...
*/
func (a *ScimSubattributeApiService) AddScimSubattribute(ctx context.Context) ApiAddScimSubattributeRequest {
	return ApiAddScimSubattributeRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ScimSubattributeApiService) AddScimSubattributeExecute(r ApiAddScimSubattributeRequest) (*ScimSubattributeResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/scim-subattributes"
...
DeleteScimSubattribute Delete a SCIM Subattribute
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param scimSubattributeName Name of the SCIM Subattribute to be deleted
	@return ApiDeleteScimSubattributeRequest
*/
func (a *ScimSubattributeApiService) DeleteScimSubattribute(ctx context.Context, scimSubattributeName string) ApiDeleteScimSubattributeRequest {
	return ApiDeleteScimSubattributeRequest{
		ApiService:           a,
		ctx:                  ctx,
...
func (a *ScimSubattributeApiService) DeleteScimSubattributeExecute(r ApiDeleteScimSubattributeRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/scim-subattributes/{scim-subattribute-name}"
...
GetScimSubattribute Returns a single SCIM Subattribute
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param scimSubattributeName Name of the SCIM Subattribute to be read
	@return ApiGetScimSubattributeRequest
*/
func (a *ScimSubattributeApiService) GetScimSubattribute(ctx context.Context, scimSubattributeName string) ApiGetScimSubattributeRequest {
	return ApiGetScimSubattributeRequest{
		ApiService:           a,
		ctx:                  ctx,
		scimSubattributeName: scimSubattributeName,
...
UpdateScimSubattribute Update an existing SCIM Subattribute by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param scimSubattributeName Name of the SCIM Subattribute to be updated
	@return ApiUpdateScimSubattributeRequest
*/
func (a *ScimSubattributeApiService) UpdateScimSubattribute(ctx context.Context, scimSubattributeName string) ApiUpdateScimSubattributeRequest {
	return ApiUpdateScimSubattributeRequest{
		ApiService:           a,
		ctx:                  ctx,
		scimSubattributeName: scimSubattributeName,
