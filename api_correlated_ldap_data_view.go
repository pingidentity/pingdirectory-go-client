...
*/
func (a *CorrelatedLdapDataViewApiService) AddCorrelatedLdapDataView(ctx context.Context) ApiAddCorrelatedLdapDataViewRequest {
	return ApiAddCorrelatedLdapDataViewRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CorrelatedLdapDataViewApiService) AddCorrelatedLdapDataViewExecute(r ApiAddCorrelatedLdapDataViewRequest) (*CorrelatedLdapDataViewResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/correlated-ldap-data-views"
...
DeleteCorrelatedLdapDataView Delete a Correlated LDAP Data View
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param correlatedLdapDataViewName Name of the Correlated LDAP Data View to be deleted
	@return ApiDeleteCorrelatedLdapDataViewRequest
*/
func (a *CorrelatedLdapDataViewApiService) DeleteCorrelatedLdapDataView(ctx context.Context, correlatedLdapDataViewName string) ApiDeleteCorrelatedLdapDataViewRequest {
	return ApiDeleteCorrelatedLdapDataViewRequest{
		ApiService:                 a,
		ctx:                        ctx,
...
func (a *CorrelatedLdapDataViewApiService) DeleteCorrelatedLdapDataViewExecute(r ApiDeleteCorrelatedLdapDataViewRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/correlated-ldap-data-views/{correlated-ldap-data-view-name}"
	localVarPath = strings.Replace(localVarPath, "{"+"correlated-ldap-data-view-name"+"}", url.PathEscape(parameterToString(r.correlatedLdapDataViewName, "")), -1)
...
GetCorrelatedLdapDataView Returns a single Correlated LDAP Data View
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param correlatedLdapDataViewName Name of the Correlated LDAP Data View to be read
	@return ApiGetCorrelatedLdapDataViewRequest
*/
func (a *CorrelatedLdapDataViewApiService) GetCorrelatedLdapDataView(ctx context.Context, correlatedLdapDataViewName string) ApiGetCorrelatedLdapDataViewRequest {
	return ApiGetCorrelatedLdapDataViewRequest{
		ApiService:                 a,
		ctx:                        ctx,
		correlatedLdapDataViewName: correlatedLdapDataViewName,
...
UpdateCorrelatedLdapDataView Update an existing Correlated LDAP Data View by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param correlatedLdapDataViewName Name of the Correlated LDAP Data View to be updated
	@return ApiUpdateCorrelatedLdapDataViewRequest
*/
func (a *CorrelatedLdapDataViewApiService) UpdateCorrelatedLdapDataView(ctx context.Context, correlatedLdapDataViewName string) ApiUpdateCorrelatedLdapDataViewRequest {
	return ApiUpdateCorrelatedLdapDataViewRequest{
		ApiService:                 a,
		ctx:                        ctx,
		correlatedLdapDataViewName: correlatedLdapDataViewName,
