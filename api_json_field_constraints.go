...
*/
func (a *JsonFieldConstraintsApiService) AddJsonFieldConstraints(ctx context.Context) ApiAddJsonFieldConstraintsRequest {
	return ApiAddJsonFieldConstraintsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *JsonFieldConstraintsApiService) AddJsonFieldConstraintsExecute(r ApiAddJsonFieldConstraintsRequest) (*JsonFieldConstraintsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/json-field-constraints"
...
DeleteJsonFieldConstraints Delete a JSON Field Constraints
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param jsonFieldConstraintsName Name of the JSON Field Constraints to be deleted
	@return ApiDeleteJsonFieldConstraintsRequest
*/
func (a *JsonFieldConstraintsApiService) DeleteJsonFieldConstraints(ctx context.Context, jsonFieldConstraintsName string) ApiDeleteJsonFieldConstraintsRequest {
	return ApiDeleteJsonFieldConstraintsRequest{
		ApiService:               a,
		ctx:                      ctx,
...
func (a *JsonFieldConstraintsApiService) DeleteJsonFieldConstraintsExecute(r ApiDeleteJsonFieldConstraintsRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/json-field-constraints/{json-field-constraints-name}"
...
GetJsonFieldConstraints Returns a single JSON Field Constraints
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param jsonFieldConstraintsName Name of the JSON Field Constraints to be read
	@return ApiGetJsonFieldConstraintsRequest
*/
func (a *JsonFieldConstraintsApiService) GetJsonFieldConstraints(ctx context.Context, jsonFieldConstraintsName string) ApiGetJsonFieldConstraintsRequest {
	return ApiGetJsonFieldConstraintsRequest{
		ApiService:               a,
		ctx:                      ctx,
		jsonFieldConstraintsName: jsonFieldConstraintsName,
...
UpdateJsonFieldConstraints Update an existing JSON Field Constraints by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param jsonFieldConstraintsName Name of the JSON Field Constraints to be updated
	@return ApiUpdateJsonFieldConstraintsRequest
*/
func (a *JsonFieldConstraintsApiService) UpdateJsonFieldConstraints(ctx context.Context, jsonFieldConstraintsName string) ApiUpdateJsonFieldConstraintsRequest {
	return ApiUpdateJsonFieldConstraintsRequest{
		ApiService:               a,
		ctx:                      ctx,
		jsonFieldConstraintsName: jsonFieldConstraintsName,
