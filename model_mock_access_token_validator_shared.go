...
// MockAccessTokenValidatorShared struct for MockAccessTokenValidatorShared
type MockAccessTokenValidatorShared struct {
...
func NewMockAccessTokenValidatorShared(schemas []EnummockAccessTokenValidatorSchemaUrn, evaluationOrderIndex int32, enabled bool) *MockAccessTokenValidatorShared {
	this := MockAccessTokenValidatorShared{}
...
func (o MockAccessTokenValidatorShared) MarshalJSON() ([]byte, error) {
...
type NullableMockAccessTokenValidatorShared struct {
	value *MockAccessTokenValidatorShared
	isSet bool
}

func (v NullableMockAccessTokenValidatorShared) Get() *MockAccessTokenValidatorShared {
	return v.value
}

func (v *NullableMockAccessTokenValidatorShared) Set(val *MockAccessTokenValidatorShared) {
	v.value = val
	v.isSet = true
}

func (v NullableMockAccessTokenValidatorShared) IsSet() bool {
	return v.isSet
}

func (v *NullableMockAccessTokenValidatorShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMockAccessTokenValidatorShared(val *MockAccessTokenValidatorShared) *NullableMockAccessTokenValidatorShared {
	return &NullableMockAccessTokenValidatorShared{value: val, isSet: true}
}

func (v NullableMockAccessTokenValidatorShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMockAccessTokenValidatorShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
