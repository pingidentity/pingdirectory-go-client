...
// CharacterSetPasswordValidatorShared struct for CharacterSetPasswordValidatorShared
type CharacterSetPasswordValidatorShared struct {
...
func NewCharacterSetPasswordValidatorShared(schemas []EnumcharacterSetPasswordValidatorSchemaUrn, characterSet []string, allowUnclassifiedCharacters bool, enabled bool) *CharacterSetPasswordValidatorShared {
	this := CharacterSetPasswordValidatorShared{}
...
func (o CharacterSetPasswordValidatorShared) MarshalJSON() ([]byte, error) {
...
type NullableCharacterSetPasswordValidatorShared struct {
	value *CharacterSetPasswordValidatorShared
	isSet bool
}

func (v NullableCharacterSetPasswordValidatorShared) Get() *CharacterSetPasswordValidatorShared {
	return v.value
}

func (v *NullableCharacterSetPasswordValidatorShared) Set(val *CharacterSetPasswordValidatorShared) {
	v.value = val
	v.isSet = true
}

func (v NullableCharacterSetPasswordValidatorShared) IsSet() bool {
	return v.isSet
}

func (v *NullableCharacterSetPasswordValidatorShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCharacterSetPasswordValidatorShared(val *CharacterSetPasswordValidatorShared) *NullableCharacterSetPasswordValidatorShared {
	return &NullableCharacterSetPasswordValidatorShared{value: val, isSet: true}
}

func (v NullableCharacterSetPasswordValidatorShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCharacterSetPasswordValidatorShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
