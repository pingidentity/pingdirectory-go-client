...
// UserDefinedVirtualAttributeShared struct for UserDefinedVirtualAttributeShared
type UserDefinedVirtualAttributeShared struct {
...
func NewUserDefinedVirtualAttributeShared(schemas []EnumuserDefinedVirtualAttributeSchemaUrn, value []string, enabled bool, attributeType string) *UserDefinedVirtualAttributeShared {
	this := UserDefinedVirtualAttributeShared{}
...
func (o UserDefinedVirtualAttributeShared) MarshalJSON() ([]byte, error) {
...
type NullableUserDefinedVirtualAttributeShared struct {
	value *UserDefinedVirtualAttributeShared
	isSet bool
}

func (v NullableUserDefinedVirtualAttributeShared) Get() *UserDefinedVirtualAttributeShared {
	return v.value
}

func (v *NullableUserDefinedVirtualAttributeShared) Set(val *UserDefinedVirtualAttributeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableUserDefinedVirtualAttributeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableUserDefinedVirtualAttributeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserDefinedVirtualAttributeShared(val *UserDefinedVirtualAttributeShared) *NullableUserDefinedVirtualAttributeShared {
	return &NullableUserDefinedVirtualAttributeShared{value: val, isSet: true}
}

func (v NullableUserDefinedVirtualAttributeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserDefinedVirtualAttributeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
