...
// JsonErrorLogPublisherShared struct for JsonErrorLogPublisherShared
type JsonErrorLogPublisherShared struct {
...
func NewJsonErrorLogPublisherShared(schemas []EnumjsonErrorLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool) *JsonErrorLogPublisherShared {
	this := JsonErrorLogPublisherShared{}
...
func (o JsonErrorLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableJsonErrorLogPublisherShared struct {
	value *JsonErrorLogPublisherShared
	isSet bool
}

func (v NullableJsonErrorLogPublisherShared) Get() *JsonErrorLogPublisherShared {
	return v.value
}

func (v *NullableJsonErrorLogPublisherShared) Set(val *JsonErrorLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableJsonErrorLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableJsonErrorLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJsonErrorLogPublisherShared(val *JsonErrorLogPublisherShared) *NullableJsonErrorLogPublisherShared {
	return &NullableJsonErrorLogPublisherShared{value: val, isSet: true}
}

func (v NullableJsonErrorLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJsonErrorLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
