...
*/
func (a *LocalDbVlvIndexApiService) AddLocalDbVlvIndex(ctx context.Context) ApiAddLocalDbVlvIndexRequest {
	return ApiAddLocalDbVlvIndexRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *LocalDbVlvIndexApiService) AddLocalDbVlvIndexExecute(r ApiAddLocalDbVlvIndexRequest) (*LocalDbVlvIndexResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/local-db-vlv-indexes"
...
DeleteLocalDbVlvIndex Delete a Local DB VLV Index
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param localDbVlvIndexName Name of the Local DB VLV Index to be deleted
	@return ApiDeleteLocalDbVlvIndexRequest
*/
func (a *LocalDbVlvIndexApiService) DeleteLocalDbVlvIndex(ctx context.Context, localDbVlvIndexName string) ApiDeleteLocalDbVlvIndexRequest {
	return ApiDeleteLocalDbVlvIndexRequest{
		ApiService:          a,
		ctx:                 ctx,
...
func (a *LocalDbVlvIndexApiService) DeleteLocalDbVlvIndexExecute(r ApiDeleteLocalDbVlvIndexRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/local-db-vlv-indexes/{local-db-vlv-index-name}"
...
GetLocalDbVlvIndex Returns a single Local DB VLV Index
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param localDbVlvIndexName Name of the Local DB VLV Index to be read
	@return ApiGetLocalDbVlvIndexRequest
*/
func (a *LocalDbVlvIndexApiService) GetLocalDbVlvIndex(ctx context.Context, localDbVlvIndexName string) ApiGetLocalDbVlvIndexRequest {
	return ApiGetLocalDbVlvIndexRequest{
		ApiService:          a,
		ctx:                 ctx,
		localDbVlvIndexName: localDbVlvIndexName,
...
UpdateLocalDbVlvIndex Update an existing Local DB VLV Index by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param localDbVlvIndexName Name of the Local DB VLV Index to be updated
	@return ApiUpdateLocalDbVlvIndexRequest
*/
func (a *LocalDbVlvIndexApiService) UpdateLocalDbVlvIndex(ctx context.Context, localDbVlvIndexName string) ApiUpdateLocalDbVlvIndexRequest {
	return ApiUpdateLocalDbVlvIndexRequest{
		ApiService:          a,
		ctx:                 ctx,
		localDbVlvIndexName: localDbVlvIndexName,
