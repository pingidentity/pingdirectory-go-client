...
// SmtpExternalServerShared struct for SmtpExternalServerShared
type SmtpExternalServerShared struct {
...
func (o SmtpExternalServerShared) MarshalJSON() ([]byte, error) {
...
type NullableSmtpExternalServerShared struct {
	value *SmtpExternalServerShared
	isSet bool
}

func (v NullableSmtpExternalServerShared) Get() *SmtpExternalServerShared {
	return v.value
}

func (v *NullableSmtpExternalServerShared) Set(val *SmtpExternalServerShared) {
	v.value = val
	v.isSet = true
}

func (v NullableSmtpExternalServerShared) IsSet() bool {
	return v.isSet
}

func (v *NullableSmtpExternalServerShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmtpExternalServerShared(val *SmtpExternalServerShared) *NullableSmtpExternalServerShared {
	return &NullableSmtpExternalServerShared{value: val, isSet: true}
}

func (v NullableSmtpExternalServerShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmtpExternalServerShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
