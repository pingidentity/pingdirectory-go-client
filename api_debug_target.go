...
*/
func (a *DebugTargetApiService) AddDebugTarget(ctx context.Context) ApiAddDebugTargetRequest {
	return ApiAddDebugTargetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DebugTargetApiService) AddDebugTargetExecute(r ApiAddDebugTargetRequest) (*DebugTargetResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/debug-targets"
...
DeleteDebugTarget Delete a Debug Target
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param debugTargetName Name of the Debug Target to be deleted
	@return ApiDeleteDebugTargetRequest
*/
func (a *DebugTargetApiService) DeleteDebugTarget(ctx context.Context, debugTargetName string) ApiDeleteDebugTargetRequest {
	return ApiDeleteDebugTargetRequest{
		ApiService:      a,
		ctx:             ctx,
...
func (a *DebugTargetApiService) DeleteDebugTargetExecute(r ApiDeleteDebugTargetRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/debug-targets/{debug-target-name}"
...
GetDebugTarget Returns a single Debug Target
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param debugTargetName Name of the Debug Target to be read
	@return ApiGetDebugTargetRequest
*/
func (a *DebugTargetApiService) GetDebugTarget(ctx context.Context, debugTargetName string) ApiGetDebugTargetRequest {
	return ApiGetDebugTargetRequest{
		ApiService:      a,
		ctx:             ctx,
		debugTargetName: debugTargetName,
...
UpdateDebugTarget Update an existing Debug Target by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param debugTargetName Name of the Debug Target to be updated
	@return ApiUpdateDebugTargetRequest
*/
func (a *DebugTargetApiService) UpdateDebugTarget(ctx context.Context, debugTargetName string) ApiUpdateDebugTargetRequest {
	return ApiUpdateDebugTargetRequest{
		ApiService:      a,
		ctx:             ctx,
		debugTargetName: debugTargetName,
