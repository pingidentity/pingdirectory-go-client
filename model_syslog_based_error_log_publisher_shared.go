...
// SyslogBasedErrorLogPublisherShared struct for SyslogBasedErrorLogPublisherShared
type SyslogBasedErrorLogPublisherShared struct {
...
func NewSyslogBasedErrorLogPublisherShared(schemas []EnumsyslogBasedErrorLogPublisherSchemaUrn, enabled bool, serverHostName string, serverPort int32, syslogFacility int32, asynchronous bool) *SyslogBasedErrorLogPublisherShared {
	this := SyslogBasedErrorLogPublisherShared{}
...
func (o SyslogBasedErrorLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableSyslogBasedErrorLogPublisherShared struct {
	value *SyslogBasedErrorLogPublisherShared
	isSet bool
}

func (v NullableSyslogBasedErrorLogPublisherShared) Get() *SyslogBasedErrorLogPublisherShared {
	return v.value
}

func (v *NullableSyslogBasedErrorLogPublisherShared) Set(val *SyslogBasedErrorLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableSyslogBasedErrorLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableSyslogBasedErrorLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyslogBasedErrorLogPublisherShared(val *SyslogBasedErrorLogPublisherShared) *NullableSyslogBasedErrorLogPublisherShared {
	return &NullableSyslogBasedErrorLogPublisherShared{value: val, isSet: true}
}

func (v NullableSyslogBasedErrorLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyslogBasedErrorLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
