...
------------- | ------------- | -------------
[**AddRootDnUser**](RootDnUserApi.md#AddRootDnUser) | **Post** /root-dn-users | Add a new Root DN User to the config
[**DeleteRootDnUser**](RootDnUserApi.md#DeleteRootDnUser) | **Delete** /root-dn-users/{root-dn-user-name} | Delete a Root DN User
[**GetRootDnUser**](RootDnUserApi.md#GetRootDnUser) | **Get** /root-dn-users/{root-dn-user-name} | Returns a single Root DN User
[**UpdateRootDnUser**](RootDnUserApi.md#UpdateRootDnUser) | **Patch** /root-dn-users/{root-dn-user-name} | Update an existing Root DN User by name
...
func main() {
    rootDnUserName := "rootDnUserName_example" // string | Name of the Root DN User to be deleted
...
**rootDnUserName** | **string** | Name of the Root DN User to be deleted | 
...
func main() {
    rootDnUserName := "rootDnUserName_example" // string | Name of the Root DN User to be read
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**rootDnUserName** | **string** | Name of the Root DN User to be read | 
...
func main() {
    rootDnUserName := "rootDnUserName_example" // string | Name of the Root DN User to be updated
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**rootDnUserName** | **string** | Name of the Root DN User to be updated | 
