...
------------- | ------------- | -------------
[**AddScimAttribute**](ScimAttributeApi.md#AddScimAttribute) | **Post** /scim-attributes | Add a new SCIM Attribute to the config
[**DeleteScimAttribute**](ScimAttributeApi.md#DeleteScimAttribute) | **Delete** /scim-attributes/{scim-attribute-name} | Delete a SCIM Attribute
[**GetScimAttribute**](ScimAttributeApi.md#GetScimAttribute) | **Get** /scim-attributes/{scim-attribute-name} | Returns a single SCIM Attribute
[**UpdateScimAttribute**](ScimAttributeApi.md#UpdateScimAttribute) | **Patch** /scim-attributes/{scim-attribute-name} | Update an existing SCIM Attribute by name



## AddScimAttribute

> ScimAttributeResponse AddScimAttribute(ctx).AddScimAttributeRequest(addScimAttributeRequest).Execute()
...
func main() {
    ...
    resp, r, err := apiClient.ScimAttributeApi.AddScimAttribute(context.Background()).AddScimAttributeRequest(addScimAttributeRequest).Execute()
    if err != nil {
...
> DeleteScimAttribute(ctx, scimAttributeName).Execute()
...
func main() {
    scimAttributeName := "scimAttributeName_example" // string | Name of the SCIM Attribute to be deleted

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ScimAttributeApi.DeleteScimAttribute(context.Background(), scimAttributeName).Execute()
    if err != nil {
...
**scimAttributeName** | **string** | Name of the SCIM Attribute to be deleted | 
...
> ScimAttributeResponse GetScimAttribute(ctx, scimAttributeName).Execute()
...
func main() {
    scimAttributeName := "scimAttributeName_example" // string | Name of the SCIM Attribute to be read

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ScimAttributeApi.GetScimAttribute(context.Background(), scimAttributeName).Execute()
    if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**scimAttributeName** | **string** | Name of the SCIM Attribute to be read | 
...
> ScimAttributeResponse UpdateScimAttribute(ctx, scimAttributeName).UpdateRequest(updateRequest).Execute()
...
func main() {
    scimAttributeName := "scimAttributeName_example" // string | Name of the SCIM Attribute to be updated
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ScimAttributeApi.UpdateScimAttribute(context.Background(), scimAttributeName).UpdateRequest(updateRequest).Execute()
    if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**scimAttributeName** | **string** | Name of the SCIM Attribute to be updated | 
