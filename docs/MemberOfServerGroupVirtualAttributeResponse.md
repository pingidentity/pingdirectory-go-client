...
`func NewMemberOfServerGroupVirtualAttributeResponse(schemas []EnummemberOfServerGroupVirtualAttributeSchemaUrn, attributeType string, enabled bool, ) *MemberOfServerGroupVirtualAttributeResponse`
...
`func (o *MemberOfServerGroupVirtualAttributeResponse) HasId() bool`
