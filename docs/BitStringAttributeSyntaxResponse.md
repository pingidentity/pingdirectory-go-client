...
`func NewBitStringAttributeSyntaxResponse(schemas []EnumbitStringAttributeSyntaxSchemaUrn, enabled bool, ) *BitStringAttributeSyntaxResponse`
...
`func (o *BitStringAttributeSyntaxResponse) HasId() bool`
