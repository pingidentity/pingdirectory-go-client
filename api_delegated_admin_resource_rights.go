...
*/
func (a *DelegatedAdminResourceRightsApiService) AddDelegatedAdminResourceRights(ctx context.Context) ApiAddDelegatedAdminResourceRightsRequest {
	return ApiAddDelegatedAdminResourceRightsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DelegatedAdminResourceRightsApiService) AddDelegatedAdminResourceRightsExecute(r ApiAddDelegatedAdminResourceRightsRequest) (*DelegatedAdminResourceRightsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/delegated-admin-resource-rights"
...
DeleteDelegatedAdminResourceRights Delete a Delegated Admin Resource Rights
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param delegatedAdminResourceRightsName Name of the Delegated Admin Resource Rights to be deleted
	@return ApiDeleteDelegatedAdminResourceRightsRequest
*/
func (a *DelegatedAdminResourceRightsApiService) DeleteDelegatedAdminResourceRights(ctx context.Context, delegatedAdminResourceRightsName string) ApiDeleteDelegatedAdminResourceRightsRequest {
	return ApiDeleteDelegatedAdminResourceRightsRequest{
		ApiService:                       a,
		ctx:                              ctx,
...
func (a *DelegatedAdminResourceRightsApiService) DeleteDelegatedAdminResourceRightsExecute(r ApiDeleteDelegatedAdminResourceRightsRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/delegated-admin-resource-rights/{delegated-admin-resource-rights-name}"
...
GetDelegatedAdminResourceRights Returns a single Delegated Admin Resource Rights
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param delegatedAdminResourceRightsName Name of the Delegated Admin Resource Rights to be read
	@return ApiGetDelegatedAdminResourceRightsRequest
*/
func (a *DelegatedAdminResourceRightsApiService) GetDelegatedAdminResourceRights(ctx context.Context, delegatedAdminResourceRightsName string) ApiGetDelegatedAdminResourceRightsRequest {
	return ApiGetDelegatedAdminResourceRightsRequest{
		ApiService:                       a,
		ctx:                              ctx,
		delegatedAdminResourceRightsName: delegatedAdminResourceRightsName,
...
UpdateDelegatedAdminResourceRights Update an existing Delegated Admin Resource Rights by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param delegatedAdminResourceRightsName Name of the Delegated Admin Resource Rights to be updated
	@return ApiUpdateDelegatedAdminResourceRightsRequest
*/
func (a *DelegatedAdminResourceRightsApiService) UpdateDelegatedAdminResourceRights(ctx context.Context, delegatedAdminResourceRightsName string) ApiUpdateDelegatedAdminResourceRightsRequest {
	return ApiUpdateDelegatedAdminResourceRightsRequest{
		ApiService:                       a,
		ctx:                              ctx,
		delegatedAdminResourceRightsName: delegatedAdminResourceRightsName,
