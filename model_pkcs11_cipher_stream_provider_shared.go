...
// Pkcs11CipherStreamProviderShared struct for Pkcs11CipherStreamProviderShared
type Pkcs11CipherStreamProviderShared struct {
...
func NewPkcs11CipherStreamProviderShared(schemas []Enumpkcs11CipherStreamProviderSchemaUrn, sslCertNickname string, encryptionMetadataFile string, enabled bool) *Pkcs11CipherStreamProviderShared {
	this := Pkcs11CipherStreamProviderShared{}
...
func (o Pkcs11CipherStreamProviderShared) MarshalJSON() ([]byte, error) {
...
type NullablePkcs11CipherStreamProviderShared struct {
	value *Pkcs11CipherStreamProviderShared
	isSet bool
}

func (v NullablePkcs11CipherStreamProviderShared) Get() *Pkcs11CipherStreamProviderShared {
	return v.value
}

func (v *NullablePkcs11CipherStreamProviderShared) Set(val *Pkcs11CipherStreamProviderShared) {
	v.value = val
	v.isSet = true
}

func (v NullablePkcs11CipherStreamProviderShared) IsSet() bool {
	return v.isSet
}

func (v *NullablePkcs11CipherStreamProviderShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePkcs11CipherStreamProviderShared(val *Pkcs11CipherStreamProviderShared) *NullablePkcs11CipherStreamProviderShared {
	return &NullablePkcs11CipherStreamProviderShared{value: val, isSet: true}
}

func (v NullablePkcs11CipherStreamProviderShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePkcs11CipherStreamProviderShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
