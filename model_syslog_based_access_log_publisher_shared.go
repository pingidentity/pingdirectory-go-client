...
// SyslogBasedAccessLogPublisherShared struct for SyslogBasedAccessLogPublisherShared
type SyslogBasedAccessLogPublisherShared struct {
...
func NewSyslogBasedAccessLogPublisherShared(schemas []EnumsyslogBasedAccessLogPublisherSchemaUrn, enabled bool, serverHostName string, serverPort int32, syslogFacility int32, asynchronous bool) *SyslogBasedAccessLogPublisherShared {
	this := SyslogBasedAccessLogPublisherShared{}
...
func (o SyslogBasedAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableSyslogBasedAccessLogPublisherShared struct {
	value *SyslogBasedAccessLogPublisherShared
	isSet bool
}

func (v NullableSyslogBasedAccessLogPublisherShared) Get() *SyslogBasedAccessLogPublisherShared {
	return v.value
}

func (v *NullableSyslogBasedAccessLogPublisherShared) Set(val *SyslogBasedAccessLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableSyslogBasedAccessLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableSyslogBasedAccessLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyslogBasedAccessLogPublisherShared(val *SyslogBasedAccessLogPublisherShared) *NullableSyslogBasedAccessLogPublisherShared {
	return &NullableSyslogBasedAccessLogPublisherShared{value: val, isSet: true}
}

func (v NullableSyslogBasedAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyslogBasedAccessLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
