...
*/
func (a *DelegatedAdminCorrelatedRestResourceApiService) AddDelegatedAdminCorrelatedRestResource(ctx context.Context) ApiAddDelegatedAdminCorrelatedRestResourceRequest {
	return ApiAddDelegatedAdminCorrelatedRestResourceRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DelegatedAdminCorrelatedRestResourceApiService) AddDelegatedAdminCorrelatedRestResourceExecute(r ApiAddDelegatedAdminCorrelatedRestResourceRequest) (*DelegatedAdminCorrelatedRestResourceResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/delegated-admin-correlated-rest-resources"
...
DeleteDelegatedAdminCorrelatedRestResource Delete a Delegated Admin Correlated REST Resource
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param delegatedAdminCorrelatedRestResourceName Name of the Delegated Admin Correlated REST Resource to be deleted
	@return ApiDeleteDelegatedAdminCorrelatedRestResourceRequest
*/
func (a *DelegatedAdminCorrelatedRestResourceApiService) DeleteDelegatedAdminCorrelatedRestResource(ctx context.Context, delegatedAdminCorrelatedRestResourceName string) ApiDeleteDelegatedAdminCorrelatedRestResourceRequest {
	return ApiDeleteDelegatedAdminCorrelatedRestResourceRequest{
		ApiService:                               a,
		ctx:                                      ctx,
...
func (a *DelegatedAdminCorrelatedRestResourceApiService) DeleteDelegatedAdminCorrelatedRestResourceExecute(r ApiDeleteDelegatedAdminCorrelatedRestResourceRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/delegated-admin-correlated-rest-resources/{delegated-admin-correlated-rest-resource-name}"
	localVarPath = strings.Replace(localVarPath, "{"+"delegated-admin-correlated-rest-resource-name"+"}", url.PathEscape(parameterToString(r.delegatedAdminCorrelatedRestResourceName, "")), -1)
...
GetDelegatedAdminCorrelatedRestResource Returns a single Delegated Admin Correlated REST Resource
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param delegatedAdminCorrelatedRestResourceName Name of the Delegated Admin Correlated REST Resource to be read
	@return ApiGetDelegatedAdminCorrelatedRestResourceRequest
*/
func (a *DelegatedAdminCorrelatedRestResourceApiService) GetDelegatedAdminCorrelatedRestResource(ctx context.Context, delegatedAdminCorrelatedRestResourceName string) ApiGetDelegatedAdminCorrelatedRestResourceRequest {
	return ApiGetDelegatedAdminCorrelatedRestResourceRequest{
		ApiService:                               a,
		ctx:                                      ctx,
		delegatedAdminCorrelatedRestResourceName: delegatedAdminCorrelatedRestResourceName,
...
UpdateDelegatedAdminCorrelatedRestResource Update an existing Delegated Admin Correlated REST Resource by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param delegatedAdminCorrelatedRestResourceName Name of the Delegated Admin Correlated REST Resource to be updated
	@return ApiUpdateDelegatedAdminCorrelatedRestResourceRequest
*/
func (a *DelegatedAdminCorrelatedRestResourceApiService) UpdateDelegatedAdminCorrelatedRestResource(ctx context.Context, delegatedAdminCorrelatedRestResourceName string) ApiUpdateDelegatedAdminCorrelatedRestResourceRequest {
	return ApiUpdateDelegatedAdminCorrelatedRestResourceRequest{
		ApiService:                               a,
		ctx:                                      ctx,
		delegatedAdminCorrelatedRestResourceName: delegatedAdminCorrelatedRestResourceName,
