...
// EqualityJoinVirtualAttributeShared struct for EqualityJoinVirtualAttributeShared
type EqualityJoinVirtualAttributeShared struct {
...
func NewEqualityJoinVirtualAttributeShared(schemas []EnumequalityJoinVirtualAttributeSchemaUrn, joinSourceAttribute string, joinTargetAttribute string, joinBaseDNType EnumvirtualAttributeJoinBaseDNTypeProp, enabled bool, attributeType string) *EqualityJoinVirtualAttributeShared {
	this := EqualityJoinVirtualAttributeShared{}
...
func (o EqualityJoinVirtualAttributeShared) MarshalJSON() ([]byte, error) {
...
type NullableEqualityJoinVirtualAttributeShared struct {
	value *EqualityJoinVirtualAttributeShared
	isSet bool
}

func (v NullableEqualityJoinVirtualAttributeShared) Get() *EqualityJoinVirtualAttributeShared {
	return v.value
}

func (v *NullableEqualityJoinVirtualAttributeShared) Set(val *EqualityJoinVirtualAttributeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableEqualityJoinVirtualAttributeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableEqualityJoinVirtualAttributeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEqualityJoinVirtualAttributeShared(val *EqualityJoinVirtualAttributeShared) *NullableEqualityJoinVirtualAttributeShared {
	return &NullableEqualityJoinVirtualAttributeShared{value: val, isSet: true}
}

func (v NullableEqualityJoinVirtualAttributeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEqualityJoinVirtualAttributeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
