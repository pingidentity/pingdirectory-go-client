...
*/
func (a *VelocityTemplateLoaderApiService) AddVelocityTemplateLoader(ctx context.Context) ApiAddVelocityTemplateLoaderRequest {
	return ApiAddVelocityTemplateLoaderRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *VelocityTemplateLoaderApiService) AddVelocityTemplateLoaderExecute(r ApiAddVelocityTemplateLoaderRequest) (*VelocityTemplateLoaderResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/velocity-template-loaders"
...
DeleteVelocityTemplateLoader Delete a Velocity Template Loader
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param velocityTemplateLoaderName Name of the Velocity Template Loader to be deleted
	@return ApiDeleteVelocityTemplateLoaderRequest
*/
func (a *VelocityTemplateLoaderApiService) DeleteVelocityTemplateLoader(ctx context.Context, velocityTemplateLoaderName string) ApiDeleteVelocityTemplateLoaderRequest {
	return ApiDeleteVelocityTemplateLoaderRequest{
		ApiService:                 a,
		ctx:                        ctx,
...
func (a *VelocityTemplateLoaderApiService) DeleteVelocityTemplateLoaderExecute(r ApiDeleteVelocityTemplateLoaderRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/velocity-template-loaders/{velocity-template-loader-name}"
...
GetVelocityTemplateLoader Returns a single Velocity Template Loader
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param velocityTemplateLoaderName Name of the Velocity Template Loader to be read
	@return ApiGetVelocityTemplateLoaderRequest
*/
func (a *VelocityTemplateLoaderApiService) GetVelocityTemplateLoader(ctx context.Context, velocityTemplateLoaderName string) ApiGetVelocityTemplateLoaderRequest {
	return ApiGetVelocityTemplateLoaderRequest{
		ApiService:                 a,
		ctx:                        ctx,
		velocityTemplateLoaderName: velocityTemplateLoaderName,
...
UpdateVelocityTemplateLoader Update an existing Velocity Template Loader by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param velocityTemplateLoaderName Name of the Velocity Template Loader to be updated
	@return ApiUpdateVelocityTemplateLoaderRequest
*/
func (a *VelocityTemplateLoaderApiService) UpdateVelocityTemplateLoader(ctx context.Context, velocityTemplateLoaderName string) ApiUpdateVelocityTemplateLoaderRequest {
	return ApiUpdateVelocityTemplateLoaderRequest{
		ApiService:                 a,
		ctx:                        ctx,
		velocityTemplateLoaderName: velocityTemplateLoaderName,
