...
// FileBasedErrorLogPublisherShared struct for FileBasedErrorLogPublisherShared
type FileBasedErrorLogPublisherShared struct {
...
func NewFileBasedErrorLogPublisherShared(schemas []EnumfileBasedErrorLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool) *FileBasedErrorLogPublisherShared {
	this := FileBasedErrorLogPublisherShared{}
...
func (o FileBasedErrorLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableFileBasedErrorLogPublisherShared struct {
	value *FileBasedErrorLogPublisherShared
	isSet bool
}

func (v NullableFileBasedErrorLogPublisherShared) Get() *FileBasedErrorLogPublisherShared {
	return v.value
}

func (v *NullableFileBasedErrorLogPublisherShared) Set(val *FileBasedErrorLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableFileBasedErrorLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableFileBasedErrorLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileBasedErrorLogPublisherShared(val *FileBasedErrorLogPublisherShared) *NullableFileBasedErrorLogPublisherShared {
	return &NullableFileBasedErrorLogPublisherShared{value: val, isSet: true}
}

func (v NullableFileBasedErrorLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileBasedErrorLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
