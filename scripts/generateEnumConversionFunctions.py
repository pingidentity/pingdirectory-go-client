...
with open("enum_conversion.go", 'w') as conversionFile:
    # Write header
    conversionFile.write("package configurationapi\n")
    ...
    for enum in enumNames:
        ...
        conversionFile.write('}\n')
        conversionFile.write('\n')
        conversionFile.write(f'func StringPointer{enum}(value *{enum}) *string {{\n')
        conversionFile.write('	  if value == nil {\n')
        conversionFile.write('		  return nil\n')
        conversionFile.write('	  }\n')
        conversionFile.write('	  s := value.String()\n')
        conversionFile.write('	  return &s\n')
        conversionFile.write('}\n')
