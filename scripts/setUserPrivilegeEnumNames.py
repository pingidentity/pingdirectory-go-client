...
def updateRevokePrivilegeEnumNames(filename):
...
updateRevokePrivilegeEnumNames("model_enumtopology_admin_user_privilege_prop.go")
updateRevokePrivilegeEnumNames("model_enumroot_dn_user_privilege_prop.go")
