...
// FileBasedJsonHttpOperationLogPublisherShared struct for FileBasedJsonHttpOperationLogPublisherShared
type FileBasedJsonHttpOperationLogPublisherShared struct {
...
func NewFileBasedJsonHttpOperationLogPublisherShared(schemas []EnumfileBasedJsonHttpOperationLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool) *FileBasedJsonHttpOperationLogPublisherShared {
	this := FileBasedJsonHttpOperationLogPublisherShared{}
...
func (o FileBasedJsonHttpOperationLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableFileBasedJsonHttpOperationLogPublisherShared struct {
	value *FileBasedJsonHttpOperationLogPublisherShared
	isSet bool
}

func (v NullableFileBasedJsonHttpOperationLogPublisherShared) Get() *FileBasedJsonHttpOperationLogPublisherShared {
	return v.value
}

func (v *NullableFileBasedJsonHttpOperationLogPublisherShared) Set(val *FileBasedJsonHttpOperationLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableFileBasedJsonHttpOperationLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableFileBasedJsonHttpOperationLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileBasedJsonHttpOperationLogPublisherShared(val *FileBasedJsonHttpOperationLogPublisherShared) *NullableFileBasedJsonHttpOperationLogPublisherShared {
	return &NullableFileBasedJsonHttpOperationLogPublisherShared{value: val, isSet: true}
}

func (v NullableFileBasedJsonHttpOperationLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileBasedJsonHttpOperationLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
