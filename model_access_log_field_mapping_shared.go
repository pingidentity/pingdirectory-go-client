...
// AccessLogFieldMappingShared struct for AccessLogFieldMappingShared
type AccessLogFieldMappingShared struct {
...
func NewAccessLogFieldMappingShared(schemas []EnumaccessLogFieldMappingSchemaUrn) *AccessLogFieldMappingShared {
	this := AccessLogFieldMappingShared{}
...
func (o AccessLogFieldMappingShared) MarshalJSON() ([]byte, error) {
...
type NullableAccessLogFieldMappingShared struct {
	value *AccessLogFieldMappingShared
	isSet bool
}

func (v NullableAccessLogFieldMappingShared) Get() *AccessLogFieldMappingShared {
	return v.value
}

func (v *NullableAccessLogFieldMappingShared) Set(val *AccessLogFieldMappingShared) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessLogFieldMappingShared) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessLogFieldMappingShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessLogFieldMappingShared(val *AccessLogFieldMappingShared) *NullableAccessLogFieldMappingShared {
	return &NullableAccessLogFieldMappingShared{value: val, isSet: true}
}

func (v NullableAccessLogFieldMappingShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessLogFieldMappingShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
