...
const (
	CONSENT_CREATED EnumlogPublisherConsentMessageTypeProp = "consent-created"
	CONSENT_UPDATED EnumlogPublisherConsentMessageTypeProp = "consent-updated"
	CONSENT_DELETED EnumlogPublisherConsentMessageTypeProp = "consent-deleted"
	CONSENT_RETRIEVED EnumlogPublisherConsentMessageTypeProp = "consent-retrieved"
	CONSENT_SEARCH EnumlogPublisherConsentMessageTypeProp = "consent-search"
	DEFINITION_CREATED EnumlogPublisherConsentMessageTypeProp = "definition-created"
	DEFINITION_UPDATED EnumlogPublisherConsentMessageTypeProp = "definition-updated"
	DEFINITION_DELETED EnumlogPublisherConsentMessageTypeProp = "definition-deleted"
	DEFINITION_RETRIEVED EnumlogPublisherConsentMessageTypeProp = "definition-retrieved"
	DEFINITION_SEARCH EnumlogPublisherConsentMessageTypeProp = "definition-search"
	LOCALIZATION_CREATED EnumlogPublisherConsentMessageTypeProp = "localization-created"
	LOCALIZATION_UPDATED EnumlogPublisherConsentMessageTypeProp = "localization-updated"
	LOCALIZATION_DELETED EnumlogPublisherConsentMessageTypeProp = "localization-deleted"
	LOCALIZATION_RETRIEVED EnumlogPublisherConsentMessageTypeProp = "localization-retrieved"
	LOCALIZATION_SEARCH EnumlogPublisherConsentMessageTypeProp = "localization-search"
	ERROR EnumlogPublisherConsentMessageTypeProp = "error"
	AUDIT EnumlogPublisherConsentMessageTypeProp = "audit"
)
