...
// ConjurPasswordStorageSchemeShared struct for ConjurPasswordStorageSchemeShared
type ConjurPasswordStorageSchemeShared struct {
...
func NewConjurPasswordStorageSchemeShared(schemas []EnumconjurPasswordStorageSchemeSchemaUrn, conjurExternalServer string, enabled bool) *ConjurPasswordStorageSchemeShared {
	this := ConjurPasswordStorageSchemeShared{}
...
func (o ConjurPasswordStorageSchemeShared) MarshalJSON() ([]byte, error) {
...
type NullableConjurPasswordStorageSchemeShared struct {
	value *ConjurPasswordStorageSchemeShared
	isSet bool
}

func (v NullableConjurPasswordStorageSchemeShared) Get() *ConjurPasswordStorageSchemeShared {
	return v.value
}

func (v *NullableConjurPasswordStorageSchemeShared) Set(val *ConjurPasswordStorageSchemeShared) {
	v.value = val
	v.isSet = true
}

func (v NullableConjurPasswordStorageSchemeShared) IsSet() bool {
	return v.isSet
}

func (v *NullableConjurPasswordStorageSchemeShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConjurPasswordStorageSchemeShared(val *ConjurPasswordStorageSchemeShared) *NullableConjurPasswordStorageSchemeShared {
	return &NullableConjurPasswordStorageSchemeShared{value: val, isSet: true}
}

func (v NullableConjurPasswordStorageSchemeShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConjurPasswordStorageSchemeShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
