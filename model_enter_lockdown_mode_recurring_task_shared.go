...
// EnterLockdownModeRecurringTaskShared struct for EnterLockdownModeRecurringTaskShared
type EnterLockdownModeRecurringTaskShared struct {
...
func NewEnterLockdownModeRecurringTaskShared(schemas []EnumenterLockdownModeRecurringTaskSchemaUrn) *EnterLockdownModeRecurringTaskShared {
	this := EnterLockdownModeRecurringTaskShared{}
...
func (o EnterLockdownModeRecurringTaskShared) MarshalJSON() ([]byte, error) {
...
type NullableEnterLockdownModeRecurringTaskShared struct {
	value *EnterLockdownModeRecurringTaskShared
	isSet bool
}

func (v NullableEnterLockdownModeRecurringTaskShared) Get() *EnterLockdownModeRecurringTaskShared {
	return v.value
}

func (v *NullableEnterLockdownModeRecurringTaskShared) Set(val *EnterLockdownModeRecurringTaskShared) {
	v.value = val
	v.isSet = true
}

func (v NullableEnterLockdownModeRecurringTaskShared) IsSet() bool {
	return v.isSet
}

func (v *NullableEnterLockdownModeRecurringTaskShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnterLockdownModeRecurringTaskShared(val *EnterLockdownModeRecurringTaskShared) *NullableEnterLockdownModeRecurringTaskShared {
	return &NullableEnterLockdownModeRecurringTaskShared{value: val, isSet: true}
}

func (v NullableEnterLockdownModeRecurringTaskShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnterLockdownModeRecurringTaskShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
