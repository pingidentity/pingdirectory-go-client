...
// DebugAccessLogPublisherShared struct for DebugAccessLogPublisherShared
type DebugAccessLogPublisherShared struct {
...
func NewDebugAccessLogPublisherShared(schemas []EnumdebugAccessLogPublisherSchemaUrn, logFile string, logFilePermissions string, rotationPolicy []string, retentionPolicy []string, asynchronous bool, enabled bool) *DebugAccessLogPublisherShared {
	this := DebugAccessLogPublisherShared{}
...
func (o DebugAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
...
type NullableDebugAccessLogPublisherShared struct {
	value *DebugAccessLogPublisherShared
	isSet bool
}

func (v NullableDebugAccessLogPublisherShared) Get() *DebugAccessLogPublisherShared {
	return v.value
}

func (v *NullableDebugAccessLogPublisherShared) Set(val *DebugAccessLogPublisherShared) {
	v.value = val
	v.isSet = true
}

func (v NullableDebugAccessLogPublisherShared) IsSet() bool {
	return v.isSet
}

func (v *NullableDebugAccessLogPublisherShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebugAccessLogPublisherShared(val *DebugAccessLogPublisherShared) *NullableDebugAccessLogPublisherShared {
	return &NullableDebugAccessLogPublisherShared{value: val, isSet: true}
}

func (v NullableDebugAccessLogPublisherShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebugAccessLogPublisherShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
