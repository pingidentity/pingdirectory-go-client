...
// ThirdPartyResultCriteriaShared struct for ThirdPartyResultCriteriaShared
type ThirdPartyResultCriteriaShared struct {
...
func NewThirdPartyResultCriteriaShared(schemas []EnumthirdPartyResultCriteriaSchemaUrn, extensionClass string) *ThirdPartyResultCriteriaShared {
	this := ThirdPartyResultCriteriaShared{}
...
func (o ThirdPartyResultCriteriaShared) MarshalJSON() ([]byte, error) {
...
type NullableThirdPartyResultCriteriaShared struct {
	value *ThirdPartyResultCriteriaShared
	isSet bool
}

func (v NullableThirdPartyResultCriteriaShared) Get() *ThirdPartyResultCriteriaShared {
	return v.value
}

func (v *NullableThirdPartyResultCriteriaShared) Set(val *ThirdPartyResultCriteriaShared) {
	v.value = val
	v.isSet = true
}

func (v NullableThirdPartyResultCriteriaShared) IsSet() bool {
	return v.isSet
}

func (v *NullableThirdPartyResultCriteriaShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThirdPartyResultCriteriaShared(val *ThirdPartyResultCriteriaShared) *NullableThirdPartyResultCriteriaShared {
	return &NullableThirdPartyResultCriteriaShared{value: val, isSet: true}
}

func (v NullableThirdPartyResultCriteriaShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThirdPartyResultCriteriaShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
