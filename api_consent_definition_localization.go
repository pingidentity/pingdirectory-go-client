...
*/
func (a *ConsentDefinitionLocalizationApiService) AddConsentDefinitionLocalization(ctx context.Context) ApiAddConsentDefinitionLocalizationRequest {
	return ApiAddConsentDefinitionLocalizationRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ConsentDefinitionLocalizationApiService) AddConsentDefinitionLocalizationExecute(r ApiAddConsentDefinitionLocalizationRequest) (*ConsentDefinitionLocalizationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/consent-definition-localizations"
...
DeleteConsentDefinitionLocalization Delete a Consent Definition Localization
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param consentDefinitionLocalizationName Name of the Consent Definition Localization to be deleted
	@return ApiDeleteConsentDefinitionLocalizationRequest
*/
func (a *ConsentDefinitionLocalizationApiService) DeleteConsentDefinitionLocalization(ctx context.Context, consentDefinitionLocalizationName string) ApiDeleteConsentDefinitionLocalizationRequest {
	return ApiDeleteConsentDefinitionLocalizationRequest{
		ApiService:                        a,
		ctx:                               ctx,
...
func (a *ConsentDefinitionLocalizationApiService) DeleteConsentDefinitionLocalizationExecute(r ApiDeleteConsentDefinitionLocalizationRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/consent-definition-localizations/{consent-definition-localization-name}"
...
GetConsentDefinitionLocalization Returns a single Consent Definition Localization
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param consentDefinitionLocalizationName Name of the Consent Definition Localization to be read
	@return ApiGetConsentDefinitionLocalizationRequest
*/
func (a *ConsentDefinitionLocalizationApiService) GetConsentDefinitionLocalization(ctx context.Context, consentDefinitionLocalizationName string) ApiGetConsentDefinitionLocalizationRequest {
	return ApiGetConsentDefinitionLocalizationRequest{
		ApiService:                        a,
		ctx:                               ctx,
		consentDefinitionLocalizationName: consentDefinitionLocalizationName,
...
UpdateConsentDefinitionLocalization Update an existing Consent Definition Localization by name
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param consentDefinitionLocalizationName Name of the Consent Definition Localization to be updated
	@return ApiUpdateConsentDefinitionLocalizationRequest
*/
func (a *ConsentDefinitionLocalizationApiService) UpdateConsentDefinitionLocalization(ctx context.Context, consentDefinitionLocalizationName string) ApiUpdateConsentDefinitionLocalizationRequest {
	return ApiUpdateConsentDefinitionLocalizationRequest{
		ApiService:                        a,
		ctx:                               ctx,
		consentDefinitionLocalizationName: consentDefinitionLocalizationName,
