...
// SmtpAlertHandlerShared struct for SmtpAlertHandlerShared
type SmtpAlertHandlerShared struct {
...
func (o SmtpAlertHandlerShared) MarshalJSON() ([]byte, error) {
...
type NullableSmtpAlertHandlerShared struct {
	value *SmtpAlertHandlerShared
	isSet bool
}

func (v NullableSmtpAlertHandlerShared) Get() *SmtpAlertHandlerShared {
	return v.value
}

func (v *NullableSmtpAlertHandlerShared) Set(val *SmtpAlertHandlerShared) {
	v.value = val
	v.isSet = true
}

func (v NullableSmtpAlertHandlerShared) IsSet() bool {
	return v.isSet
}

func (v *NullableSmtpAlertHandlerShared) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmtpAlertHandlerShared(val *SmtpAlertHandlerShared) *NullableSmtpAlertHandlerShared {
	return &NullableSmtpAlertHandlerShared{value: val, isSet: true}
}

func (v NullableSmtpAlertHandlerShared) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmtpAlertHandlerShared) UnmarshalJSON(src []byte) error {
	v.isSet = true
